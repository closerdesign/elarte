...
require('../Application/Component/basededatosComponent.php');
require('../Application/Services/basededatosServices.php');
...
<br />
<a href="#" id="BotonPrueba" onclick="inscritosConf1()" >- Ver Inscritos a conferencia "El arte de amar sin apegos".</a>
