...
<br />
<input type="button" name="BotonPrueba" id="BotonPrueba" value="Conciliar El Arte respecto a Payu" onclick="ConciliarElArteRespectoPayu(0)" />
<input type="button" name="BotonPrueba" id="BotonPrueba" value="Conciliar Payu respecto a El arte" onclick="ConciliarPayuRespectoElArte(0)" />
<br /><br />
