		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Los 4 pilares fundamentales para una buena autoestima</h1>
            ...
            <div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<p style="font-size:16px">El amor empieza por casa. El primer amor para uno debe ser su propio "YO", no narcisismo, sino amor propio del bueno, sin egolatría. Sólo podrás amar a otra persona si te quieres a ti mismo, uno da lo que piensa que vale. "Te quiero y me quiero" es mejor que amar ciegamente y entregarse sin reparos. Si crees que vales como persona, llegarás a la conclusión que todo amor debe ser recíproco: "Si yo te amo y tu no me amas, no me sirves como pareja". Pero, ¿qué hacer para aprender a quererse a sí mismo? En este video Walter Riso le cuenta a la comunidad Phronesis a través de su programa "Reflexiones para vivir mejor" los 4 elementos o pilares fundamentales en los que hay que trabajar para  fortalecer el amor propio y sentirse merecedor.</p>
            ...
            <div class="row">
				<div class="col-md-6">
					...
					<div class="col-md-12">
						<h3>Video 1: Los pilares para una buena autoestima</h3>
						<div class='embed-container'>
                        	
							<iframe src='https://www.youtube.com/embed/P9c3qMUvnxo?list=PLjjVfXgqEfhiya2fLbaIQ0_warfPIBI_-' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
				...
				<div class="col-md-6">
					...
					<div class="col-md-12">
						<h3>Video 2: Sobre guía práctica para mejorar la autoestima</h3>
						<div class='embed-container'>
