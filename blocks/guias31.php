		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">La culpa en la infidelidad</h1>
					<h4 class="text-center">Reflexiones para vivir mejor - Por Walter Riso </h4>
                    <br />
				</div>
			</div>
			<hr>
            ...
            <div class="row">
				<div class="col-md-12">
                	...
                	<p style="font-size:16px">Cuando quien es víctima de un engaño lo descubre, recorre casi toda la gama de emociones: depresión, resentimiento, ira, hostilidad, ansiedad, decepción, venganza, envidia, asombro, incredulidad, sorpresa, aislamiento, frustración y una baja fulminante en la autoestima. Pero cuando no se da por enterado(a), la sospecha comienza a molestar: "Algo ocurre", "Cada vez está más distante", "Está llegando tarde", "Me habla menos", y así. Una frialdad sutil, lenta e implacable se va apoderando de la relación hasta congelarla. Tal como lo indica Walter Riso en su guía práctica para afrontar la infidelidad de la pareja: "La infidelidad aunque no se ve, se siente". Pero, ¿qué pasa con el victimario? ¿qué pasa con la persona que engaña?. Veamos en este video lo que dice el prestigioso psicólogo y escritor Walter Riso  sobre los conflictos y remordimientos que deben vivir las personas infieles.</p>
            ...
            <div class="row">
				<div class="col-md-6">
                	<h3>Video 1: Los conflictos y remordimientos de una persona infiel</h3>
                	<style>
					...
					<div class="col-md-12">
						...
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/ElmMG8iEdbI' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
                ...
                <div class="col-md-6">
                	<h3>Video 2: Sobre guía práctica para afrontar la infidelidad de la pareja</h3>
                	<style>
						.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }
					</style>
					<div class="col-md-12">
						...
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/xouBf43Od3I' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
            ...
            <div class="row">
            	...
            	<p style="font-size:16px">Millones de personas son víctimas de relaciones amorosas inadecuadas y no saben qué hacer al respecto. El miedo a la pérdida, a la soledad y/o al abandono contaminan el vínculo amoroso y lo vuelven vulnerable y enfermizo. Un amor inseguro es una bomba de tiempo que puede estallar en cualquier momento y lastimarnos profundamente. Las guías prácticas de Walter Riso son la herramienta perfecta para construir relaciones basadas en los tres pilares imprescindibles del amor: Eros (Deseo), Philia (Amistad), Ágape (Ternura y preocupación). Con ellas podrás iniciar un proceso de mejora y transformación para llevar una vida emocional saludable. ¡Basta de sufrir por amor!, es el momento de hacer una revolución en tu vida y avanzar por un camino donde el amor se viva y se disfrute de una manera plena y saludable.</p>
