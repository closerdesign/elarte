		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Aprende a decir NO</h1>
					<h4 class="text-center">Reflexiones para vivir mejor - Por Walter Riso </h4>
                    
                    <hr />
                    
                    <p style="font-size:16px">Desde pequeños no nos enseñan a ser asertivos, sino solo agradar a los demás por encima de nuestros verdaderos deseos u opiniones. Ser asertivo significa ser capaz de ejercer y/o defender los derechos personales: decir "no", expresar desacuerdos, dar una opinión contraria y/o expresar sentimientos negativos sin dejarse manipular, como lo haría una persona sumisa, y sin violar los derechos de los demás, como hace una persona agresiva. Esta es la clave. La asertividad es un punto medio entre el que se arrodilla y el que aplasta al otro. Implica la defensa de los derechos sin lastimar a nadie. Tal como lo indica Walter Riso en su guía práctica para no dejarse manipular y ser asertivo:
                    <br /><br />
                    <i>"Dejar constancia de la divergencia y expresar un sentimiento de inconformidad, aunque no genere un cambio inmediato en el ambiente, fortalece la autoestima y evita la acumulación de basura en la memoria. Sienta tus precedentes, sin violar los derechos de nadie, y te sentirás íntimamente poderoso".</i>
					<br /><br />Veamos en este video lo que dice el prestigioso psicólogo y escritor Walter Riso sobre ser tu mismo, ser asertivo y feliz.
            ...
            <div class="row">
				<div class="col-md-6">
					...
					<div class="col-md-12">
						...
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/9wkVU5xuiM0' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
				...
				<div class="col-md-6">
					...
					<div class="col-md-12">
						...
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/IwUjmf27K3E' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
