		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">¿Amas o dependes?</h1>
					<h4 class="text-center">¿Eres de los que piensa y siente que no puede vivir sin su pareja, que tu vida sin ella no tiene sentido, que tu felicidad solo depende de tu pareja y que tu vida sólo puede girar en torno a ella?</h4>
                    <br />
                    <p style="font-size:16px">
                    
                    ¡Cuidado! depender de la persona que se ama no solo arruina relaciones, también es una manera de enterrarse en vida, un acto de automutilación psicológica donde el amor propio, el autorrespeto, la dignidad, los principios y la esencia de uno mismo son ofrendados y regalados irracional-mente. Amar no sólo con el corazón sino también con la razón es fundamental para llevar una relación sana y que no genere sufrimiento. 
                    
                    <br /><br />
                    
                    Walter Riso nos trae ahora sus guías prácticas, una herramienta donde nos muestra de una forma práctica elementos y pasos para que vivir el amor sea una experiencia plena y saludable, mostrando que la razón, la autoestima, la asertividad y la independencia afectiva juegan un papel fundamental para desligar el amor del sufrimiento. 
