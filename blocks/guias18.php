		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<h4 class="text-center">Una herramienta para construir un amor de pareja sano y completo</h4>
                    <br />
                    <p style="font-size:16px">
                    Un amor de pareja sano debe estar compuesto por estos tres elementos, si falta alguno será una relación que tarde o temprano podrá generar sufrimiento:
                    </p>
                    
                    <div class="row">
						<div class="col-md-4">
                        	<img class="img img-responsive" src="../img/Philia.png" alt="Philia" title="Philia - Amistad">
                            <br />
                        </div>
                        
                        <div class="col-md-4">
                        	<img class="img img-responsive" src="../img/Agape.png" alt="Agape" title="Agape - Ternura">
                            <br />
                        </div>
                        
                        <div class="col-md-4">
                        	<img class="img img-responsive" src="../img/Eros.png" alt="Eros" title="Eros - Deseo">
                            <br />
                        </div>
                    </div>
                    
                    <p style="font-size:16px">
                    Las guías prácticas de Walter Riso son la herramienta perfecta para construir relaciones basadas en estos tres pilares imprescindibles del amor, con ellas podrás iniciar un proceso de mejora y transformación para llevar una vida emocional saludable. ¡Basta de sufrir por amor!, es el momento de hacer una revolución en tu vida y avanzar por un camino donde el amor se viva y se disfrute de una manera plena y saludable. </p>
				</div>
			</div>
			<hr>
