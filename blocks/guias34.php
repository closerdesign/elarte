		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">El mito del amor eterno</h1>
					<h4 class="text-center">Extraído de <i><b>"Guía práctica para no sufrir de amor"</b></i> de Walter Riso</h4>
                    <br />
                    <p style="font-size:16px">En la guía práctica para no sufrir de amor el prestigioso psicólogo y escritor Walter Riso analiza 3 mitos comunes que generan concepciones erróneas y pensamientos idealizados que perjudican el buen amor:</p>
					<ul style="font-size:16px">
						<li>Mito 1: "Si hay amor, no necesitas nada más". </li>
						<li>Mito 2: "El verdadero amor es incondicional". </li>
						<li>Mito 3: "El amor es eterno". </li>
					</ul>
                    
					<p style="font-size:16px">A continuación compartiremos un fragmento de esta guía donde Walter Riso analiza el tercer mito.</p>  
