...
<?php } ?>
<div class="row top">
	<div class="container contenidoConferencia contenidoConferencia-v2">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h1 class="tituloConferencia">
					Conferencia Virtual por Walter Riso <br>
					<span style="font-size: 0.7em">El arte de amar sin apegos</span>
				</h1>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6" >
				<div class="formularioConferencia">
					<div class="row">
						<div class="col-md-12">
							<h1 class="text-center CallTitle">
							<span style="font-size: .8em;">Entradas Limitadas</span><br>
								¡Inscríbete ahora!
							</h1>
							<hr>
							<ul class="listaInscripcion">
								<li>La conferencia es en vivo y en directo el sábado 25 de julio de 2015. <a href="#" style="color:yellow" onclick="$('#myModalHorarios').modal()">Consulta los horarios de tu país</a>.</li>
							...
							<form id="inscripcionConferencia">
								...
								<div class="row">
									<div class="col-md-12 form-group">
										<select class="form-control" name="paisConferencia" id="paisConferencia2" required >
