		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Hasta donde debemos sacrificarnos por amor</h1>
            ...
            <div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<p style="font-size:16px">En este video encontrarás la respuesta de Walter Riso a la pregunta: ¿Hasta donde debemos sacrificarnos por amor?, dejándonos claro que el sacrificio en el amor no tiene cabida, si en tu relación de pareja existe "ágape" nunca habrá sacrificio. Recordemos que el agape es uno de los pilares fundamentales de una mor sano y completo, representando la ternura, la preocupación por el otro, o dicho de otra forma significa que el dolor de tu pareja es tu dolor.  </p>
            ...
            <div class="row">
				<div class="col-md-6">
					...
					<div class="col-md-12">
						<h3>Video 1: ¿Hasta donde debemos sacrificarnos por amor?</h3>
						<div class='embed-container'>
                        	
							<iframe src='https://www.youtube.com/embed/Oq50Bnxrlz8' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
				...
				<div class="col-md-6">
					...
					<div class="col-md-12">
						<h3>Video 2: Sobre guía práctica para no sufrir de amor</h3>
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/jXEDIC65ae0' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
            ...
            <div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<p style="font-size:16px">Las guías prácticas de Walter Riso son la herramienta perfecta para construir relaciones basadas en los tres pilares imprescindibles del amor: Eros (Deseo), Philia (Amistad), Ágape (Ternura y preocupación). Con ellas podrás iniciar un proceso de mejora y transformación para llevar una vida emocional saludable. ¡Basta de sufrir por amor!, es el momento de hacer una revolución en tu vida y avanzar por un camino donde el amor se viva y se disfrute de una manera plena y saludable.  </p>
