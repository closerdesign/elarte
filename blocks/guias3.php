        	...
        	<div class="row">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									<br /><br />
                                    <center>
										<img style="max-width:300px" class="img img-responsive" src="/admin/_lib/file/imgpublicaciones/Guia-practica-para-afrontar-la-infidelidad.png" alt="Guía práctica para afrontar la infidelidad de la pareja" title="Guía práctica para afrontar la infidelidad de la pareja - Walter Riso">
                                    </center>
                                    <br />
								</div>
							</div>
				...
				<div class="col-md-8">
					<div class="row">
						<div class="col-md-12">
							<br />
							<h2 style="color:#c4e269; font-family:Verdana, Geneva, sans-serif">Guía práctica para afrontar la infidelidad de la pareja</h2>
                            <h3 style="color:#fff;">16 lecciones para descubrir, entender y afrontar la infidelidad.</h3>
                            <br />
