<?php
	...
	<div class="row top">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<p style="font-size:16px">Millones de personas son víctimas de relaciones amorosas inadecuadas y no saben qué hacer al respecto. El miedo a la pérdida, a la soledad y/o al abandono nos impide en ocasiones tomar acciones para mejorar nuestra relación, pero no tomar medidas sólo contamina más el vínculo amoroso y lo vuelve vulnerable y enfermizo. Un amor inseguro es una bomba de tiempo que puede estallar en cualquier momento y lastimarnos profundamente. Estas guías son una excelente herramienta para iniciar un proceso de mejora y crecimiento en nuestra vida emocional, a través de ellas Walter Riso nos muestra una serie de pasos y/o ejercicios para educarnos en el amor y hacer de este una experiencia plena y saludable.</p>
				</div>
			</div>
           ...
           <hr />
            ...
            <div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<p style="font-size:16px" class="text-center">Si prefieres adquirir cada guía de forma independiente, <a href="http://goo.gl/d6ot3D">Haz clíck aquí</a> .</p>
                    <hr />
				</div>
			</div>
