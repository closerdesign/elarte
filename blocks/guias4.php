        	...
        	<div class="row">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									<br /><br />
                                    <center>
										<img style="max-width:300px" class="img img-responsive" src="/admin/_lib/file/imgpublicaciones/No-sufrir-de-amor.png" alt="Guía práctica para no sufrir de amor" title="Guía práctica para no sufrir de amor - Walter Riso">
                                    </center>
                                    <br />
								</div>
							</div>
				...
				<div class="col-md-8">
					<div class="row">
						<div class="col-md-12">
							<br />
							<h2 style="color:#c4e269; font-family:Verdana, Geneva, sans-serif">Guía práctica para no sufrir de amor</h2>
                            <h3 style="color:#fff;">39 Reflexiones y vivencias que te permitirán desarrollar estrategias y esquemas afectivos resistentes.</h3>
                            <br />
