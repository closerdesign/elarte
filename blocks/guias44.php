<?php
    ...
    <div class="row top" style="background-image:url(../img/bannerl1.png); background-position:center;">
    
    	<div class="container">
        	<div class="row">
            	<div class="col-md-8" style="color:#FFF; height:500px;">
                	<br /><br /><br /><br /><br /><br /><br />
					<h1 class="text-center" style="font-size:42px"><b>Guías prácticas de Walter Riso</b></h1>
					<h3 class="text-center"><b>Una herramienta para hacer del amor una experiencia plena y saludable</b></h3>
            ...
            <div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
                		<div class="text-center" style="font-size:24px;">
								<strong>
									Lleva hoy las guías en versión audio o pdf con el <span style="color:red">30% de descuento</span><br />o lleva las dos versiones con el <span style="color:red">50% de descuento</span>
								</strong>
							</div>
					</div>
				</div>
