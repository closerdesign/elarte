	...
	<div class="row top" >
		...
		<div class="container">
            ...
            <div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="text-center" style="font-size:24px;">
                    	<h1 style="color:#500202"><b>Guías prácticas de Walter Riso + Conferencia virtual "Enamorate de ti"</b></h1>
                        <br />
					</div>
				</div>
			</div>
            ...
            <div class="row">
                ...
                <div class="text-center" style="font-size:24px;">
                    <h1 style="color:#500202"><b>¡No dejes escapar esta oportunidad!</b></h1>
                    <br />
				</div>
