		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">¿ES POSIBLE JUNTARSE CON EL AMANTE Y SOBREVIVIR AL INTENTO?</h1>
					<h3 class="text-center">Por Walter Riso</h3>
                    <br />
                    
                    <p style="font-size:16px">
                    La "montaña rusa" emocional de los amantes incluye satisfacción sexual intensa, obnubilación, ternura, alegría, culpa, miedo y temeridad, encanto y desencanto, amor y desamor, dolor y alivio, risas y tristezas, y muchas oscilaciones más. Los amantes son sacudidos por un enredo de afectos y desafectos de todo tipo y de carácter exponencial. Y es esta velocidad y variedad de sentimientos lo que los atrapa. ¿Cómo encauzar esa energía fascinante y fuera de control para domesticarla y que no pierda su esencia vital?
                    </p>
                    <p style="font-size:16px">
                    Formalizar el vínculo y mostrarse al mundo dignamente. Del amor proscrito al cuento de hadas: "Nos amamos, viviremos juntos y construiremos una familia, con los míos, los tuyos y quizá los nuestros". Si estás metido o metida en un plan similar, te recomiendo que bajes un poco las revoluciones. No es para desanimarte, pero sólo la relación de un pequeño porcentaje de los amantes que se casan o se van a vivir juntos funciona. A continuación respondo seis preguntas que pueden servirte de guía antes de tomar la decisión.
                    </p>
                    <br />
                 </div>
             </div>
             ...
             <div class="row">
             	<div class="col-md-4" align="center">
                	...
                	<img class="img img-responsive" src="../img/landings/amantes.png" alt:"Amantes" title="Relación de amantes" />
                    <br />
                </div>
                <div class="col-md-8">
                	
                    <ul style="font-size:16px">
						<li><i>¿Amante o no amante?</i> Pregúntate por qué necesitas un amante. La experiencia demuestra que si no resuelves primero lo que tienes con tu pareja, para bien o para mal, nunca tendrás claridad emocional ni sobre tu amante ni sobre tu pareja. La infidelidad es un paliativo, pero no conduce a nada bueno ni resuelve los problemas de fondo.</li>
                        
                        <li><i>¿Hay algún riesgo de que te quedes sin amante y sin pareja?</i> Sí lo hay. El riesgo de irte a vivir con tu amigo o amiga prematuramente es que no puedas manejar ni la convivencia ni la separación.  Quedarse solo o sola puede ser una buena opción, pero debe resultar de una decisión deseada y pensada, y no como consecuencia de actuaciones impulsivas. Cabeza fría, así el corazón esté recalentado.</li>
                        
                        <li><i>¿Conoces a tu amante lo suficiente para saber si son compatibles para una vida de pareja?</i> Suma las horas que has estado con él o con ella. Piensa qué situaciones has compartido y si te convencen. Pregúntate si necesitas más tiempo. Si lo único que tienes son hermosas anécdotas de hotel, no  tienes nada.</li>
                        
                        <li><i>¿Es amor lo que sientes o has sido víctima de un huracán grado diez que te lleva y te trae como un títere?</i> Antes de echarle sal al postre, antes de bajar del cielo y aterrizar las pasiones, repasa las razones que te tienen junto a él o a ella. Medítalo seriamente, examina los atractivos, las  sensaciones, los deseos y, después, enfría el ímpetu y la relación un poco, trata de comprender qué te llevó a ello y qué te mantiene allí. Intenta ser realista.</li>
                        
                        <li><i>¿Puede construirse algo positivo donde se generó tanto dolor a otros?</i> Algunos dicen que no, que nada bueno surge de lastimar a otros, así sea en nombre del amor. El amor no lo justifica todo. Según los que sostienen este punto de vista, el amor se desvirtúa si necesita del engaño y la mentira. Es sólo para que lo pienses; no sé si tengan razón, pero vale la pena analizarlo.</li>
                        
                        <li><i>¿Eres capaz de confiar en la fidelidad del que fue amante y ahora comparte tu vida?</i>. ¿Eres de los que piensa que si lo hizo una vez, así sea contigo, podría volver a hacerlo? ¿Celos de que el amante o la amante tengan un amante? ¿De que el ex amante (ahora pareja) repita el amor prohibido con otra u otro? En verdad, pasar de cómplice a víctima es una paradoja que agobia y le quita el sueño a más de uno.</li>
             ...
             <div class="row">
             	<br />
                    ...
                    <p style="font-size:16px">
                        "¿Qué tiene de malo irnos a vivir juntos? ¿Acaso no  merecemos ser felices? ¡No es azar que nuestras vidas se hayan cruzado!". Obviamente, nadie merece ser  infeliz. La cuestión es saber si es posible trasplantar la relación de amante a un  matrimonio estable, sin perder la vivacidad que nos hace felices.
                    </p>
