		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Parejas diferentes: ¿Complemento o problema?</h1>
					<h3 class="text-center">Por Walter Riso</h3>
                    <br /><br />
                    <p style="font-size:16px">Un fanático del racismo emparejado con una activista de los derechos humanos no sería una feliz combinación. Como tampoco lo sería un sujeto violento por naturaleza con una mujer pacifista por convicción. Y no hablo de atracción física, sino de convivencia. En ocasiones la gente prefiere ignorar las disparidades, tapar el sol con el dedo y seguir con la relación como si nada pasara. Dos ejemplos:</p>
                 </div>
             </div>
