	...
	<div class="row top" style="background-color:#CCC" >
		...
		<div class="container">
        	...
        	<div class="row">
            	...
            	<h1>ENAMÓRATE DE TI Y SERÁS FELIZ</h1>
                
                <p style="font-size:16px">
                    Durante un seminario para matrimonios, le preguntaron a una mujer: <br />
                    -Te hace feliz tu esposo? ¿Verdaderamente te hace feliz? <br />
                    En ese momento el esposo levantó ligeramente el cuello en señal de seguridad, sabía que su esposa diría que sí, pues ella jamás se había quejado durante su matrimonio. <br />
                    ...
                    Pero lo que no sabes es que PUEDES SER FELIZ<br />
                    aunque... estés enfermo, <br />
                    aunque...haga calor, <br />
                    aunque...no tengas dinero, <br />
                    aunque...alguien te haya insultado, <br />
                    aunque...alguien no te amó , <br />
                    o no te haya valorado . <br /><br />
                    
                    La vida es como andar en bicicleta... te caes, sólo si dejas de pedalear. <br />
                    Empieza tu día con una sonrisa y no permitas que nada ni nadie la borre de tu rostro. <br /><br />
            ...
            <div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
                		<div class="text-center" style="font-size:24px;">
                        	<h1>GUÍAS PRÁCTICAS DE WALTER RISO</h1>
								<h3>
									Adquiere hoy la colección completa en formato texto y formato audio y recibe <span style="color:red">50% de dto</span> mas acceso <span style="color:red">gratis</span> a la conferencia <span style="color:red">"Enamorate de ti"</span>
								</h3>
							</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									<br /><hr />
                                    <h4 class="text-center">Colección de guías prácticas de Walter Riso</h4>
                                    <br />
                                    <p style="font-size:16px">
                                    ...
                                    <p style="font-size:16px">En nuestra tienda cada guía tiene un costo de $6,99 dólares, pero hoy podrás adquirir esta colección completa en formato de audio o en formato pdf con el 30% de descuento. También puedes adquirir los dos formatos con el 50% de descuento y adicional acceso gratis a la conferencia magistral "Enamorate de ti" de Walter Riso el próximo 5 de diciembre. </p>
