	...
	<div class="row top" >
		...
		<div class="container">
        	...
        	<div class="row">
            	...
            	<h1 class="text-center">8 Tips para amarte día a día</h1>
                <br /><br />
            </div>
            <div class="row">
            	<div class="col-md-6">
        	...
        	<div class="row">
                ...
                <div class="col-md-6">
                	...
                	<div style="margin:20px 10px 0px 10px; background-color:#001768; padding:10px 20px 10px 20px;">
                        ...
                        <table border="0" width="100%">
                            <tr height="80px">
                                ...
                                ?>
                                    ...
                                    <td valign="middle">
                                        <span style="font-size:16px; color:#09F"><b>Primera preventa</b></span>
                                        <br />
