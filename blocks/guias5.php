		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center tituloPublicacionInner">
						Colección de las 5 guías prácticas de Walter Riso en formato de AUDIO
					</h1>
				</div>
			</div>
			<hr>
			<div class="row">			
				<div class="col-md-7">
					...
					<div class="row">
						<div class="col-md-12">
							<p>La guías prácticas son una excelente herramienta para iniciar un proceso de mejora y crecimiento personal. Basado en sus más de 30 años de experiencia como psicólogo terapeuta y en sus amplias investigaciones y estudios, Walter Riso nos muestra de una forma sencilla y totalmente práctica los pasos a seguir para lograr objetivos de crecimiento y mejora en nuestra vida emocional.</p>
							<p>Cada tomo de esta colección puede ser leí­do y llevado a la práctica de forma independiente, no llevan una secuencia ni son parte integral de una misma obra. Sin embargo, la unión de todas son un excelente complemento para tener una vida emocional saludable.</p>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							<h1 class="text-center">
								Precio Especial<br />USD <?= number_format($data['precio'],2) ?>
							</h1>
							<?php
