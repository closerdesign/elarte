					...
					<div class="col-lg-8 col-md-8 col-sm-8">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 articulo-detalle">
								...
								<img class="img img-responsive" src="/admin/_lib/file/imgarticulos/<?php echo $data['imagen'] ?>" />
						...
						<div class="row comentarios-articulo">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								...
								<?php
									if(!isset($_SESSION['id'])){
										echo '
											<p>Para poder comentar este artículo debes ser un usuario registrado. <a href="/index.php?content=registrarme">Regístrate</a> o ingresa haciendo click <a href="#">aquí</a>.</p>
										';
									}else{
										?>
				...
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-12 articulos-content">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<?php
									$sql="SELECT * FROM articulos WHERE categoria LIKE '%1%' AND status = 1";
									...
									if($n<1){
										...
										while($post=mysqli_fetch_assoc($q)){
											...
											<div class="col-lg-6 col-md-6 col-sm-6 articulos-container" data-sr="enter bottom and scale up 20% over 2s" >
												<div class="articulos">
													<a href="/index.php?content=articulos&id=<?php echo $post['id'] ?>"><img class="img img-responsive" src="/admin/_lib/file/imgarticulos/<?php echo $post['imagen'] ?>" alt="<?php echo $post['titulo'] ?>" /></a>
													<div class="articulos-inner">
														<h4><a href="/index.php?content=articulos&id=<?php echo $post['id'] ?>"><?php echo $post['titulo']; ?></a></h4>
														<p><?php echo custom_echo(strip_tags($post['contenido'])); ?></p>
													</div>
												</div>
												<div class="cta-blog">
													<p><a href="/index.php?content=articulos&id=<?php echo $post['id'] ?>"><i class='fa fa-plus-square'></i> Leer la nota</a></p>
												</div>
											</div>
											<?php
										}
