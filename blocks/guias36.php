		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Aprende a quererte a ti mismo trabajando en estos 4 elementos</h1>
                    <br />
					...
					<br /><br />
                    Walter Riso, en su guía práctica para mejorar la autoestima señala que hay cuatro elementos que son los más importantes a la hora de configurar la autoestima general; y aunque en la práctica están  entremezclados, para fines didácticos, los separa conceptualmente para analizarlos mejor. Ellos son: 
                    </p>
                    
                    <div class="row">
						<div class="col-md-6">
                        	<img class="img img-responsive" src="../img/landings/autoconcepto.png" alt="Autoconcepto" title="Qué piensas de ti mismo">
                            <br />
                        </div>
                        
                        <div class="col-md-6">
                        	<img class="img img-responsive" src="../img/landings/autoimagen.png" alt="Autoimagen" title="Qué tanto te agradas">
                            <br />
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                        	<img class="img img-responsive" src="../img/landings/autoeficacia.png" alt="Autoeficacia" title="Qué tanta confianza tienes en ti mismo">
                            <br />
                        </div>
                        <div class="col-md-6">
                        	<img class="img img-responsive" src="../img/landings/autorrefuerzo.png" alt="Autorrefuerzo" title="Qué tanto te premias y te das gusto">
                            <br />
                        </div>
                    </div>
                    
                    <p style="font-size:16px">
                    Bien estructurados, serán los cuatro soportes de un "yo sólido" y saludable; y si funcionan mal, serán como los cuatro jinetes del Apocalipsis. Si fallas en alguno de ellos, será suficiente para que tu autoestima se muestre coja e inestable. Más aún, si uno solo de los jinetes se desboca, los tres restantes lo seguirán como una pequeña manada fuera de control. En la guía práctica para mejorar la autoestima de Walter Riso encontrarás una serie de pasos y ejercicios que te orientarán por el camino para trabajar en estos cuatro elementos. </p>
				</div>
			</div>
			<hr>
