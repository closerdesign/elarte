		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">¿Cómo afrontar la soledad afectiva?</h1>
            ...
            <div class="row">
				<div class="col-md-6">
                	...
                	<p style="font-size:16px">La soledad en nuestra cultura es una de las experiencias más difíciles de sobrellevar, más aún en términos del amor. En este video Walter Riso habla de uno de los temas que más enfatiza en sus guías prácticas para aprender a amar sin sufrimiento: La soledad afectiva. Si no sabemos manejar la soledad, si no estamos acostumbrados a ella, o si le tememos, seremos personas vulnerables en el amor, predispuestos a padecer con más intensidad el dolor de una separación, de una infidelidad o de un rechazo afectivo.</p>
				...
				<div class="col-md-6">
					...
					<div class="col-md-12">
						...
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/a9X9fk7UgIk' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<p style="font-size:16px">Aprender a vivir con la soledad no quiere decir que debas ser una persona aislada o que debas estar siempre soltera, por el contrario, serás una persona fuertemente sociable y con la capacidad de llevar relaciones sentimentales plenas y sanas, pero blindada y preparada para afrontar momentos de soledad.  Te invitamos a trabajar en este importante aspecto aplicando  las guías prácticas de Walter Riso, en ellas encontrarás pasos y ejercicios que te conducirán a fortalecer tu relación contigo mismo y a mejorar la forma como llevas tu vida emocional para que el amor se convierta para ti en una experiencia plena y saludable.</p>
				</div>
			</div>
