		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Estereotipos y rótulos que dañan tu autoestima</h1>
                    <br />
				</div>
			</div>
			<hr>
            ...
            <div class="row">
				<div class="col-md-6">
                	...
                	<p style="font-size:16px">Catalogarte y crearte estereotipos vulnera tu estima. Nos han enseñado a amar al prójimo, pero ese amor que brindamos a otros no solemos regalarlo a nosotros mismos. Somos seres humanos fruto de una ideología y un pensamiento que ataca verazmente nuestro ser; desde niños nos llenan de miedos, de límites, de "no puedos" y muchos aspectos más que afectan nuestra autoestima, logrando así crear adultos poco seguros y dispuestos en la vida a rotularse y a dejar que otros lo hagan. 
                    <br /><br />
                    Ten presente este fragmento de una de las Guías prácticas de Walter Riso: "Si le dijeras a la persona que amas: <em>"¡Te equivocaste,  eres una idiota!"</em> ¿cómo se sentiría ella? ¿Cómo reaccionaría? Le harías daño ¿verdad? Pues de igual manera: atacar tu valoración personal, golpear tu valía, te afecta psicológicamente mucho más de lo que piensas". 
                    <br /><br />
                    Si atacas tu YO día a día por tus comportamientos solo ayudarás a crear inseguridad y baja autoestima en ti, somos seres pensantes, capaces de identificar lo negativo de lo positivo. Revisa lo que te dices y de ser cosas negativas comienza el cambio y refuerza tu amor propio sin temor. Si halagas a otros cuando les dices "Qué bonita/o estás", Qué inteligente eres", "Qué buen logro! ¿Por qué no hacerlo contigo mismo?. 
				...
				<div class="col-md-6">
						...
						<p style="font-size:16px">
                            En este mes de la autoestima queremos invitarte a trabajar en este aspecto tan importante de nuestras vidas, y para ello queremos recomendarte poner en práctica la "Guía para mejorar la autoestima" del escritor Walter Riso y que asistas a su conferencia virtual titulada "Enamórate de ti"  que se llevará a cabo el próximo 5 de diciembre. A continuación podrás escuchar el paso 4 de esta guía práctica donde Walter Riso nos habla de este importante tema:
                        </p>
                        
                        <br />
						<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/234369600&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
						</iframe>
						
						<br /><br />
						
						<p style="font-size:16px">
                            <b>¡Recuerda!</b> solo por esta semana, adquiriendo la colección completa de Guías prácticas de Walter Riso en cualquiera de sus versiones obtendrás 30% de descuento y  acceso gratis a la conferencia virtual "Enamórate de ti" del próximo 5 de diciembre. 
                        </p>
