		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Guías prácticas para vivir mejor</h1>
					<h4 class="text-center">Pasos, ejercicios y reflexiones para hacer del amor una experiencia plena y saludable<br />Por Walter Riso</h4>
				</div>
			</div>
			<hr>
