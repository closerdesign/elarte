		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Aprende a expresar y defender tus opiniones de manera firme</h1>
					<h3 class="text-center">La asertividad, un arma no solo para tu vida en pareja sino para todos los aspectos de tu vida</h3>
                    <br /><br />
                    <p style="font-size:16px">¿Qué te impide actuar asertivamente, decir 'no' y no dejarte manipular o explotar? Es posible que en ocasiones sientas el impulso vital a actuar y a defenderte, pero algo te frena. Una fuerza supremamente poderosa y opuesta al enfado entra a escena con el fin de aplacar la rebelión e impedirte comportarte como quisieras.
					</p>
					<p style="font-size:16px">Ser asertivo significa ser capaz de ejercer y/o defender los derechos personales: decir 'no', expresar desacuerdos, dar una opinión contraria y/o expresar sentimientos negativos sin dejarse manipular (como lo haría una persona sumisa) y sin violar los derechos de los demás, (como sí lo hace una persona agresiva). Esta es la clave: La asertividad es un punto medio entre el que se arrodilla y el que aplasta al otro; implica la defensa de los derechos sin lastimar a nadie.</p>

					<p style="font-size:16px">El siguiente esquema de cuestionamientos hace parte de los ejercicios propuestos en la guía práctica para no dejarse manipular y ser asertivo del psicólogo y escritor Walter Riso, los cuales funcionan como un árbol de toma de decisiones que permite reflexionar sobre cada aspecto de la asertividad. La automatización de esta autoguía va familiarizando a las personas con el proceso de toma de decisión necesario para defender los derechos personales:</p>
                 
             		<br />
                    	<ol style="font-size:16px">
                        	<li>La situación provocadora que me impulsa ¿es real o es producto de mi imaginación? </li>
							<li>¿Qué siento y cómo me siento?</li>
                            <li>¿Es vital para mí responder a esta situación?</li>
                            <li>¿Cuál es mi meta?</li>
                            <li>¿Qué consecuencias negativas espero?</li>
                            <li>¿Tengo alternativas de respuesta claras a las consecuencias probables?</li>
                            <li>La ejecución del comportamiento: Ahora hay que estructurar el contenido verbal del mensaje asertivo. Lo que vas a decir, o lo que es lo mismo, la meta expresada en forma verbal. Realiza ensayos imaginados. Busca un lugar cómodo, cierra los ojos y recrea la situación provocadora. Imagínate siendo asertivo y reproduce mentalmente cada componente de manera relajada. Si la ansiedad no te deja, saca la mente de la situación un momento, piensa en algo agradable, relájate, y regresa nuevamente a la imagen dónde estás siendo asertivo. La preparación imaginaria te dará más seguridad a la hora de ejecutar la conducta in situ. Y cuando creas que estás listo, sé atrevido, arriésgate, auto-obsérvate y evalúa tu desempeño de la manera más objetiva posible, es decir, sin lastimarte.</li>
                            <li>Autoevaluación: Después de ejecutar la conducta asertiva, haz una recopilación de lo que hiciste bien y mal. Evalúa si la meta se cumplió, si fallaste en alguno de los siete puntos anteriores, considera los aspectos débiles y las fortalezas; felicítate por intentarlo.</li>
                        </ol>
                 ...
                 <div class="col-md-6">
					...
					<div class="col-md-12">
						...
						<div class='embed-container'>
							...
							<iframe src='https://www.youtube.com/embed/632rGnFJ05A' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
