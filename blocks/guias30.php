		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Carta de un joven que decidió amar a su novia con independencia</h1>
					
                    <br />
                    
                    <p style="font-size:16px">¿Por qué nos ofendemos si nuestra pareja no se angustia con nuestra ausencia? ¿Por qué nos desconcierta tanto que nuestra pareja no sienta celos? ¿Realmente estamos preparados para una relación no dependiente? ¿Alguna vez lo has intentado? ¿Estás dispuesto o dispusta a correr el riesgo de no dominar, no poseer y aprender a perder? Alguna vez te has propuesto seriamente enfrentar tus miedos y emprender la aventura de amar sin apegos, no como algo teórico sino de hecho?. Esta carta es una de las muchas reflexiones que el Dr. Walter Riso comparte en su guía práctica para vencer la dependencia emocional, leela y piensa, ¿Estarías dispuesto o dispuesta a amar de esta forma?</p>
                    <br />
                 </div>
             </div>
             ...
             <div class="row">
                ...
                <div class="row text-center">
                	<h4>¿Qué opinas de esta carta? ¿Estarías dispuesto o dispuesta a amar de esta forma? <br />¿Qué piensas de la reacción de la novia?</h4>
                </div>
            ...
            <div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h5>Te invitamos a participar en esta sala de debate</h5>								
