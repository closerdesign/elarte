		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Un pensamiento que te hará sufrir</h1>
					<h3 class="text-center">La ansiedad anticipatoria</h3>
                    <br /><br />
                    <p style="font-size:16px">Si estás por debajo de tu pareja en el juego del poder afectivo es probable que aparezcan en ti dos síntomas claros de inseguridad y temor. En su guía práctica para no sufrir de amor, el psicólogo y escritor Walter Riso habla de dos síntomas comunes: la ansiedad anticipatoria ("Me va a dejar") y la sumisión ("Temo decirle que no"). A continuación profundizaremos en el primer síntoma o pensamiento compartiendo un fragmento de la guía en mención:<br /><br /></p>
                 </div>
             </div>
             ...
             <div class="row">
             	<div class="col-md-5">
                	<br />
                	<img class="img img-responsive" src="../img/landings/ansiedad-en-pareja.png" alt:"Mujer ansiosa" title="Mujer con ansiedad anticipatoria" />
                </div>
                <div class="col-md-7">
                
                	<p style="font-size:16px"><i><b>Síntoma 1:</b> Buscar la <b>certeza</b> de que nunca te dejarán, lo cual es imposible. Y como la probabilidad <b>real</b> de perder al otro nunca es cero, el miedo al abandono estará activado constantemente. A esto lo llamamos <b>ansiedad anticipatoria</b>: adelantarse a la "catástrofe" del desamor o de la soledad impuesta y obligada. Los  dependientes afectivos suelen convertirse en expertos lectores de las  emociones y los gestos de su pareja, esperando hallar indicadores de desamor. Un paciente me decía con angustia: "Ella es muy tranquila, nunca muestra celos, ni me pregunta adónde voy ni con quien. Tiene tanta confianza en mí que me hace dudar… ¿O será una estrategia para que yo no le pregunte?". La paranoia siempre se filtra cuando la incertidumbre está presente. A la esposa de mi paciente no le pasaba nada raro, simplemente era una mujer que practicaba una relación independiente: <b>podía ser ella misma, estando en pareja</b>. Nuestra cultura ha asociado el amor al sufrimiento de tal manera que si la relación no genera ningún tipo de "dolor amoroso", el amor es insuficiente, sospechoso o enclenque. ¡Qué gran estupidez y cuántos lo piensan!</i></p>
                    <br />
             ...
             <div class="row">
             	<p style="font-size:16px"><i>El compromiso afectivo no se instaura sobre la base de la invasión mutua, como lo promulgan los adictos afectivos. Amar tampoco es una declaración de guerra o una apropiación indebida del ser ajeno: <b>aunque te duela reconocerlo, tu pareja no te pertenece, no es "tuya"</b>. Es enfermizo pensar que la persona que amas te dejará porque no es tan adicta como tú. Si lo que pretendes para estar tranquila o tranquilo, es ver a tu pareja tumbada, con ojeras, deprimida y temerosa de  que la dejes, tienes los cables cruzados: no es ella la que debe volverse apegada a ti, sino que eres tú quien debe desapegarse de ella en el sentido que he descrito antes.</i>
                	<br /><br />
                	Texto extraído de Guía práctica para no sufrir de amor. Esta es una obra del escritor Walter Riso en la cual podrás encontrar una serie de reflexiones y ejercicios para educarse en el amor y hacer de este sentimiento una experiencia plena y saludable. 
