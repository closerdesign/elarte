		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">Dos formas de matar el amor</h1>
					<h3 class="text-center"><i>"El amor tiene dos enemigos principales: la indiferencia, que lo mata lentamente, y la desilusión , que lo elimina de una vez"</i>. Walter Riso </h3>
                    <br />
				</div>
			</div>
			<hr>
            ...
            <div class="row">
				<div class="col-md-6">
                	...
                	<p style="font-size:16px"><b>La muerte lenta del amor ocurre con la indiferencia, que es el principal enemigo del amor</b>. El desinterés por el otro desvincula e incapacita. El amor expira en la reiterada mirada ausente, en la caricia que no llega. Casi siempre, la indiferencia de la otra persona duele más que un insulto o un golpe.
					<br /><br />
<b>La muerte súbita del amor acontece a manos de la decepción: la mezcla de asombro negativo y desilusión.</b> Algunos desengaños son esenciales y destruyen toda forma de admiración, que es una de las puertas de entrada al amor. Es imposible amar a quien no se admira, a menos para nosotros que no somos iluminados y santos. Se puede admirar sin amar, es verdad, pero lo opuesto sólo se concibe desde la enfermedad.</p>
				...
				<div class="col-md-6">
						...
						<p style="font-size:16px">
                        	A continuación podrás escuchar la "Reflexión 17" de la Guía práctica para no sufrir de amor (version audio) del prestigioso psicólogo y escritor Walter Riso, donde nos habla de este importante tema:
                        </p>
                        
                        <br /><br />
						<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/229512520&amp;color=ff9900&amp;auto_play=false&amp;hide_related=true&amp;show_comments=false&amp;show_user=false&amp;show_reposts=false"></iframe>
						</iframe>
