<?php
	...
	$titulo = "Aquí va el titulo";
	$subtitulo = "Aquí va el subtitulo";
	$file_no = 43;
	...
	$contCol[1][1] = '<p><i>"Pelear la vida. A regañadientes, a las malas, con las uñas, como quieras, pero no hay otra opción. Puedes sentarte a llorar tu mala suerte, a lamentarte de la "injusta" soledad, a sentir lástima por tu aporreado yo y autocompadecerte. O por el contrario, puedes levantar cabeza y aplicar una dosis de racionalidad a tu desajustado corazón".</i></p>';
	
	$contCol[2][1] = '<img class="img img-responsive" src="../img/landings/mujer-sola.png" alt="Mujer sola" title="Mujer en soledad">';
	
	$contCol[2][2] = '<img class="img img-responsive" src="../img/landings/mujer-sola.png" alt="Mujer sola" title="Mujer en soledad">';
	
	$contCol[2][3] = '<img class="img img-responsive" src="../img/landings/mujer-sola.png" alt="Mujer sola" title="Mujer en soledad">';
	
	$contCol[3][1] = '<p><i>"Pelear la vida. A regañadientes, a las malas, con las uñas, como quieras, pero no hay otra opción. Puedes sentarte a llorar tu mala suerte, a lamentarte de la "injusta" soledad, a sentir lástima por tu aporreado yo y autocompadecerte. O por el contrario, puedes levantar cabeza y aplicar una dosis de racionalidad a tu desajustado corazón".</i></p>';
	...
	<div class="row top" style="background-color:#CCC" >
		...
		<div class="container">
			...
			for($i=1; $i<=count($tamCol); $i++)
			{
				
				echo '<div class="row" style="font-size:16px">';
				
				for($j=1; $j<=count($tamCol[$i]); $j++)
				{
					$tamColActual = $tamCol[$i][$j];
					
					echo '<div class="col-md-'.$tamColActual.'">';
