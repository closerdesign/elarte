		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">¿Es un error jurar amor eterno?</h1>
					<h3 class="text-center">Sala de debate</h3>
                    <br />
                 </div>
             </div>
             ...
             <div class="row">
                ...
                <div class="col-md-6">
                	...
                	<p style="font-size:16px">Esto fue lo que dijo de Walter Riso cuando se le pidió su opinión acerca de jurar amor eterno:</p>
                    <br />
            ...
            <div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php
					$actual_link = "http://www.elartedesabervivir.com/guias/es-un-error-prometer-amor-eterno";
					?>
					<div id="fb-root"></div>
