		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">¿Estaría bien volver con mi ex-pareja?</h1>
            ...
            <div class="row">
				<div class="col-md-12">
                	...
                	<p style="font-size:16px">En este tipo de dilema, unos dicen que las segundas partes no son buenas, otros disfrutan de las reconciliaciones y otros están de acuerdo en que todo el mundo merece una segunda oportunidad y han sido más felices que en el primer intento de su relación. Pero veamos que dice el Dr. Walter Riso, experto en relaciones de pareja:</p>
            ...
            <div class="row">
				<div class="col-md-6">
                	<h3>Video 1: ¿Me puedo enamorar de mi ex-pareja? Por Walter Riso</h3>
                	<style>
					...
					<div class="col-md-12">
						...
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/iduAO5Y-7I4' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
                ...
                <div class="col-md-6">
                	<h3>Video 2: Sobre guía práctica para vencer la dependencia emocional</h3>
                	<style>
						.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }
					</style>
					<div class="col-md-12">
						...
						<div class='embed-container'>
							<iframe src='https://www.youtube.com/embed/rZyErX9wZFg' frameborder='0' allowfullscreen>
							</iframe>
						</div>
						<br />
						<br />
