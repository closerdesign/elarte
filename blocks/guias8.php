<?php
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">¿Cómo reconocer si soy un dependiente afectivo?</h1>
					<h4 class="text-center">7 criterios que te ayudarán a reconocer si eres un dependiente emocional</h4>
                    <br />
                    <p style="font-size:16px">
                    
                    A continuación encontrarás el segundo de los trece pasos de la guía práctica para vencer la dependencia emocional del prestigioso psicólogo y escritor Walter Riso. En este paso, Walter expone 7 criterios para que el lector identifique si él o su pareja sufren o tienen tendencia a sufrir de dependencia emocional. Recuerda que esta guía es una herramienta con una serie de pasos o ejercicios prácticos para vencer la dependencia, y que en conjunto con el resto de guías prácticas son el material perfecto para aprender a hacer del amor una experiencia plena y saludable.  
                    
                    <br /><br />
                    
                    <div align="center">
                    
                        <div style="background-color:#FFF; padding:50px; font-size:14px; text-align:justify; max-width:620px;">
                            	<div align="right"><h5>Guía práctica para vencer la dependencia emocional - Walter Riso</h5></div>
                                <hr />
                                <h4>Paso 2. Reconocer la dependencia en uno mismo</h4>
                                <br />	
    ...
    <br /><br />
    <ul>
        <li>Necesidad imperiosa de estar cerca de la persona amada o sentir amor la mayor parte del tiempo.</li>
    <li>Abstinencia manifiesta, si no se tienen las manifestaciones de afecto o la persona amada disponible. Es decir, desorganización conductual, malestar, ansiedad o simplemente desasosiego, similar a lo que ocurre con una persona adicta a cualquier droga química a la cual se le retira la misma.</li>
    <li>Incapacidad de controlar la compulsión de estar con la persona amada.</li>
    <li>Se emplea mucho tiempo mental y físico en mantenerse cerca de la pareja u obtener amor.</li>
    <li>Altos niveles de obsesión, preocupación y/o comportamientos vigilantes y controladores por miedo a perder la fuente del placer/seguridad (temor al abandono, a un engaño, o a la soledad).</li>
    <li>Reducción de actividades sociales, laborales o recreativas (reducción hedonista) para estar con la persona amada.</li>
    <li>Pese a tener claras las consecuencias negativas de amar sin límites (v. g. depresión, descontrol, ansiedad, baja autoestima, desorganización conductual, violencia intrafamiliar), se sigue manteniendo el estilo de vida dependiente.</li>
    </ul>
    <br />
