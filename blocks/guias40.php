		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="text-center">CUATRO PREMISAS PARA UN AMOR INTELIGENTE</h1>
                    <br />
                    <p style="font-size:16px">
                    	Un amor racional es aquel que además de sentirse se piensa. Es una manera de relacionarse, donde el "ser para sí" y el "ser para el otro" se integra en un "nosotros" saludable. En el amor racional el sentimiento, por sí solo, no basta. Un amor descerebrado es puro impulso. "Contigo, pan y cebolla" es un viejo dicho napolitano, el cual inspiró la película de los años cincuenta de Marcelo Mastroiani y Sofía Loren, que significa algo así como: "Si te tengo, no necesito nada más". Afirmación peligrosa para quien quiera buscar su autorrealización. Para no sufrir de amor es importante amar y disfrutar del amor con los pies en la tierra, para ello Walter Riso en su guía práctica para no sufrir de amor habla de 4 premisas a tener en cuenta:
                ...
                <div class="row">
					<div class="col-md-4">
                    	<br />
                        <img class="img img-responsive" src="../img/landings/dudan-que-te-aman.png" alt="Si alguien duda que te ama, no te ama" title="Premisa 1: Si alguien duda que te ama, no te ama">
                        
                     </div>
                        
                     <div class="col-md-8">
                        
                        	<h3>Si alguien duda que te ama, no te ama:</h3>
                            <br />
                    		<p style="font-size:16px">A los enamorados hay que frenarlos, no empujarlos. "No estoy seguro" o "Necesito tiempo", son algunas de las expresiones del titubeo afectivo. Cuando el amor hace mella nos atraviesa de lado a lado como un choque eléctrico, es una evidencia que se sustenta a sí misma, no cabe la duda. En esto se parece al orgasmo: si alguien no está seguro que lo tuvo, no lo tuvo. Otra cosa es decir que no nos conviene, que quiero desenamorarme, que somos incompatibles, así exista afecto. "Te quiero, pero no te amo": ¿quién no ha sido victima de esta frase tenebrosa? Amor subdesarrollado, que no llega, que se achica, que desfallece antes de germinar.</p>
                ...
                <div class="row">
					<div class="col-md-4">
                    	<br />
                        <img class="img img-responsive" src="../img/landings/no-te-merece-si-te-lastima.png" alt="Si alguien duda que te ama, no te ama" title="Premisa 1: Si alguien duda que te ama, no te ama">
                        
                     </div>
                        
                     <div class="col-md-8">
                        
                        	<h3>No te merece quien te lastima intencionalmente:</h3>
                            <br />
                    		<p style="font-size:16px">¿Para qué seguir con alguien que nos hace daño? Un amor saludable no exige eso. Amar no es hacer un culto al sacrificio ni negociar los principios fundamentales. Si la persona que supuestamente te ama, te hiere o viola tus derechos, pues su manera de amar es enfermiza. El sentimiento aquí no tiene nada que ver. No se trata de ser un buen samaritano o poner la otra mejilla, un denuncio a tiempo es más efectivo, un alejamiento más recomendable. No solo tenemos que hacernos merecedores del otro, sino que la pareja también debe merecernos. Repito: la dignidad no es negociable, no importa cuantas arandelas amorosas quieran colgarle.</p>
                ...
                <div class="row">
					<div class="col-md-4">
                    	<br />
                        <img class="img img-responsive" src="../img/landings/el-amor-debe-ser-reciproco.png" alt="Si alguien duda que te ama, no te ama" title="Premisa 1: Si alguien duda que te ama, no te ama">
                        
                     </div>
                        
                     <div class="col-md-8">
                        
                        	<h3>El buen amor es recíproco:</h3>
                            <br />
                    		<p style="font-size:16px">Democracia afectiva, equilibrio, Amor justo, sindicalizado, bien repartido, no milimétrico pero adecuadamente dosificado. Horizontal dentro y fuera de la cama, ¿No esperar nada a cambio? Eso es para un amor universal, que trasciende el individuo, eso es mística o sentido de vida o misión humanitaria. En las relaciones cara a cara todos esperamos: si eres fiel, esperas fidelidad; si das sexo, esperas sexo; si eres cariñoso, esperarás cariño. Los que creen que pueden vivir con dar y no recibir, al cabo de un tiempo se frustran y deprimen, ya que es natural y congruente con la condición humana buscar un balance interpersonal. Algunas persona solo saben relacionarse desde la explotación o adoptando actitudes de victima. Todo amor "vertical" está contraindicado.</p>
                ...
                <div class="row">
                	<p style="font-size:16px">
                    	<br />
                    	Cuatro premisas sin anestesia que se trabajan a profundidad en la guía práctica para no sufrir de amor de Walter Riso. Tratamiento para el alma, ver lo que es, enfriar la cabeza y poner el corazón a buen resguardo. El amor es un sentimiento, ¡claro!, pero podemos gestionarlo, pensarlo y admnistrarlo para evitar golpes que afectan nuestra vida emocional. No importa lo que digan los enamorados del amor, el realismo afectivo salva gente y la ubica en un terreno fértil para que el "yo" no se destruya a si mismo persiguiendo un imposible.
                    </p>
