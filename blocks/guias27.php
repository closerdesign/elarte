		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<h4 class="text-center">Una herramienta para superar la dependencia afectiva</h4>
                    <br />
                    <p style="font-size:16px">
                    Walter Riso, en su guía práctica para vencer la dependencia emocional afirma que la dependencia afectiva es la incapacidad de renunciar a la pareja cuando debe hacerse. ¿Pero cuando debemos hacerlo?: Según Walter Riso debemos renunciar cuando esa relación es perjudicial para tu salud mental, y normalmente es perjudicial cuando ocurren por lo menos estas tres cosas:
                    </p>
                    
                    <div class="row">
						<div class="col-md-4">
                        	<img class="img img-responsive" src="../img/landings/renuncia-a-un-amor1.png" alt="No te quieren como te gustaría que te quisieran" title="Renuncia si no te quieren como te gustaría que te quisieran">
                            <br />
                        </div>
                        
                        <div class="col-md-4">
                        	<img class="img img-responsive" src="../img/landings/renuncia-a-un-amor2.png" alt="No te puedes autorealizar como persona" title="Renuncia a un amor si no te puedes autorealizar como persona">
                            <br />
                        </div>
                        
                        <div class="col-md-4">
                        	<img class="img img-responsive" src="../img/landings/renuncia-a-un-amor3.png" alt="Violan tus principios o valores básicos" title="Renuncia a un amor s vViolan tus principios o valores básicos">
                            <br />
                        </div>
                    </div>
                    
                    <p style="font-size:16px">
                    Las guías prácticas de Walter Riso son la herramienta perfecta para aprender a desligar el amor del sufrimiento, pensamos que cuando se sufre es porque hay amor, y eso es un grave error. Las 5 guías prácticas te servirán para construir relaciones de pareja saludables o para que sepas como manejar relaciones que hoy te quitan tranquilidad, trabajando en temas como la dependencia afectiva, la autoestima, la asertividad, la infidelidad, entre otros. ¡Basta de sufrir por amor!, es el momento de hacer una revolución en tu vida y avanzar por un camino donde el amor se viva y se disfrute de una manera plena y saludable. </p>
				</div>
			</div>
			<hr>
