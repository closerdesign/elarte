...
if ( isset( $session ) ) {
	...
	/* ---- Session Variables -----*/
	if ( registroDeUsuariosFacebook($fbid, $fbfullname, $firstName, $lastName, $femail, $url_actual) ) {
		$_SESSION['FBID'] = $fbid;
		header( "Location: http://www.elartedesabervivir.com".$url_actual );
	}else{
