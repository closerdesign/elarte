...
<?php
include_once("form_inscritos_conferencia_edit_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_inscritos_conferencia_edit_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['recarga'];
}
?>
...
<?php
 include_once("form_inscritos_conferencia_edit_mob_js0.php");
?>
...
<form name="F1" method="post" 
               action="form_inscritos_conferencia_edit_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_inscritos_conferencia_edit_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_inscritos_conferencia_edit_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_id_inscripcion" style="<?php echo $sStyleHidden_id_inscripcion; ?>text-align:right;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd" style="text-align:right;;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style="text-align:right;" ><span id="id_label_id_inscripcion"><?php echo $this->nm_new_label['id_inscripcion']; ?></span></span><br><span id="id_read_on_id_inscripcion" style="text-align:right;<?php echo $sStyleReadLab_id_inscripcion; ?>"><?php echo NM_encode_input($this->id_inscripcion); ?></span><span id="id_read_off_id_inscripcion" style="<?php echo $sStyleReadInp_id_inscripcion; ?>"><input type="hidden" name="id_inscripcion" value="<?php echo NM_encode_input($id_inscripcion) . "\">"?><span id="id_ajax_label_id_inscripcion"><?php echo nl2br($id_inscripcion); ?></span>
...
<?php } 
?> 
<?php $sStyleHidden_id_inscripcion_dumb = ('' == $sStyleHidden_id_inscripcion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_inscripcion_dumb" style="<?php echo $sStyleHidden_id_inscripcion_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_estado_inscripcion'][] = '0'; ?>
 <option value="1" <?php  if ($this->estado_inscripcion == "1") { echo " selected" ;} ?>>Exitosa</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_estado_inscripcion'][] = '1'; ?>
 <option value="2" <?php  if ($this->estado_inscripcion == "2") { echo " selected" ;} ?>>Pendiente</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_estado_inscripcion'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_metodo_pago'][] = '1'; ?>
 <option value="2" <?php  if ($this->metodo_pago == "2") { echo " selected" ;} ?>>Paypal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_metodo_pago'][] = '2'; ?>
 <option value="3" <?php  if ($this->metodo_pago == "3") { echo " selected" ;} ?>>Transferencia PSE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_metodo_pago'][] = '3'; ?>
 <option value="4" <?php  if ($this->metodo_pago == "4") { echo " selected" ;} ?>>Puntos VIA Baloto</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_metodo_pago'][] = '4'; ?>
 <option value="5" <?php  if ($this->metodo_pago == "5") { echo " selected" ;} ?>>OXXO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_metodo_pago'][] = '5'; ?>
 <option value="6" <?php  if ($this->metodo_pago == "6") { echo " selected" ;} ?>>BCP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_metodo_pago'][] = '6'; ?>
 <option value="7" <?php  if ($this->metodo_pago == "7") { echo " selected" ;} ?>>Crédito</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['Lookup_metodo_pago'][] = '7'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_valor_inscripcion_dumb = ('' == $sStyleHidden_valor_inscripcion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_valor_inscripcion_dumb" style="<?php echo $sStyleHidden_valor_inscripcion_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_id_pedido" style="<?php echo $sStyleHidden_id_pedido; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_id_pedido"><?php echo $this->nm_new_label['id_pedido']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_id_pedido_dumb = ('' == $sStyleHidden_id_pedido) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_pedido_dumb" style="<?php echo $sStyleHidden_id_pedido_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_creado" style="<?php echo $sStyleHidden_creado; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_creado"><?php echo $this->nm_new_label['creado']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia_edit_mob']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_inscritos_conferencia_edit_mob");
 parent.scAjaxDetailHeight("form_inscritos_conferencia_edit_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
