...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['sc_outra_jan'])
      {
          $this->sc_init_menu = "x";
