...
$_SESSION['scriptcase']['app_Login']['contr_erro'] = 'off';
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['sc_outra_jan'])
      {
          $this->sc_init_menu = "x";
