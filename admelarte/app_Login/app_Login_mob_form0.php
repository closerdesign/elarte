...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<input type="hidden" name="links" value="<?php echo NM_encode_input($this->links) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd" id="hidden_field_data_links" style="<?php echo $sStyleHidden_links; ?>;"> 
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["links"]) &&  $this->nmgp_cmp_readonly["links"] == "on") { 

 ?>
<input type="hidden" name="links" value="<?php echo NM_encode_input($links) . "\">" . $links . ""; ?>
<?php } else { ?>

<input type="hidden" name="links" value = "">

 <a href="javascript:nm_menu_link_links('app_form_add_users')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<br>
