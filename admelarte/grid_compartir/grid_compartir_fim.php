...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Phronesis_____grid_compartir"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Phronesis_____grid_compartir"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_compartir']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_compartir']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_compartir']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_compartir']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_compartir']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_compartir']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_compartir']['embutida_filho'] as $ind => $sc_init)
          {
