...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idcompartir";$Nm_numeric[] = "idcompartir";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_idcompartir"  <?php echo $str_hide_idcompartir?>><?php
      $idcompartir_look = substr($this->Db->qstr($idcompartir), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idcompartir" name="idcompartir_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_idcompartir"  <?php echo $str_display_idcompartir; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcompartir_input_2" name="idcompartir_input_2" value="<?php echo NM_encode_input($idcompartir_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tunombre"  <?php echo $str_hide_tunombre?>><?php
      $tunombre_look = substr($this->Db->qstr($tunombre), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_emailamigo"  <?php echo $str_hide_emailamigo?>><?php
      $emailamigo_look = substr($this->Db->qstr($emailamigo), 1, -1); 
      $nmgp_def_dados = array(); 
