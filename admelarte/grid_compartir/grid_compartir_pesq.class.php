...
class grid_compartir_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_compartir_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_compartir_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_compartir_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idcompartir')
      {
          $idcompartir = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idcompartir($idcompartir);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tunombre')
      {
          $tunombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tunombre($tunombre);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_emailamigo')
      {
          $emailamigo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_emailamigo($emailamigo);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_idcompartir($idcompartir)
   {
      $idcompartir = substr($this->Db->qstr($idcompartir), 1, -1);
            $idcompartir_look = substr($this->Db->qstr($idcompartir), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct idCompartir from " . $this->Ini->nm_tabela . " where  idCompartir like '%" . $idcompartir . "%'"; 
   ...
   function lookup_ajax_tunombre($tunombre)
   {
      $tunombre = substr($this->Db->qstr($tunombre), 1, -1);
            $tunombre_look = substr($this->Db->qstr($tunombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tuNombre from " . $this->Ini->nm_tabela . " where  tuNombre like '%" . $tunombre . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_emailamigo($emailamigo)
   {
      $emailamigo = substr($this->Db->qstr($emailamigo), 1, -1);
            $emailamigo_look = substr($this->Db->qstr($emailamigo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct emailAmigo from " . $this->Ini->nm_tabela . " where  emailAmigo like '%" . $emailamigo . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - compartir</TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_compartir_ajax_search.js"></script>
 <script type="text/javascript" src="grid_compartir_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idcompartir_cond#NMF#' + search_get_sel_txt('SC_idcompartir_cond') + '@NMF@';
  str_out += 'SC_idcompartir#NMF#' + search_get_text('SC_idcompartir') + '@NMF@';
  str_out += 'id_ac_idcompartir#NMF#' + search_get_text('id_ac_idcompartir') + '@NMF@';
  str_out += 'SC_idcompartir_input_2#NMF#' + search_get_text('SC_idcompartir_input_2') + '@NMF@';
  str_out += 'SC_tunombre_cond#NMF#' + search_get_sel_txt('SC_tunombre_cond') + '@NMF@';
  str_out += 'SC_tunombre#NMF#' + search_get_text('SC_tunombre') + '@NMF@';
  str_out += 'id_ac_tunombre#NMF#' + search_get_text('id_ac_tunombre') + '@NMF@';
  str_out += 'SC_emailamigo_cond#NMF#' + search_get_sel_txt('SC_emailamigo_cond') + '@NMF@';
  str_out += 'SC_emailamigo#NMF#' + search_get_text('SC_emailamigo') + '@NMF@';
  str_out += 'id_ac_emailamigo#NMF#' + search_get_text('id_ac_emailamigo') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_tunombre").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tunombre",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_tunombre").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tunombre").val( $(this).val() );
       }
     }
   });
   $("#id_ac_emailamigo").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_emailamigo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_emailamigo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_emailamigo").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_idcompartir").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idcompartir",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_idcompartir").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idcompartir").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - compartir</span></td>
...
<?php
   ...
   {
      global 
             $idcompartir_cond, $idcompartir, $idcompartir_input_2, $idcompartir_autocomp,
             $tunombre_cond, $tunombre, $tunombre_autocomp,
             $emailamigo_cond, $emailamigo, $emailamigo_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idcompartir = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['idcompartir']; 
          $idcompartir_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['idcompartir_input_2']; 
          $idcompartir_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['idcompartir_cond']; 
          $tunombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['tunombre']; 
          $tunombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['tunombre_cond']; 
          $emailamigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['emailamigo']; 
          $emailamigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['emailamigo_cond']; 
          $url = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['url']; 
          $url_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['url_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idcompartir_cond) || empty($idcompartir_cond))
      {
         $idcompartir_cond = "gt";
      }
      if (!isset($tunombre_cond) || empty($tunombre_cond))
      {
         $tunombre_cond = "qp";
      }
      if (!isset($emailamigo_cond) || empty($emailamigo_cond))
      {
         $emailamigo_cond = "qp";
      }
      ...
      $str_hide_idcompartir = (in_array($idcompartir_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tunombre = (in_array($tunombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_emailamigo = (in_array($emailamigo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_url = (in_array($url_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idcompartir = ('bw' == $idcompartir_cond) ? $display_aberto : $display_fechado;

      if (!isset($idcompartir) || $idcompartir == "")
      {
          $idcompartir = "";
      }
      if (isset($idcompartir) && !empty($idcompartir))
      {
         $tmp_pos = strpos($idcompartir, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idcompartir = substr($idcompartir, 0, $tmp_pos);
         }
      }
      if (!isset($tunombre) || $tunombre == "")
      {
          $tunombre = "";
      }
      if (isset($tunombre) && !empty($tunombre))
      {
         $tmp_pos = strpos($tunombre, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tunombre = substr($tunombre, 0, $tmp_pos);
         }
      }
      if (!isset($emailamigo) || $emailamigo == "")
      {
          $emailamigo = "";
      }
      if (isset($emailamigo) && !empty($emailamigo))
      {
         $tmp_pos = strpos($emailamigo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $emailamigo = substr($emailamigo, 0, $tmp_pos);
         }
      }
      if (!isset($url) || $url == "")
      {
...
<?php
   if (is_file("grid_compartir_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcompartir'])) ? $this->New_label['idcompartir'] : "Id Compartir"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcompartir_cond" name="idcompartir_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcompartir'), this, 'idcompartir')">
       <OPTION value="gt" <?php if ("gt" == $idcompartir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcompartir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcompartir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idcompartir_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idcompartir" <?php echo $str_hide_idcompartir?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idcompartir'])) ? $this->New_label['idcompartir'] : "Id Compartir";
 $nmgp_tab_label .= "idcompartir?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $idcompartir_look = substr($this->Db->qstr($idcompartir), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idcompartir))
   { 
      $nm_comando = "select distinct idCompartir from " . $this->Ini->nm_tabela . " where idCompartir = $idcompartir_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$idcompartir]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idcompartir];
      }
      else
      {
          $sAutocompValue = $idcompartir;
      }
?>
<INPUT  type="text" id="SC_idcompartir" name="idcompartir" value="<?php echo NM_encode_input($idcompartir) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idcompartir" name="idcompartir_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idcompartir"  <?php echo $str_display_idcompartir; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcompartir_input_2" name="idcompartir_input_2" value="<?php echo NM_encode_input($idcompartir_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tunombre'])) ? $this->New_label['tunombre'] : "Tu Nombre"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tunombre_cond" name="tunombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_tunombre'), this, 'tunombre')">
       <OPTION value="qp" <?php if ("qp" == $tunombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tunombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tunombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tunombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tunombre" <?php echo $str_hide_tunombre?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tunombre'])) ? $this->New_label['tunombre'] : "Tu Nombre";
 $nmgp_tab_label .= "tunombre?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $tunombre_look = substr($this->Db->qstr($tunombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tuNombre from " . $this->Ini->nm_tabela . " where tuNombre = '$tunombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$tunombre]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tunombre];
      }
      else
      {
          $sAutocompValue = $tunombre;
      }
?>
<INPUT  type="text" id="SC_tunombre" name="tunombre" value="<?php echo NM_encode_input($tunombre) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tunombre" name="tunombre_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['emailamigo'])) ? $this->New_label['emailamigo'] : "Email Amigo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_emailamigo_cond" name="emailamigo_cond" onChange="nm_campos_between(document.getElementById('id_vis_emailamigo'), this, 'emailamigo')">
       <OPTION value="qp" <?php if ("qp" == $emailamigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $emailamigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $emailamigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $emailamigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_emailamigo" <?php echo $str_hide_emailamigo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['emailamigo'])) ? $this->New_label['emailamigo'] : "Email Amigo";
 $nmgp_tab_label .= "emailamigo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $emailamigo_look = substr($this->Db->qstr($emailamigo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct emailAmigo from " . $this->Ini->nm_tabela . " where emailAmigo = '$emailamigo_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$emailamigo]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$emailamigo];
      }
      else
      {
          $sAutocompValue = $emailamigo;
      }
?>
<INPUT  type="text" id="SC_emailamigo" name="emailamigo" value="<?php echo NM_encode_input($emailamigo) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_emailamigo" name="emailamigo_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['url'])) ? $this->New_label['url'] : "Url"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_url_cond" name="url_cond" onChange="nm_campos_between(document.getElementById('id_vis_url'), this, 'url')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_url" name="url_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compartir']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_compartir']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_idcompartir'), document.F1.idcompartir_cond, 'idcompartir');
   document.F1.idcompartir.value = "";
   document.F1.idcompartir_autocomp.value = "";
   document.F1.idcompartir_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_tunombre'), document.F1.tunombre_cond, 'tunombre');
   document.F1.tunombre.value = "";
   document.F1.tunombre_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_emailamigo'), document.F1.emailamigo_cond, 'emailamigo');
   document.F1.emailamigo.value = "";
   document.F1.emailamigo_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Phronesis/grid_compartir";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_idcompartir_cond'] = 'cond';
      $tp_fields['SC_idcompartir'] = 'text_aut';
      $tp_fields['id_ac_idcompartir'] = 'text_aut';
      $tp_fields['SC_idcompartir_input_2'] = 'text';
      $tp_fields['SC_tunombre_cond'] = 'cond';
      $tp_fields['SC_tunombre'] = 'text_aut';
      $tp_fields['id_ac_tunombre'] = 'text_aut';
      $tp_fields['SC_emailamigo_cond'] = 'cond';
      $tp_fields['SC_emailamigo'] = 'text_aut';
      $tp_fields['id_ac_emailamigo'] = 'text_aut';
   ...
   {
      global $idcompartir_cond, $idcompartir, $idcompartir_input_2, $idcompartir_autocomp,
             $tunombre_cond, $tunombre, $tunombre_autocomp,
             $emailamigo_cond, $emailamigo, $emailamigo_autocomp,
             $url_cond, $url, $url_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($idcompartir_autocomp) && empty($idcompartir))
      {
          $idcompartir = $idcompartir_autocomp;
      }
      if (!empty($tunombre_autocomp) && empty($tunombre))
      {
          $tunombre = $tunombre_autocomp;
      }
      if (!empty($emailamigo_autocomp) && empty($emailamigo))
      {
          $emailamigo = $emailamigo_autocomp;
      }
      if (!empty($url_autocomp) && empty($url))
      {
          $url = $url_autocomp;
      }
      $idcompartir_cond_salva = $idcompartir_cond; 
      if (!isset($idcompartir_input_2) || $idcompartir_input_2 == "")
      {
          $idcompartir_input_2 = $idcompartir;
      }
      $tunombre_cond_salva = $tunombre_cond; 
      if (!isset($tunombre_input_2) || $tunombre_input_2 == "")
      {
          $tunombre_input_2 = $tunombre;
      }
      $emailamigo_cond_salva = $emailamigo_cond; 
      if (!isset($emailamigo_input_2) || $emailamigo_input_2 == "")
      {
          $emailamigo_input_2 = $emailamigo;
      }
      ...
      if ($idcompartir_cond != "in")
      {
          nm_limpa_numero($idcompartir, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $idcompartir);
          ...
          $idcompartir = implode(",", $Nm_sc_valores);
      }
      if ($idcompartir_cond != "in")
      {
          nm_limpa_numero($idcompartir_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['idcompartir'] = $idcompartir; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['idcompartir_input_2'] = $idcompartir_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['idcompartir_cond'] = $idcompartir_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['tunombre'] = $tunombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['tunombre_cond'] = $tunombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['emailamigo'] = $emailamigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['emailamigo_cond'] = $emailamigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['url'] = $url; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['url_cond'] = $url_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!is_numeric($idcompartir) && $idcompartir_cond != "in")
      {
          $idcompartir = "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idcompartir'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idcompartir'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idcompartir'] = $idcompartir;
      }
      $Conteudo = $idcompartir_input_2;
      if (strtoupper($idcompartir_cond) != "II" && strtoupper($idcompartir_cond) != "QP" && strtoupper($idcompartir_cond) != "NP" && strtoupper($idcompartir_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idcompartir_input_2'] = $Conteudo;
      $tunombre_look = substr($this->Db->qstr($tunombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct tuNombre from " . $this->Ini->nm_tabela . " where tuNombre = '$tunombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tunombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tunombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tunombre'] = $tunombre;
      }
      $emailamigo_look = substr($this->Db->qstr($emailamigo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct emailAmigo from " . $this->Ini->nm_tabela . " where emailAmigo = '$emailamigo_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['emailamigo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['emailamigo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['emailamigo'] = $emailamigo;
      }
      $url_look = substr($this->Db->qstr($url), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct url from " . $this->Ini->nm_tabela . " where url = '$url_look'"; 
      ...
      if (isset($idcompartir) || $idcompartir_cond == "nu" || $idcompartir_cond == "nn" || $idcompartir_cond == "ep" || $idcompartir_cond == "ne")
      {
         $this->monta_condicao("idCompartir", $idcompartir_cond, $idcompartir, $idcompartir_input_2, "idcompartir");
      }

      //----- $tunombre
      $this->Date_part = false;
      if (isset($tunombre) || $tunombre_cond == "nu" || $tunombre_cond == "nn" || $tunombre_cond == "ep" || $tunombre_cond == "ne")
      {
         $this->monta_condicao("tuNombre", $tunombre_cond, $tunombre, "", "tunombre");
      }

      //----- $emailamigo
      $this->Date_part = false;
      if (isset($emailamigo) || $emailamigo_cond == "nu" || $emailamigo_cond == "nn" || $emailamigo_cond == "ep" || $emailamigo_cond == "ne")
      {
         $this->monta_condicao("emailAmigo", $emailamigo_cond, $emailamigo, "", "emailamigo");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compartir']['where_pesq_ant'] = $this->comando . $this->comando_fim;
