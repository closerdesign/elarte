<?php
   ...
   session_start();
    $Ord_Cmp = new grid_compartir_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_compartir_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['tunombre'] = "on";
   $tab_def_campos['tunombre'] = "tuNombre";
   $tab_converte["tuNombre"]   = "tunombre";
   $tab_labels["tunombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["tunombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["tunombre"] : "Tu Nombre";
   $tab_ger_campos['emailamigo'] = "on";
   $tab_def_campos['emailamigo'] = "emailAmigo";
   $tab_converte["emailAmigo"]   = "emailamigo";
   $tab_labels["emailamigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["emailamigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["emailamigo"] : "Email Amigo";
   $tab_ger_campos['url'] = "on";
   $tab_def_campos['url'] = "url";
   $tab_converte["url"]   = "url";
   $tab_labels["url"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["url"])) ? $_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["url"] : "Url";
   $tab_ger_campos['mensajeadicional'] = "on";
   $tab_def_campos['mensajeadicional'] = "mensajeAdicional";
   $tab_converte["mensajeAdicional"]   = "mensajeadicional";
   $tab_labels["mensajeadicional"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["mensajeadicional"])) ? $_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["mensajeadicional"] : "Mensaje Adicional";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_converte["creado"]   = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_compartir']['labels']["creado"] : "Creado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_compartir']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_compartir']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - compartir</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_compartir_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_compartir']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
