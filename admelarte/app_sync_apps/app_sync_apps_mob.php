...
// 
      ...
      $this->str_conf_reg    = (isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_conf_reg']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_conf_reg'])) ? $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_conf_reg'] : "es_co";
      $this->str_schema_all  = (isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_schema_all']) && !empty($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_schema_all'])) ? $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['str_schema_all'] : "Sc8_Saphir/Sc8_Saphir";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'Phronesis'); 
      } 
      else 
      { 
...
{
    include_once("app_sync_apps_mob_nmutf8.php");
}
ob_start();
//
//----------------  
//
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['parms']))
    {
        ...
        {
            $todo = explode("?@?", $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['parms']);
            $ix = 0;
            while (!empty($todo[$ix]))
            {
               $cadapar = explode("?#?", $todo[$ix]);
    ...
    if (!empty($nmgp_opcao) && ($nmgp_opcao == "change_lang_t" || $nmgp_opcao == "change_lang_b" || $nmgp_opcao == "change_lang_f" || $nmgp_opcao == "force_lang"))  
    {
        ...
        { 
            $_SESSION['scriptcase']['change_regional_old'] = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg']) && !empty($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_conf_reg'] : "es_co";
    ...
    { 
      ...
      $str_schema_app = (isset($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all']) && !empty($_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all'])) ? $_SESSION['sc_session'][$script_case_init]['app_sync_apps_mob']['str_schema_all'] : "Sc8_Saphir/Sc8_Saphir";
...
//
    ...
    function ajax_app_sync_apps_mob_submit_form($sync, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init)
    {
        global $inicial_app_sync_apps_mob;
        //register_shutdown_function("app_sync_apps_mob_pack_ajax_response");
        $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_flag          = true;
