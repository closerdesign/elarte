...
class grid_pedidos_xml
{
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_pedidos";
         $this->id = $rs->fields[0] ;  
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_formapago))
         {
             $this->look_formapago = mb_convert_encoding($this->look_formapago, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " formapago =\"" . $this->trata_dados($this->look_formapago) . "\"";
   }
   //----- transactionid
   function NM_export_transactionid()
   {
         ...
         $this->xml_registro .= " transactionid =\"" . $this->trata_dados($this->transactionid) . "\"";
   }
   //----- creado
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
