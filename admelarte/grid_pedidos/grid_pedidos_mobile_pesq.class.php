...
//-- ajax metodos ---
   ...
   function lookup_ajax_valor($valor)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct valor from " . $this->Ini->nm_tabela . " where  valor like '%" . $valor . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_status($status)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct status from " . $this->Ini->nm_tabela . " where  status like '%" . $status . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['id']; 
          $id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['id_input_2']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['id_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['usuario']; 
          $usuario_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['usuario_input_2']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['usuario_cond']; 
          $valor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['valor']; 
          $valor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['valor_cond']; 
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['status']; 
          $status_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['status_input_2']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['status_cond']; 
...
<?php echo $SC_Label ?><br>
      ...
      $valor_look = substr($this->Db->qstr($valor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct valor from " . $this->Ini->nm_tabela . " where valor = '$valor_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php echo $SC_Label ?><br>
   ...
   { 
      $nm_comando = "select distinct status from " . $this->Ini->nm_tabela . " where status = $status_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Phronesis/grid_pedidos";
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['id_input_2'] = $id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['usuario'] = $usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['usuario_input_2'] = $usuario_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['valor'] = $valor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['valor_cond'] = $valor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['status'] = $status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['status_input_2'] = $status_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']['status_cond'] = $status_cond_salva; 
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_ant'] = $this->comando . $this->comando_fim;
