...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   { 
       ...
       $nmgrp_apl_opcao= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'];
...
//
   ...
   if ($this->nmgp_botoes['Detalle'] != "on") 
   { 
...
//
   ...
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['qt_lin_grid'] = 10 ;  
   }   
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_select']['creado'] = 'DESC'; 
   ...
   { 
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_quebra'][$nmgp_ordem])) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "inicio" ;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_grid'] = ""; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_quebra'][$nmgp_ordem] == "asc") 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_quebra'][$nmgp_ordem] = "desc"; 
           }   
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_quebra'][$nmgp_ordem] = "asc"; 
           }   
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] = $nmgp_ordem;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_quebra'][$nmgp_ordem]);  
       }   
       else   
       { 
...
//----- 
   ...
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "pdf" || isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['paginacao']))
   {
   ...
   else  
   {
       ...
       {
           $_SESSION['scriptcase']['sc_sql_btn_run'][0] = $nmgp_select; 
           $_SESSION['scriptcase']['sc_sql_btn_run'][1] = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['qt_reg_grid'] + 2); 
   ...
   { 
       ...
       $GLOBALS["usuario"] = $this->rs_grid->fields[1] ;  
...
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_pedidos_jquery.js\"></script>\r\n");
           ...
           $nm_saida->saida("   var scQtReg  = " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['qt_reg_grid'] . ";\r\n");
       ...
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
...
//----- 
 function cabecalho()
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_pedidos#?#" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . "\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_psq']) { 
 ...
 function NM_label_id()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'id')
      {
 ...
 function NM_label_usuario()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'usuario')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_valor()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'valor')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_status()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'status')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_formapago()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'formaPago')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_orderid()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'orderId')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
// 
   $SC_Label = (isset($this->New_label['id'])) ? $this->New_label['id'] : "Id"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['usuario'])) ? $this->New_label['usuario'] : "Usuario"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['usuario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['valor'])) ? $this->New_label['valor'] : "Valor"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['valor'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['status'])) ? $this->New_label['status'] : "Status"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['formapago'])) ? $this->New_label['formapago'] : "Forma Pago"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['formapago'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['transactionid'])) ? $this->New_label['transactionid'] : "Transaction Id"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['transactionid'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['creado'])) ? $this->New_label['creado'] : "Creado"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['creado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['orderid'])) ? $this->New_label['orderid'] : "Order Id"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['orderid'] = $SC_Label; 
   ...
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
       {
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_pedidos#?#$nm_seq_execucoes\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
...
// 
   ...
   {  
          ...
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
 ...
 function NM_grid_formapago()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['formapago']) || $this->NM_cmp_hidden['formapago'] != "off") { 
          $conteudo = trim(NM_encode_input($this->look_formapago)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
 ...
 function NM_grid_transactionid()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['transactionid']) || $this->NM_cmp_hidden['transactionid'] != "off") { 
          $conteudo = $this->transactionid; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"   align=\"left\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_transactionid_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function quebra_geral_top() 
 {
   ...
   function nmgp_barra_top()
   {
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pedidos/grid_pedidos_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pedidos/grid_pedidos_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_pedidos/grid_pedidos_config_print.php?nm_opc=AM&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['Detalle'] == "on" && !$this->grid_emb_form) 
      { 
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "Detalle", "sc_btn_Detalle()", "sc_btn_Detalle()", "sc_Detalle_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "");
          $nm_saida->saida("          $Cod_Btn \r\n");
          $NM_btn = true;
      } 
          $nm_saida->saida("         </td> \r\n");
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['b_sair'] || $this->grid_emb_form)
      {
   ...
   function nmgp_barra_bot()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['paginacao']))
          {
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['nav']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['paginacao']))
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['nav']))
          {
...
?>
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   { 
   ...
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['nav']))
       { 
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_pedidos', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function sc_btn_Detalle()\r\n");
   $nm_saida->saida("   {\r\n");
   ...
   $nm_saida->saida("       document.FBtn_Run.nm_call_php.value = \"Detalle\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_pedidos/grid_pedidos_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=print&tp_print=' + tp + '&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campo_psq_ret']) && empty($this->nm_grid_sem_reg))
   {
   ...
   $nm_saida->saida("   }\r\n");
   if ($this->grid_emb_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('grid_pedidos');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_pedidos', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
