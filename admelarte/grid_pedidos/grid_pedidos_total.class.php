...
class grid_pedidos_total
{
   ...
   //----- 
   function grid_pedidos_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['campos_busca']))
      { 
   ...
   function quebra_geral()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq']; 
      ...
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['contr_total_geral'] = "OK";
   } 
