...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["id"] : "Id";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_converte["usuario"]   = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_converte["valor"]   = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["valor"] : "Valor";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_converte["status"]   = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["status"] : "Status";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formaPago";
   $tab_converte["formaPago"]   = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["formapago"] : "Forma Pago";
   $tab_ger_campos['transactionid'] = "on";
   $tab_def_campos['transactionid'] = "transactionId";
   $tab_converte["transactionId"]   = "transactionid";
   $tab_labels["transactionid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["transactionid"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["transactionid"] : "Transaction Id";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_converte["creado"]   = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["creado"] : "Creado";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_pedidos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_pedidos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
