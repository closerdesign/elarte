...
function AddBody()
{
	...
	document.write("<form name='searchform' method='post' onSubmit='doSearch(); return false;'>"
					+"<table border='0' width='10%' style='font-family:Arial, Helvetica, sans-serif;font-size:12px;'>"
