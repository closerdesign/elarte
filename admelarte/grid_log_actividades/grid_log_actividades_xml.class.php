...
class grid_log_actividades_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_log_actividades_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_log_actividades.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_log_actividades";
   ...
   function NM_export_actividad()
   {
         ...
         $this->xml_registro .= " actividad =\"" . $this->trata_dados($this->actividad) . "\"";
   }
   //----- creado
   ...
   function NM_export_id_actividad()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_actividad))
         {
             $this->id_actividad = mb_convert_encoding($this->id_actividad, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " id_actividad =\"" . $this->trata_dados($this->id_actividad) . "\"";
   }
   //----- usuario
   ...
   function NM_export_sesion()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->sesion))
         {
             $this->sesion = mb_convert_encoding($this->sesion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " sesion =\"" . $this->trata_dados($this->sesion) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - log_actividades :: XML</TITLE>
