...
class grid_log_actividades_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_log_actividades_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_log_actividades_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_log_actividades_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_log_actividades_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_actividad')
      {
          $id_actividad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_actividad($id_actividad);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sesion')
      {
          $sesion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sesion($sesion);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      {
          $actividad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
   ...
   function lookup_ajax_id_actividad($id_actividad)
   {
      $id_actividad = substr($this->Db->qstr($id_actividad), 1, -1);
            $id_actividad_look = substr($this->Db->qstr($id_actividad), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct id_actividad from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and  id_actividad like '%" . $id_actividad . "%'"; 
   ...
   function lookup_ajax_usuario($usuario)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct usuario from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and  usuario like '%" . $usuario . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_sesion($sesion)
   {
      $sesion = substr($this->Db->qstr($sesion), 1, -1);
            $sesion_look = substr($this->Db->qstr($sesion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct sesion from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and  sesion like '%" . $sesion . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_actividad($actividad)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct actividad from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and  actividad like '%" . $actividad . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - log_actividades</TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_log_actividades_ajax_search.js"></script>
 <script type="text/javascript" src="grid_log_actividades_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_actividad_cond#NMF#' + search_get_sel_txt('SC_id_actividad_cond') + '@NMF@';
  str_out += 'SC_id_actividad#NMF#' + search_get_text('SC_id_actividad') + '@NMF@';
  str_out += 'id_ac_id_actividad#NMF#' + search_get_text('id_ac_id_actividad') + '@NMF@';
  str_out += 'SC_id_actividad_input_2#NMF#' + search_get_text('SC_id_actividad_input_2') + '@NMF@';
  ...
  str_out += 'SC_sesion_cond#NMF#' + search_get_sel_txt('SC_sesion_cond') + '@NMF@';
  str_out += 'SC_sesion#NMF#' + search_get_text('SC_sesion') + '@NMF@';
  str_out += 'id_ac_sesion#NMF#' + search_get_text('id_ac_sesion') + '@NMF@';
  str_out += 'SC_sesion_input_2#NMF#' + search_get_text('SC_sesion_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_id_actividad").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_actividad",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_id_actividad").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_actividad").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_sesion").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sesion",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_sesion").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_sesion").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - log_actividades</span></td>
...
<?php
   ...
   {
      global 
             $id_actividad_cond, $id_actividad, $id_actividad_input_2, $id_actividad_autocomp,
             $usuario_cond, $usuario, $usuario_input_2, $usuario_autocomp,
             $sesion_cond, $sesion, $sesion_input_2, $sesion_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_actividad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['id_actividad']; 
          $id_actividad_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['id_actividad_input_2']; 
          $id_actividad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['id_actividad_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['usuario']; 
          $usuario_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['usuario_input_2']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['usuario_cond']; 
          $sesion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['sesion']; 
          $sesion_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['sesion_input_2']; 
          $sesion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['sesion_cond']; 
          $actividad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['actividad']; 
          $actividad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['actividad_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_actividad_cond) || empty($id_actividad_cond))
      {
         $id_actividad_cond = "gt";
      }
      if (!isset($usuario_cond) || empty($usuario_cond))
      {
         $usuario_cond = "gt";
      }
      if (!isset($sesion_cond) || empty($sesion_cond))
      {
         $sesion_cond = "gt";
      }
      ...
      $str_hide_id_actividad = (in_array($id_actividad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usuario = (in_array($usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sesion = (in_array($sesion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_actividad = (in_array($actividad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_actividad = ('bw' == $id_actividad_cond) ? $display_aberto : $display_fechado;
      $str_display_usuario = ('bw' == $usuario_cond) ? $display_aberto : $display_fechado;
      $str_display_sesion = ('bw' == $sesion_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_actividad) || $id_actividad == "")
      {
          $id_actividad = "";
      }
      if (isset($id_actividad) && !empty($id_actividad))
      {
         $tmp_pos = strpos($id_actividad, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_actividad = substr($id_actividad, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($sesion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $sesion = substr($sesion, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_log_actividades_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_actividad'])) ? $this->New_label['id_actividad'] : "Id Actividad"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_actividad_cond" name="id_actividad_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_actividad'), this, 'id_actividad')">
       <OPTION value="gt" <?php if ("gt" == $id_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_actividad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_actividad" <?php echo $str_hide_id_actividad?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_actividad'])) ? $this->New_label['id_actividad'] : "Id Actividad";
 $nmgp_tab_label .= "id_actividad?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_actividad_look = substr($this->Db->qstr($id_actividad), 1, -1); 
   ...
   { 
      $nm_comando = "select distinct id_actividad from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and id_actividad = $id_actividad_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$id_actividad]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_actividad];
      }
      else
      {
          $sAutocompValue = $id_actividad;
      }
?>
<INPUT  type="text" id="SC_id_actividad" name="id_actividad" value="<?php echo NM_encode_input($id_actividad) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_actividad" name="id_actividad_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_actividad"  <?php echo $str_display_id_actividad; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_actividad_input_2" name="id_actividad_input_2" value="<?php echo NM_encode_input($id_actividad_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<?php
   ...
   { 
      $nm_comando = "select distinct usuario from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and usuario = $usuario_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['sesion'])) ? $this->New_label['sesion'] : "Sesion"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_sesion_cond" name="sesion_cond" onChange="nm_campos_between(document.getElementById('id_vis_sesion'), this, 'sesion')">
       <OPTION value="gt" <?php if ("gt" == $sesion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $sesion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sesion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $sesion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sesion" <?php echo $str_hide_sesion?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['sesion'])) ? $this->New_label['sesion'] : "Sesion";
 $nmgp_tab_label .= "sesion?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $sesion_look = substr($this->Db->qstr($sesion), 1, -1); 
   ...
   { 
      $nm_comando = "select distinct sesion from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and sesion = $sesion_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$sesion]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$sesion];
      }
      else
      {
          $sAutocompValue = $sesion;
      }
?>
<INPUT  type="text" id="SC_sesion" name="sesion" value="<?php echo NM_encode_input($sesion) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sesion" name="sesion_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_sesion"  <?php echo $str_display_sesion; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_sesion_input_2" name="sesion_input_2" value="<?php echo NM_encode_input($sesion_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['actividad'])) ? $this->New_label['actividad'] : "Actividad"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      $actividad_look = substr($this->Db->qstr($actividad), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct actividad from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and actividad = '$actividad_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_actividad" name="actividad" value="<?php echo NM_encode_input($actividad) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_actividad" name="actividad_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_actividades']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_log_actividades']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_actividad'), document.F1.id_actividad_cond, 'id_actividad');
   document.F1.id_actividad.value = "";
   document.F1.id_actividad_autocomp.value = "";
   document.F1.id_actividad_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_sesion'), document.F1.sesion_cond, 'sesion');
   document.F1.sesion.value = "";
   document.F1.sesion_autocomp.value = "";
   document.F1.sesion_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Phronesis/grid_log_actividades";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_actividad_cond'] = 'cond';
      $tp_fields['SC_id_actividad'] = 'text_aut';
      $tp_fields['id_ac_id_actividad'] = 'text_aut';
      $tp_fields['SC_id_actividad_input_2'] = 'text';
      ...
      $tp_fields['SC_sesion_cond'] = 'cond';
      $tp_fields['SC_sesion'] = 'text_aut';
      $tp_fields['id_ac_sesion'] = 'text_aut';
      $tp_fields['SC_sesion_input_2'] = 'text';
   ...
   {
      global $id_actividad_cond, $id_actividad, $id_actividad_input_2, $id_actividad_autocomp,
             $usuario_cond, $usuario, $usuario_input_2, $usuario_autocomp,
             $sesion_cond, $sesion, $sesion_input_2, $sesion_autocomp,
      ...
      if (!empty($id_actividad_autocomp) && empty($id_actividad))
      {
          $id_actividad = $id_actividad_autocomp;
      }
      if (!empty($usuario_autocomp) && empty($usuario))
      {
          $usuario = $usuario_autocomp;
      }
      if (!empty($sesion_autocomp) && empty($sesion))
      {
          $sesion = $sesion_autocomp;
      }
      if (!empty($actividad_autocomp) && empty($actividad))
      {
          $actividad = $actividad_autocomp;
      }
      $id_actividad_cond_salva = $id_actividad_cond; 
      if (!isset($id_actividad_input_2) || $id_actividad_input_2 == "")
      {
          $id_actividad_input_2 = $id_actividad;
      }
      ...
      $sesion_cond_salva = $sesion_cond; 
      if (!isset($sesion_input_2) || $sesion_input_2 == "")
      {
          $sesion_input_2 = $sesion;
      }
      ...
      if ($id_actividad_cond != "in")
      {
          nm_limpa_numero($id_actividad, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_actividad);
          ...
          $id_actividad = implode(",", $Nm_sc_valores);
      }
      if ($id_actividad_cond != "in")
      {
          nm_limpa_numero($id_actividad_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($usuario_cond != "in")
      {
      ...
      if ($sesion_cond != "in")
      {
          nm_limpa_numero($sesion, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $sesion);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $sesion = implode(",", $Nm_sc_valores);
      }
      if ($sesion_cond != "in")
      {
          nm_limpa_numero($sesion_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['id_actividad'] = $id_actividad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['id_actividad_input_2'] = $id_actividad_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['id_actividad_cond'] = $id_actividad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['usuario'] = $usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['usuario_input_2'] = $usuario_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['sesion'] = $sesion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['sesion_input_2'] = $sesion_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['sesion_cond'] = $sesion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['actividad'] = $actividad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['actividad_cond'] = $actividad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!is_numeric($id_actividad) && $id_actividad_cond != "in")
      {
          $id_actividad = "";
      }
      ...
      if (!is_numeric($sesion) && $sesion_cond != "in")
      {
          $sesion = "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_actividad'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_actividad'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_actividad'] = $id_actividad;
      }
      $Conteudo = $id_actividad_input_2;
      if (strtoupper($id_actividad_cond) != "II" && strtoupper($id_actividad_cond) != "QP" && strtoupper($id_actividad_cond) != "NP" && strtoupper($id_actividad_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_actividad_input_2'] = $Conteudo;
      $usuario_look = substr($this->Db->qstr($usuario), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($usuario))
   { 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sesion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['sesion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sesion'] = $sesion;
      }
      $Conteudo = $sesion_input_2;
      if (strtoupper($sesion_cond) != "II" && strtoupper($sesion_cond) != "QP" && strtoupper($sesion_cond) != "NP" && strtoupper($sesion_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['sesion_input_2'] = $Conteudo;
      $actividad_look = substr($this->Db->qstr($actividad), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct actividad from " . $this->Ini->nm_tabela . " where sesion = " . $_SESSION['var_sesion'] . " and actividad = '$actividad_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (isset($id_actividad) || $id_actividad_cond == "nu" || $id_actividad_cond == "nn" || $id_actividad_cond == "ep" || $id_actividad_cond == "ne")
      {
         $this->monta_condicao("id_actividad", $id_actividad_cond, $id_actividad, $id_actividad_input_2, "id_actividad");
      }
      ...
      //----- $sesion
      $this->Date_part = false;
      if (isset($sesion) || $sesion_cond == "nu" || $sesion_cond == "nn" || $sesion_cond == "ep" || $sesion_cond == "ne")
      {
         $this->monta_condicao("sesion", $sesion_cond, $sesion, $sesion_input_2, "sesion");
      }
      ...
      {
         $this->monta_condicao("actividad", $actividad_cond, $actividad, "", "actividad");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_actividades']['where_pesq_ant'] = $this->comando . $this->comando_fim;
