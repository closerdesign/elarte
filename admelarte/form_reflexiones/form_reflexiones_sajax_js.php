  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_reflexiones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre
  function do_ajax_form_reflexiones_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reflexiones_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_reflexiones_validate_nombre_cb);
  } // do_ajax_form_reflexiones_validate_nombre

  function do_ajax_form_reflexiones_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reflexiones_validate_nombre_cb

  // ---------- Validate descripcion
  function do_ajax_form_reflexiones_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reflexiones_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_reflexiones_validate_descripcion_cb);
  } // do_ajax_form_reflexiones_validate_descripcion

  function do_ajax_form_reflexiones_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reflexiones_validate_descripcion_cb

  // ---------- Validate video
  function do_ajax_form_reflexiones_validate_video()
  {
    var nomeCampo_video = "video";
    var var_video = scAjaxGetFieldText(nomeCampo_video);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reflexiones_validate_video(var_video, var_script_case_init, do_ajax_form_reflexiones_validate_video_cb);
  } // do_ajax_form_reflexiones_validate_video

  function do_ajax_form_reflexiones_validate_video_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "video";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reflexiones_validate_video_cb

  // ---------- Validate status
  function do_ajax_form_reflexiones_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reflexiones_validate_status(var_status, var_script_case_init, do_ajax_form_reflexiones_validate_status_cb);
  } // do_ajax_form_reflexiones_validate_status

  function do_ajax_form_reflexiones_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "status";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reflexiones_validate_status_cb
  // ---------- Form
  function do_ajax_form_reflexiones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_reflexiones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_reflexiones_submit_form(var_nombre, var_descripcion, var_video, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_reflexiones_submit_form_cb);
  } // do_ajax_form_reflexiones_submit_form

  function do_ajax_form_reflexiones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_reflexiones_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_reflexiones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_reflexiones_navigate_form(var_idreflexion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_reflexiones_navigate_form_cb);
  } // do_ajax_form_reflexiones_navigate_form

  function do_ajax_form_reflexiones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_reflexiones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_reflexiones_navigate_form_cb
