...
<?php
include_once("form_reflexiones_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_reflexiones_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['recarga'];
}
?>
...
<?php
 include_once("form_reflexiones_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_reflexiones'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_reflexiones'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['Lookup_status'][] = '1'; ?>
 <option value="0" <?php  if ($this->status == "0") { echo " selected" ;} ?>>Inactivo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['Lookup_status'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reflexiones']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_reflexiones");
 parent.scAjaxDetailHeight("form_reflexiones", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
