...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_nombre' + iSeqRow).bind('blur', function() { sc_form_reflexiones_nombre_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_reflexiones_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion' + iSeqRow).bind('blur', function() { sc_form_reflexiones_descripcion_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_reflexiones_descripcion_onfocus(this, iSeqRow) });
  $('#id_sc_field_video' + iSeqRow).bind('blur', function() { sc_form_reflexiones_video_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_reflexiones_video_onfocus(this, iSeqRow) });
  $('#id_sc_field_status' + iSeqRow).bind('blur', function() { sc_form_reflexiones_status_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_reflexiones_status_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_reflexiones_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_reflexiones_mob_validate_nombre();
  scCssBlur(oThis);
}

function sc_form_reflexiones_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reflexiones_descripcion_onblur(oThis, iSeqRow) {
  do_ajax_form_reflexiones_mob_validate_descripcion();
  scCssBlur(oThis);
}

function sc_form_reflexiones_descripcion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reflexiones_video_onblur(oThis, iSeqRow) {
  do_ajax_form_reflexiones_mob_validate_video();
  scCssBlur(oThis);
}

function sc_form_reflexiones_video_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reflexiones_status_onblur(oThis, iSeqRow) {
  do_ajax_form_reflexiones_mob_validate_status();
  scCssBlur(oThis);
}

function sc_form_reflexiones_status_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
