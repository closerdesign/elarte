...
<?php
include_once("form_pedidos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_pedidos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['recarga'];
}
?>
...
<?php
 include_once("form_pedidos_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_pedidos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_pedidos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['Detalle'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "detalle", "sc_btn_Detalle()", "sc_btn_Detalle()", "sc_Detalle_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_usuario" style="<?php echo $sStyleHidden_usuario; ?>;"><span id="id_label_usuario"><?php echo $this->nm_new_label['usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_usuario" style="<?php echo $sStyleHidden_usuario; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_valor" style="<?php echo $sStyleHidden_valor; ?>;"><span id="id_label_valor"><?php echo $this->nm_new_label['valor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['valor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['valor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_valor" style="<?php echo $sStyleHidden_valor; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_status" style="<?php echo $sStyleHidden_status; ?>;"><span id="id_label_status"><?php echo $this->nm_new_label['status']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['status']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['status'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_status'][] = '0'; ?>
 <option value="1" <?php  if ($this->status == "1") { echo " selected" ;} ?>>Pendiente</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_status'][] = '1'; ?>
 <option value="2" <?php  if ($this->status == "2") { echo " selected" ;} ?>>Exitoso</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_status'][] = '2'; ?>
 <option value="3" <?php  if ($this->status == "3") { echo " selected" ;} ?>>Cancelado/Rechazado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_status'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_formapago" style="<?php echo $sStyleHidden_formapago; ?>;"><span id="id_label_formapago"><?php echo $this->nm_new_label['formapago']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['formapago']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['php_cmp_required']['formapago'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_formapago" style="<?php echo $sStyleHidden_formapago; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["formapago"]) &&  $this->nmgp_cmp_readonly["formapago"] == "on") { 

$formapago_look = "";
 if ($this->formapago == "1") { $formapago_look .= "Tarjeta de Crédito" ;} 
 ...
 if ($this->formapago == "7") { $formapago_look .= "Crédito" ;} 
?>
...
<span id="id_read_on_formapago" style=";<?php echo $sStyleReadLab_formapago; ?>"><?php echo NM_encode_input($formapago_look); ?></span><span id="id_read_off_formapago" style="<?php echo $sStyleReadInp_formapago; ?>">
 ...
 <option value="1" <?php  if ($this->formapago == "1") { echo " selected" ;} ?>>Tarjeta de Crédito</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_formapago'][] = '1'; ?>
 <option value="2" <?php  if ($this->formapago == "2") { echo " selected" ;} ?>>Paypal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_formapago'][] = '2'; ?>
 <option value="3" <?php  if ($this->formapago == "3") { echo " selected" ;} ?>>Transferencia PSE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_formapago'][] = '3'; ?>
 <option value="4" <?php  if ($this->formapago == "4") { echo " selected" ;} ?>>VIA Baloto</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_formapago'][] = '4'; ?>
 <option value="5" <?php  if ($this->formapago == "5") { echo " selected" ;} ?>>Oxxo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_formapago'][] = '5'; ?>
 <option value="6" <?php  if ($this->formapago == "6") { echo " selected" ;} ?>>BCP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_formapago'][] = '6'; ?>
 <option value="7" <?php  if ($this->formapago == "7") { echo " selected" ;} ?>>Crédito</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['Lookup_formapago'][] = '7'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_orderid" style="<?php echo $sStyleHidden_orderid; ?>;"><span id="id_label_orderid"><?php echo $this->nm_new_label['orderid']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_orderid" style="<?php echo $sStyleHidden_orderid; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_transactionid" style="<?php echo $sStyleHidden_transactionid; ?>;"><span id="id_label_transactionid"><?php echo $this->nm_new_label['transactionid']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_transactionid" style="<?php echo $sStyleHidden_transactionid; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_state" style="<?php echo $sStyleHidden_state; ?>;"><span id="id_label_state"><?php echo $this->nm_new_label['state']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_state" style="<?php echo $sStyleHidden_state; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_pendingreason" style="<?php echo $sStyleHidden_pendingreason; ?>;"><span id="id_label_pendingreason"><?php echo $this->nm_new_label['pendingreason']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_pendingreason" style="<?php echo $sStyleHidden_pendingreason; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_responsecode" style="<?php echo $sStyleHidden_responsecode; ?>;"><span id="id_label_responsecode"><?php echo $this->nm_new_label['responsecode']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_responsecode" style="<?php echo $sStyleHidden_responsecode; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_urlpaymentreceipthtml" style="<?php echo $sStyleHidden_urlpaymentreceipthtml; ?>;"><span id="id_label_urlpaymentreceipthtml"><?php echo $this->nm_new_label['urlpaymentreceipthtml']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_urlpaymentreceipthtml" style="<?php echo $sStyleHidden_urlpaymentreceipthtml; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_reference" style="<?php echo $sStyleHidden_reference; ?>;"><span id="id_label_reference"><?php echo $this->nm_new_label['reference']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_reference" style="<?php echo $sStyleHidden_reference; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_pedidos");
 parent.scAjaxDetailHeight("form_pedidos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
