  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_formatos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre_
  function do_ajax_form_formatos_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatos_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_formatos_validate_nombre__cb);
  } // do_ajax_form_formatos_validate_nombre_

  function do_ajax_form_formatos_validate_nombre__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatos_validate_nombre__cb

  // ---------- Validate status_
  function do_ajax_form_formatos_validate_status_(iNumLinha)
  {
    var nomeCampo_status_ = "status_" + iNumLinha;
    var var_status_ = scAjaxGetFieldSelect(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatos_validate_status_(var_status_, iNumLinha, var_script_case_init, do_ajax_form_formatos_validate_status__cb);
  } // do_ajax_form_formatos_validate_status_

  function do_ajax_form_formatos_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatos_validate_status__cb

  // ---------- Validate idformato_
  function do_ajax_form_formatos_validate_idformato_(iNumLinha)
  {
    var nomeCampo_idformato_ = "idformato_" + iNumLinha;
    var var_idformato_ = scAjaxGetFieldHidden(nomeCampo_idformato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatos_validate_idformato_(var_idformato_, iNumLinha, var_script_case_init, do_ajax_form_formatos_validate_idformato__cb);
  } // do_ajax_form_formatos_validate_idformato_

  function do_ajax_form_formatos_validate_idformato__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idformato_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idformato_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idformato_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idformato_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatos_validate_idformato__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_formatos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_formatos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_formatos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_formatos_add_new_line_cb);
  } // do_ajax_form_formatos_add_new_line

  function do_ajax_form_formatos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_formatos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_formatos_backup_line(iNumLinha)
  {
    var var_idformato_ = scAjaxGetFieldHidden("idformato_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatos_backup_line(var_idformato_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_formatos_backup_line_cb);
  } // do_ajax_form_formatos_backup_line

  function do_ajax_form_formatos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_formatos_backup_line_cb

  function do_ajax_form_formatos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_formatos_cancel_insert

  function do_ajax_form_formatos_cancel_update(iSeqVert)
  {
    do_ajax_form_formatos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_formatos_cancel_update

  function do_ajax_form_formatos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_formatos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_formatos_table_refresh()
  {
    var var_idformato_ = document.F2.idformato_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_formatos_table_refresh(var_idformato_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_formatos_table_refresh_cb);
  } //  do_ajax_form_formatos_table_refresh

  function do_ajax_form_formatos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.idformato_.value = scAjaxGetKeyValue("idformato_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_formatos_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_formatos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_formatos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_formatos_submit_form(var_nombre_, var_status_, var_idformato_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_formatos_submit_form_cb);
  } // do_ajax_form_formatos_submit_form

  function do_ajax_form_formatos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idformato_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_formatos_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_formatos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_formatos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idformato_" + iNavForm);
    }
    var var_idformato_ = document.F2.idformato_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_formatos_navigate_form(var_idformato_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_formatos_navigate_form_cb);
  } // do_ajax_form_formatos_navigate_form

  function do_ajax_form_formatos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idformato_.value = scAjaxGetKeyValue("idformato_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_formatos_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idformato_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["idformato_" + iNumLinha] = {"label": "Id Formato<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["status_"][iNumLinha] = "status_" + iNumLinha;
    ajax_field_mult["idformato_"][iNumLinha] = "idformato_" + iNumLinha;
    ...
    ajax_error_count["idformato_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["idformato_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idformato_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idformato_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idformato_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idformato_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idformato_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idformato_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idformato_'])) ? $this->nmgp_cmp_readonly['idformato_'] : 'on';
?>
    scAjaxFieldRead("idformato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("idformato_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["status_" + iRow] || "on" == ajax_error_count["idformato_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_idformato_" + iRow))
        document.getElementById("hidden_field_data_idformato_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["status_" + iRow] && "off" == ajax_error_count["idformato_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["status_" + iRow] = "off";
        ajax_error_count["idformato_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_idformato_" + iRow))
        document.getElementById("hidden_field_data_idformato_" + iRow).className = sCssLine;
    }
  }
