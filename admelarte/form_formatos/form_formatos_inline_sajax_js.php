  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_formatos_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre_
  function do_ajax_form_formatos_inline_validate_nombre_()
  {
    var nomeCampo_nombre_ = "nombre_";
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatos_inline_validate_nombre_(var_nombre_, var_script_case_init, do_ajax_form_formatos_inline_validate_nombre__cb);
  } // do_ajax_form_formatos_inline_validate_nombre_

  function do_ajax_form_formatos_inline_validate_nombre__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatos_inline_validate_nombre__cb

  // ---------- Validate status_
  function do_ajax_form_formatos_inline_validate_status_()
  {
    var nomeCampo_status_ = "status_";
    var var_status_ = scAjaxGetFieldSelect(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatos_inline_validate_status_(var_status_, var_script_case_init, do_ajax_form_formatos_inline_validate_status__cb);
  } // do_ajax_form_formatos_inline_validate_status_

  function do_ajax_form_formatos_inline_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "status_";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatos_inline_validate_status__cb

  // ---------- Validate idformato_
  function do_ajax_form_formatos_inline_validate_idformato_()
  {
    var nomeCampo_idformato_ = "idformato_";
    var var_idformato_ = scAjaxGetFieldText(nomeCampo_idformato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatos_inline_validate_idformato_(var_idformato_, var_script_case_init, do_ajax_form_formatos_inline_validate_idformato__cb);
  } // do_ajax_form_formatos_inline_validate_idformato_

  function do_ajax_form_formatos_inline_validate_idformato__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatos_inline_validate_idformato__cb
  // ---------- Form
  function do_ajax_form_formatos_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_formatos_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre_ = scAjaxGetFieldText("nombre_");
    var var_status_ = scAjaxGetFieldSelect("status_");
    var var_idformato_ = scAjaxGetFieldText("idformato_");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_formatos_inline_submit_form(var_nombre_, var_status_, var_idformato_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_formatos_inline_submit_form_cb);
  } // do_ajax_form_formatos_inline_submit_form

  function do_ajax_form_formatos_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("status_");
      scAjaxHideErrorDisplay("idformato_");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_formatos_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_formatos_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_formatos_inline_navigate_form(var_idformato_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_formatos_inline_navigate_form_cb);
  } // do_ajax_form_formatos_inline_navigate_form

  function do_ajax_form_formatos_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_formatos_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_formatos_inline_navigate_form_cb
  ...
  ajax_field_list[1] = "status_";
  ajax_field_list[2] = "idformato_";
  ...
  var ajax_error_list = {
    ...
    "status_": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idformato_": {"label": "Id Formato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["status_"][1] = "status_";
  ajax_field_mult["idformato_"][1] = "idformato_";

  var ajax_field_id = {
    "nombre_": new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_"),
    "status_": new Array("hidden_field_label_status_", "hidden_field_data_status_")
  };
