  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_articulos_formato" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate titulo
  function do_ajax_form_articulos_formato_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_formato_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_articulos_formato_validate_titulo_cb);
  } // do_ajax_form_articulos_formato_validate_titulo

  function do_ajax_form_articulos_formato_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_formato_validate_titulo_cb

  // ---------- Validate contenido
  function do_ajax_form_articulos_formato_validate_contenido()
  {
    var nomeCampo_contenido = "contenido";
    var var_contenido = scAjaxGetFieldText(nomeCampo_contenido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_formato_validate_contenido(var_contenido, var_script_case_init, do_ajax_form_articulos_formato_validate_contenido_cb);
  } // do_ajax_form_articulos_formato_validate_contenido

  function do_ajax_form_articulos_formato_validate_contenido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_formato_validate_contenido_cb

  // ---------- Validate formato
  function do_ajax_form_articulos_formato_validate_formato()
  {
    var nomeCampo_formato = "formato";
    var var_formato = scAjaxGetFieldSelect(nomeCampo_formato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_formato_validate_formato(var_formato, var_script_case_init, do_ajax_form_articulos_formato_validate_formato_cb);
  } // do_ajax_form_articulos_formato_validate_formato

  function do_ajax_form_articulos_formato_validate_formato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "formato";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_formato_validate_formato_cb
  // ---------- Form
  function do_ajax_form_articulos_formato_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_articulos_formato_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_titulo = scAjaxGetFieldText("titulo");
    var var_contenido = scAjaxGetFieldText("contenido");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_articulos_formato_submit_form(var_titulo, var_contenido, var_formato, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_articulos_formato_submit_form_cb);
  } // do_ajax_form_articulos_formato_submit_form

  function do_ajax_form_articulos_formato_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_articulos_formato_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_articulos_formato_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_articulos_formato_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_articulos_formato_navigate_form_cb);
  } // do_ajax_form_articulos_formato_navigate_form

  function do_ajax_form_articulos_formato_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_articulos_formato_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_articulos_formato_navigate_form_cb
  ...
  ajax_field_list[1] = "contenido";
  ajax_field_list[2] = "formato";
