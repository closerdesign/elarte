...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_contacto";$Nm_numeric[] = "id_contacto";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_contacto"  <?php echo $str_hide_id_contacto?>><?php
      $id_contacto_look = substr($this->Db->qstr($id_contacto), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_contacto" name="id_contacto_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_contacto"  <?php echo $str_display_id_contacto; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_contacto_input_2" name="id_contacto_input_2" value="<?php echo NM_encode_input($id_contacto_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_apellido"  <?php echo $str_hide_apellido?>><?php
      $apellido_look = substr($this->Db->qstr($apellido), 1, -1); 
      $nmgp_def_dados = array(); 
