...
class grid_contacto_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_contacto_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_contacto_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_contacto_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_contacto')
      {
          $id_contacto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_contacto($id_contacto);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      {
          $nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
      ...
      if ($this->NM_ajax_opcao == 'autocomp_apellido')
      {
          $apellido = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_apellido($apellido);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_id_contacto($id_contacto)
   {
      $id_contacto = substr($this->Db->qstr($id_contacto), 1, -1);
            $id_contacto_look = substr($this->Db->qstr($id_contacto), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct id_contacto from " . $this->Ini->nm_tabela . " where  id_contacto like '%" . $id_contacto . "%'"; 
   ...
   function lookup_ajax_nombre($nombre)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre from " . $this->Ini->nm_tabela . " where  nombre like '%" . $nombre . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_apellido($apellido)
   {
      $apellido = substr($this->Db->qstr($apellido), 1, -1);
            $apellido_look = substr($this->Db->qstr($apellido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct apellido from " . $this->Ini->nm_tabela . " where  apellido like '%" . $apellido . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - contacto</TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_contacto_ajax_search.js"></script>
 <script type="text/javascript" src="grid_contacto_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_contacto_cond#NMF#' + search_get_sel_txt('SC_id_contacto_cond') + '@NMF@';
  str_out += 'SC_id_contacto#NMF#' + search_get_text('SC_id_contacto') + '@NMF@';
  str_out += 'id_ac_id_contacto#NMF#' + search_get_text('id_ac_id_contacto') + '@NMF@';
  str_out += 'SC_id_contacto_input_2#NMF#' + search_get_text('SC_id_contacto_input_2') + '@NMF@';
  ...
  str_out += 'SC_apellido_cond#NMF#' + search_get_sel_txt('SC_apellido_cond') + '@NMF@';
  str_out += 'SC_apellido#NMF#' + search_get_text('SC_apellido') + '@NMF@';
  str_out += 'id_ac_apellido#NMF#' + search_get_text('id_ac_apellido') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_apellido").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_apellido",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_apellido").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_apellido").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_id_contacto").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_contacto",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_id_contacto").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_contacto").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - contacto</span></td>
...
<?php
   ...
   {
      global 
             $id_contacto_cond, $id_contacto, $id_contacto_input_2, $id_contacto_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp,
             $apellido_cond, $apellido, $apellido_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_contacto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['id_contacto']; 
          $id_contacto_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['id_contacto_input_2']; 
          $id_contacto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['id_contacto_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['nombre_cond']; 
          $apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['apellido']; 
          $apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['apellido_cond']; 
          $email = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['email']; 
          $email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['email_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_contacto_cond) || empty($id_contacto_cond))
      {
         $id_contacto_cond = "gt";
      }
      ...
      if (!isset($apellido_cond) || empty($apellido_cond))
      {
         $apellido_cond = "qp";
      }
      ...
      $str_hide_id_contacto = (in_array($id_contacto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre = (in_array($nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_apellido = (in_array($apellido_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_email = (in_array($email_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_contacto = ('bw' == $id_contacto_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($id_contacto, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_contacto = substr($id_contacto, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($apellido, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $apellido = substr($apellido, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_contacto_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_contacto'])) ? $this->New_label['id_contacto'] : "Id Contacto"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_contacto_cond" name="id_contacto_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_contacto'), this, 'id_contacto')">
       <OPTION value="gt" <?php if ("gt" == $id_contacto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_contacto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_contacto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_contacto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_contacto" <?php echo $str_hide_id_contacto?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_contacto'])) ? $this->New_label['id_contacto'] : "Id Contacto";
 $nmgp_tab_label .= "id_contacto?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_contacto_look = substr($this->Db->qstr($id_contacto), 1, -1); 
   ...
   { 
      $nm_comando = "select distinct id_contacto from " . $this->Ini->nm_tabela . " where id_contacto = $id_contacto_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$id_contacto]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_contacto];
      }
      else
      {
          $sAutocompValue = $id_contacto;
      }
?>
<INPUT  type="text" id="SC_id_contacto" name="id_contacto" value="<?php echo NM_encode_input($id_contacto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_contacto" name="id_contacto_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_contacto"  <?php echo $str_display_id_contacto; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_contacto_input_2" name="id_contacto_input_2" value="<?php echo NM_encode_input($id_contacto_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<?php
      $nombre_look = substr($this->Db->qstr($nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre from " . $this->Ini->nm_tabela . " where nombre = '$nombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre" name="nombre_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['apellido'])) ? $this->New_label['apellido'] : "Apellido"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_apellido_cond" name="apellido_cond" onChange="nm_campos_between(document.getElementById('id_vis_apellido'), this, 'apellido')">
       <OPTION value="qp" <?php if ("qp" == $apellido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $apellido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $apellido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $apellido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_apellido" <?php echo $str_hide_apellido?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['apellido'])) ? $this->New_label['apellido'] : "Apellido";
 $nmgp_tab_label .= "apellido?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $apellido_look = substr($this->Db->qstr($apellido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct apellido from " . $this->Ini->nm_tabela . " where apellido = '$apellido_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$apellido]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$apellido];
      }
      else
      {
          $sAutocompValue = $apellido;
      }
?>
<INPUT  type="text" id="SC_apellido" name="apellido" value="<?php echo NM_encode_input($apellido) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_apellido" name="apellido_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_contacto']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_contacto']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_contacto'), document.F1.id_contacto_cond, 'id_contacto');
   document.F1.id_contacto.value = "";
   document.F1.id_contacto_autocomp.value = "";
   document.F1.id_contacto_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_apellido'), document.F1.apellido_cond, 'apellido');
   document.F1.apellido.value = "";
   document.F1.apellido_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Phronesis/grid_contacto";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_contacto_cond'] = 'cond';
      $tp_fields['SC_id_contacto'] = 'text_aut';
      $tp_fields['id_ac_id_contacto'] = 'text_aut';
      $tp_fields['SC_id_contacto_input_2'] = 'text';
      $tp_fields['SC_nombre_cond'] = 'cond';
      $tp_fields['SC_nombre'] = 'text_aut';
      $tp_fields['id_ac_nombre'] = 'text_aut';
      $tp_fields['SC_apellido_cond'] = 'cond';
      $tp_fields['SC_apellido'] = 'text_aut';
      $tp_fields['id_ac_apellido'] = 'text_aut';
   ...
   {
      global $id_contacto_cond, $id_contacto, $id_contacto_input_2, $id_contacto_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp,
             $apellido_cond, $apellido, $apellido_autocomp,
             $email_cond, $email, $email_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_contacto_autocomp) && empty($id_contacto))
      {
          $id_contacto = $id_contacto_autocomp;
      }
      if (!empty($nombre_autocomp) && empty($nombre))
      {
          $nombre = $nombre_autocomp;
      }
      if (!empty($apellido_autocomp) && empty($apellido))
      {
          $apellido = $apellido_autocomp;
      }
      if (!empty($email_autocomp) && empty($email))
      {
          $email = $email_autocomp;
      }
      $id_contacto_cond_salva = $id_contacto_cond; 
      if (!isset($id_contacto_input_2) || $id_contacto_input_2 == "")
      {
          $id_contacto_input_2 = $id_contacto;
      }
      ...
      $apellido_cond_salva = $apellido_cond; 
      if (!isset($apellido_input_2) || $apellido_input_2 == "")
      {
          $apellido_input_2 = $apellido;
      }
      ...
      if ($id_contacto_cond != "in")
      {
          nm_limpa_numero($id_contacto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_contacto);
          ...
          $id_contacto = implode(",", $Nm_sc_valores);
      }
      if ($id_contacto_cond != "in")
      {
          nm_limpa_numero($id_contacto_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['id_contacto'] = $id_contacto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['id_contacto_input_2'] = $id_contacto_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['id_contacto_cond'] = $id_contacto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['nombre'] = $nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['apellido'] = $apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['apellido_cond'] = $apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['email'] = $email; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['email_cond'] = $email_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!is_numeric($id_contacto) && $id_contacto_cond != "in")
      {
          $id_contacto = "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_contacto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_contacto'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_contacto'] = $id_contacto;
      }
      $Conteudo = $id_contacto_input_2;
      if (strtoupper($id_contacto_cond) != "II" && strtoupper($id_contacto_cond) != "QP" && strtoupper($id_contacto_cond) != "NP" && strtoupper($id_contacto_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_contacto_input_2'] = $Conteudo;
      $nombre_look = substr($this->Db->qstr($nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre from " . $this->Ini->nm_tabela . " where nombre = '$nombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['apellido'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['apellido'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['apellido'] = $apellido;
      }
      $email_look = substr($this->Db->qstr($email), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct email from " . $this->Ini->nm_tabela . " where email = '$email_look'"; 
      ...
      if (isset($id_contacto) || $id_contacto_cond == "nu" || $id_contacto_cond == "nn" || $id_contacto_cond == "ep" || $id_contacto_cond == "ne")
      {
         $this->monta_condicao("id_contacto", $id_contacto_cond, $id_contacto, $id_contacto_input_2, "id_contacto");
      }
      ...
      //----- $apellido
      $this->Date_part = false;
      if (isset($apellido) || $apellido_cond == "nu" || $apellido_cond == "nn" || $apellido_cond == "ep" || $apellido_cond == "ne")
      {
         $this->monta_condicao("apellido", $apellido_cond, $apellido, "", "apellido");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contacto']['where_pesq_ant'] = $this->comando . $this->comando_fim;
