...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Phronesis_____grid_contacto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Phronesis_____grid_contacto"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contacto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contacto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contacto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contacto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contacto']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contacto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contacto']['embutida_filho'] as $ind => $sc_init)
          {
