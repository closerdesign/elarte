...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['apellido'] = "on";
   $tab_def_campos['apellido'] = "apellido";
   $tab_converte["apellido"]   = "apellido";
   $tab_labels["apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["apellido"] : "Apellido";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["email"] : "Email";
   $tab_ger_campos['pais'] = "on";
   $tab_def_campos['pais'] = "pais";
   $tab_converte["pais"]   = "pais";
   $tab_labels["pais"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["pais"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["pais"] : "Pais";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_converte["creado"]   = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["creado"] : "Creado";
