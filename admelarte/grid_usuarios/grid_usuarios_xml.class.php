...
class grid_usuarios_xml
{
   ...
   function NM_export_pais()
   {
         ...
         $this->xml_registro .= " pais =\"" . $this->trata_dados($this->pais) . "\"";
   }
   //----- creado
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->fbid))
         {
             $this->fbid = mb_convert_encoding($this->fbid, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " fbid =\"" . $this->trata_dados($this->fbid) . "\"";
   }
   //----- nombrecompleto
   function NM_export_nombrecompleto()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->nombrecompleto))
         {
             $this->nombrecompleto = mb_convert_encoding($this->nombrecompleto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " nombrecompleto =\"" . $this->trata_dados($this->nombrecompleto) . "\"";
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - usuarios :: XML</TITLE>
