...
class grid_usuarios_rtf
{
   ...
   function NM_export_fbid()
   {
         ...
         $this->fbid = str_replace('<', '&lt;', $this->fbid);
         $this->fbid = str_replace('>', '&gt;', $this->fbid);
         $this->texto_tag .= "<td>" . $this->fbid . "</td>\r\n";
   }
   //----- nombrecompleto
   function NM_export_nombrecompleto()
   {
         ...
         $this->nombrecompleto = str_replace('<', '&lt;', $this->nombrecompleto);
         $this->nombrecompleto = str_replace('>', '&gt;', $this->nombrecompleto);
         $this->texto_tag .= "<td>" . $this->nombrecompleto . "</td>\r\n";
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - usuarios :: RTF</TITLE>
