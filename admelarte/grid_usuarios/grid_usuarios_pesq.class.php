      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " = " . $nm_aspas . $campo . $nm_aspas;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "II":     // 
               ...
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " like '" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       if (in_array($nome_campo, $this->Out_dyn_search))
                       {
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = $NM_cmd;
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       }
                   }
               }
               else
               {
                   ...
                   if (in_array($nome_campo, $this->Out_dyn_search))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . $op_all . "'%" . $campo . "%'";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   }
               }
            break;
            case "DF":     // 
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GT":     // 
               ...
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome > " . $nm_aspas . $campo . $nm_aspas;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome >= " . $nm_aspas . $campo . $nm_aspas;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome < " . $nm_aspas . $campo . $nm_aspas;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome <= " . $nm_aspas . $campo . $nm_aspas;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "BW":     // 
               ...
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome between " . $nm_aspas . $campo . $nm_aspas . " and " . $nm_aspas . $campo2 . $nm_aspas;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               }
            break;
            case "IN":     // 
               ...
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " in (" . $cond_str . ")";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
               }
            break;
            case "NU":     // 
               ...
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome IS NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'];
               }
            break;
            case "NN":     // 
               ...
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome IS NOT NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'];
               }
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               ...
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome = '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'];
               }
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd'][]  = " $nome <> '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'];
               }
            break;
         }
      }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - usuarios</TITLE>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - usuarios</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $creado_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_dia']; 
          $creado_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_mes']; 
          $creado_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_ano']; 
          $creado_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_dia']; 
          $creado_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_mes']; 
          $creado_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_ano']; 
          $creado_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_hor']; 
          $creado_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_min']; 
          $creado_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_seg']; 
          $creado_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_hor']; 
          $creado_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_min']; 
          $creado_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_seg']; 
          $creado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_cond']; 
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_creado_cond" name="creado_cond" onChange="nm_campos_between(document.getElementById('id_vis_creado'), this, 'creado')">
       <OPTION value="bw"><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_creado_dia').bind('change', function() {sc_grid_usuarios_valida_dia(this)});
    $('#SC_creado_input_2_dia').bind('change', function() {sc_grid_usuarios_valida_dia(this)});
    $('#SC_creado_input_2_mes').bind('change', function() {sc_grid_usuarios_valida_mes(this)});
    $('#SC_creado_mes').bind('change', function() {sc_grid_usuarios_valida_mes(this)});
 }
 function sc_grid_usuarios_valida_dia(obj)
 {
 ...
 function sc_grid_usuarios_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Phronesis/grid_usuarios";
   ...
   {
      global $creado_cond, $creado, $creado_dia, $creado_mes, $creado_ano, $creado_hor, $creado_min, $creado_seg, $creado_input_2_dia, $creado_input_2_mes, $creado_input_2_ano, $creado_input_2_min, $creado_input_2_hor, $creado_input_2_seg, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $this->Out_dyn_search = array();
      $this->Out_dyn_search[] = "creado";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cmd']  = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search_out_cond'] = array();
      ...
      $I_Dyn = 0;
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_dia'] = $creado_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_mes'] = $creado_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_ano'] = $creado_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_dia'] = $creado_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_mes'] = $creado_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_ano'] = $creado_input_2_ano; 
      ...
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][0][] = "D:" . $creado_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][0][] = "M:" . $creado_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][0][] = "Y:" . $creado_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][1][] = "D:" . $creado_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][1][] = "M:" . $creado_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][1][] = "Y:" . $creado_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_hor'] = $creado_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_min'] = $creado_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_seg'] = $creado_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_hor'] = $creado_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_min'] = $creado_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2_seg'] = $creado_input_2_seg; 
      ...
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][0][] = "H:" . $creado_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][0][] = "I:" . $creado_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][0][] = "S:" . $creado_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][1][] = "H:" . $creado_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][1][] = "I:" . $creado_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['val'][1][] = "S:" . $creado_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_cond'] = $creado_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['cmp'] = "creado"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dyn_search'][$I_Dyn]['opc'] = $creado_cond_salva; 
          $I_Dyn++;
      }
      ...
      if ($creado_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['creado'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['creado'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "ddmmaaaa"));
          if ($creado_cond == "BW")
          {
              $creado_input_2     = $val[1];
              $this->cmp_formatado['creado_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['creado_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['creado_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['creado_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "ddmmaaaa"));
          }
