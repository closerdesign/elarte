<?php
   ...
   session_start();
    $Ord_Cmp = new grid_comentarios_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_comentarios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['articulo'] = "on";
   $tab_def_campos['articulo'] = "articulo";
   $tab_converte["articulo"]   = "articulo";
   $tab_labels["articulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["articulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["articulo"] : "Articulo";
   $tab_ger_campos['comentarios'] = "on";
   $tab_def_campos['comentarios'] = "comentarios";
   $tab_converte["comentarios"]   = "comentarios";
   $tab_labels["comentarios"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["comentarios"])) ? $_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["comentarios"] : "Comentarios";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_converte["status"]   = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["status"] : "Status";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_converte["creado"]   = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_comentarios']['labels']["creado"] : "Creado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_comentarios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_comentarios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - comentarios</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_comentarios_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_comentarios']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
