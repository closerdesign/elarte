...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idcomentarios";$Nm_numeric[] = "usuario";$Nm_numeric[] = "articulo";$Nm_numeric[] = "status";$Nm_numeric[] = "idcomentarios";$Nm_numeric[] = "usuario";$Nm_numeric[] = "articulo";$Nm_numeric[] = "status";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_idcomentarios"  <?php echo $str_hide_idcomentarios?>><?php
      $idcomentarios_look = substr($this->Db->qstr($idcomentarios), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idcomentarios" name="idcomentarios_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_idcomentarios"  <?php echo $str_display_idcomentarios; ?> class="scFilterFieldFontOdd">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_articulo"  <?php echo $str_hide_articulo?>><?php
      $articulo_look = substr($this->Db->qstr($articulo), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_articulo" name="articulo_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_articulo"  <?php echo $str_display_articulo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_articulo_input_2" name="articulo_input_2" value="<?php echo NM_encode_input($articulo_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_comentarios"  <?php echo $str_hide_comentarios?>><INPUT  type="text" id="SC_comentarios" name="comentarios" value="<?php echo NM_encode_input($comentarios) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
