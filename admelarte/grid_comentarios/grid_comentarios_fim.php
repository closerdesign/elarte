...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Phronesis_____grid_comentarios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Phronesis_____grid_comentarios"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_comentarios']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_comentarios']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_comentarios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_comentarios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_comentarios']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_comentarios']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_comentarios']['embutida_filho'] as $ind => $sc_init)
          {
