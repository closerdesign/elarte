...
class grid_comentarios_pesq
{
    ...
    * @access  public
    */
   function grid_comentarios_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_comentarios_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_comentarios_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_comentarios_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idcomentarios')
      {
          $idcomentarios = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idcomentarios($idcomentarios);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_articulo')
      {
          $articulo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? mb_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_articulo($articulo);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_idcomentarios($idcomentarios)
   {
      $idcomentarios = substr($this->Db->qstr($idcomentarios), 1, -1);
            $idcomentarios_look = substr($this->Db->qstr($idcomentarios), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct idComentarios from " . $this->Ini->nm_tabela . " where  idComentarios like '%" . $idcomentarios . "%'"; 
   ...
   function lookup_ajax_articulo($articulo)
   {
      $articulo = substr($this->Db->qstr($articulo), 1, -1);
            $articulo_look = substr($this->Db->qstr($articulo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct articulo from " . $this->Ini->nm_tabela . " where  articulo like '%" . $articulo . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - comentarios</TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_comentarios_ajax_search.js"></script>
 <script type="text/javascript" src="grid_comentarios_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idcomentarios_cond#NMF#' + search_get_sel_txt('SC_idcomentarios_cond') + '@NMF@';
  str_out += 'SC_idcomentarios#NMF#' + search_get_text('SC_idcomentarios') + '@NMF@';
  str_out += 'id_ac_idcomentarios#NMF#' + search_get_text('id_ac_idcomentarios') + '@NMF@';
  str_out += 'SC_idcomentarios_input_2#NMF#' + search_get_text('SC_idcomentarios_input_2') + '@NMF@';
  ...
  str_out += 'SC_articulo_cond#NMF#' + search_get_sel_txt('SC_articulo_cond') + '@NMF@';
  str_out += 'SC_articulo#NMF#' + search_get_text('SC_articulo') + '@NMF@';
  str_out += 'id_ac_articulo#NMF#' + search_get_text('id_ac_articulo') + '@NMF@';
  str_out += 'SC_articulo_input_2#NMF#' + search_get_text('SC_articulo_input_2') + '@NMF@';
  str_out += 'SC_comentarios_cond#NMF#' + search_get_sel_txt('SC_comentarios_cond') + '@NMF@';
  str_out += 'SC_comentarios#NMF#' + search_get_text('SC_comentarios') + '@NMF@';
   ...
   $("#id_ac_articulo").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_articulo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_articulo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_articulo").val( $(this).val() );
       }
     }
   });
   $("#id_ac_idcomentarios").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idcomentarios",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_idcomentarios").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idcomentarios").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - comentarios</span></td>
...
<?php
   ...
   {
      global 
             $idcomentarios_cond, $idcomentarios, $idcomentarios_input_2, $idcomentarios_autocomp,
             $usuario_cond, $usuario, $usuario_input_2, $usuario_autocomp,
             $articulo_cond, $articulo, $articulo_input_2, $articulo_autocomp,
             $comentarios_cond, $comentarios,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idcomentarios = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['idcomentarios']; 
          $idcomentarios_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['idcomentarios_input_2']; 
          $idcomentarios_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['idcomentarios_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['usuario']; 
          $usuario_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['usuario_input_2']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['usuario_cond']; 
          $articulo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['articulo']; 
          $articulo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['articulo_input_2']; 
          $articulo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['articulo_cond']; 
          $comentarios = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['comentarios']; 
          $comentarios_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['comentarios_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idcomentarios_cond) || empty($idcomentarios_cond))
      {
         $idcomentarios_cond = "gt";
      }
      if (!isset($usuario_cond) || empty($usuario_cond))
      {
         $usuario_cond = "gt";
      }
      if (!isset($articulo_cond) || empty($articulo_cond))
      {
         $articulo_cond = "gt";
      }
      if (!isset($comentarios_cond) || empty($comentarios_cond))
      {
         $comentarios_cond = "qp";
      }
      ...
      $str_hide_idcomentarios = (in_array($idcomentarios_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usuario = (in_array($usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_articulo = (in_array($articulo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_comentarios = (in_array($comentarios_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idcomentarios = ('bw' == $idcomentarios_cond) ? $display_aberto : $display_fechado;
      $str_display_usuario = ('bw' == $usuario_cond) ? $display_aberto : $display_fechado;
      $str_display_articulo = ('bw' == $articulo_cond) ? $display_aberto : $display_fechado;

      if (!isset($idcomentarios) || $idcomentarios == "")
      {
          $idcomentarios = "";
      }
      if (isset($idcomentarios) && !empty($idcomentarios))
      {
         $tmp_pos = strpos($idcomentarios, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idcomentarios = substr($idcomentarios, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($articulo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $articulo = substr($articulo, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($comentarios, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $comentarios = substr($comentarios, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_comentarios_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcomentarios'])) ? $this->New_label['idcomentarios'] : "Id Comentarios"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcomentarios_cond" name="idcomentarios_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcomentarios'), this, 'idcomentarios')">
       <OPTION value="gt" <?php if ("gt" == $idcomentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcomentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcomentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idcomentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idcomentarios" <?php echo $str_hide_idcomentarios?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idcomentarios'])) ? $this->New_label['idcomentarios'] : "Id Comentarios";
 $nmgp_tab_label .= "idcomentarios?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $idcomentarios_look = substr($this->Db->qstr($idcomentarios), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idcomentarios))
   { 
      $nm_comando = "select distinct idComentarios from " . $this->Ini->nm_tabela . " where idComentarios = $idcomentarios_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$idcomentarios]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idcomentarios];
      }
      else
      {
          $sAutocompValue = $idcomentarios;
      }
?>
<INPUT  type="text" id="SC_idcomentarios" name="idcomentarios" value="<?php echo NM_encode_input($idcomentarios) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idcomentarios" name="idcomentarios_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idcomentarios"  <?php echo $str_display_idcomentarios; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcomentarios_input_2" name="idcomentarios_input_2" value="<?php echo NM_encode_input($idcomentarios_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['articulo'])) ? $this->New_label['articulo'] : "Articulo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_articulo_cond" name="articulo_cond" onChange="nm_campos_between(document.getElementById('id_vis_articulo'), this, 'articulo')">
       <OPTION value="gt" <?php if ("gt" == $articulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $articulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $articulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $articulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_articulo" <?php echo $str_hide_articulo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['articulo'])) ? $this->New_label['articulo'] : "Articulo";
 $nmgp_tab_label .= "articulo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $articulo_look = substr($this->Db->qstr($articulo), 1, -1); 
   ...
   { 
      $nm_comando = "select distinct articulo from " . $this->Ini->nm_tabela . " where articulo = $articulo_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$articulo]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$articulo];
      }
      else
      {
          $sAutocompValue = $articulo;
      }
?>
<INPUT  type="text" id="SC_articulo" name="articulo" value="<?php echo NM_encode_input($articulo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_articulo" name="articulo_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_articulo"  <?php echo $str_display_articulo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_articulo_input_2" name="articulo_input_2" value="<?php echo NM_encode_input($articulo_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['comentarios'])) ? $this->New_label['comentarios'] : "Comentarios"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_comentarios_cond" name="comentarios_cond" onChange="nm_campos_between(document.getElementById('id_vis_comentarios'), this, 'comentarios')">
       <OPTION value="qp" <?php if ("qp" == $comentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $comentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $comentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $comentarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_comentarios" <?php echo $str_hide_comentarios?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['comentarios'])) ? $this->New_label['comentarios'] : "Comentarios";
 $nmgp_tab_label .= "comentarios?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_comentarios" name="comentarios" value="<?php echo NM_encode_input($comentarios) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_comentarios']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_comentarios']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_idcomentarios'), document.F1.idcomentarios_cond, 'idcomentarios');
   document.F1.idcomentarios.value = "";
   document.F1.idcomentarios_autocomp.value = "";
   document.F1.idcomentarios_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_articulo'), document.F1.articulo_cond, 'articulo');
   document.F1.articulo.value = "";
   document.F1.articulo_autocomp.value = "";
   document.F1.articulo_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_comentarios'), document.F1.comentarios_cond, 'comentarios');
   document.F1.comentarios.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Phronesis/grid_comentarios";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_idcomentarios_cond'] = 'cond';
      $tp_fields['SC_idcomentarios'] = 'text_aut';
      $tp_fields['id_ac_idcomentarios'] = 'text_aut';
      $tp_fields['SC_idcomentarios_input_2'] = 'text';
      ...
      $tp_fields['SC_articulo_cond'] = 'cond';
      $tp_fields['SC_articulo'] = 'text_aut';
      $tp_fields['id_ac_articulo'] = 'text_aut';
      $tp_fields['SC_articulo_input_2'] = 'text';
      $tp_fields['SC_comentarios_cond'] = 'cond';
      $tp_fields['SC_comentarios'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $idcomentarios_cond, $idcomentarios, $idcomentarios_input_2, $idcomentarios_autocomp,
             $usuario_cond, $usuario, $usuario_input_2, $usuario_autocomp,
             $articulo_cond, $articulo, $articulo_input_2, $articulo_autocomp,
             $comentarios_cond, $comentarios, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($idcomentarios_autocomp) && empty($idcomentarios))
      {
          $idcomentarios = $idcomentarios_autocomp;
      }
      if (!empty($usuario_autocomp) && empty($usuario))
      {
          $usuario = $usuario_autocomp;
      }
      if (!empty($articulo_autocomp) && empty($articulo))
      {
          $articulo = $articulo_autocomp;
      }
      $idcomentarios_cond_salva = $idcomentarios_cond; 
      if (!isset($idcomentarios_input_2) || $idcomentarios_input_2 == "")
      {
          $idcomentarios_input_2 = $idcomentarios;
      }
      ...
      $articulo_cond_salva = $articulo_cond; 
      if (!isset($articulo_input_2) || $articulo_input_2 == "")
      {
          $articulo_input_2 = $articulo;
      }
      $comentarios_cond_salva = $comentarios_cond; 
      if (!isset($comentarios_input_2) || $comentarios_input_2 == "")
      {
          $comentarios_input_2 = $comentarios;
      }
      if ($idcomentarios_cond != "in")
      {
          nm_limpa_numero($idcomentarios, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $idcomentarios);
          ...
          $idcomentarios = implode(",", $Nm_sc_valores);
      }
      if ($idcomentarios_cond != "in")
      {
          nm_limpa_numero($idcomentarios_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($usuario_cond != "in")
      {
      ...
      if ($articulo_cond != "in")
      {
          nm_limpa_numero($articulo, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $articulo);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $articulo = implode(",", $Nm_sc_valores);
      }
      if ($articulo_cond != "in")
      {
          nm_limpa_numero($articulo_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['idcomentarios'] = $idcomentarios; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['idcomentarios_input_2'] = $idcomentarios_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['idcomentarios_cond'] = $idcomentarios_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['usuario'] = $usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['usuario_input_2'] = $usuario_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['articulo'] = $articulo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['articulo_input_2'] = $articulo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['articulo_cond'] = $articulo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['comentarios'] = $comentarios; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['comentarios_cond'] = $comentarios_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!is_numeric($idcomentarios) && $idcomentarios_cond != "in")
      {
          $idcomentarios = "";
      }
      ...
      if (!is_numeric($articulo) && $articulo_cond != "in")
      {
          $articulo = "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idcomentarios'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idcomentarios'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idcomentarios'] = $idcomentarios;
      }
      $Conteudo = $idcomentarios_input_2;
      if (strtoupper($idcomentarios_cond) != "II" && strtoupper($idcomentarios_cond) != "QP" && strtoupper($idcomentarios_cond) != "NP" && strtoupper($idcomentarios_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idcomentarios_input_2'] = $Conteudo;
      $usuario_look = substr($this->Db->qstr($usuario), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($usuario))
   { 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['articulo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['articulo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['articulo'] = $articulo;
      }
      $Conteudo = $articulo_input_2;
      if (strtoupper($articulo_cond) != "II" && strtoupper($articulo_cond) != "QP" && strtoupper($articulo_cond) != "NP" && strtoupper($articulo_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['articulo_input_2'] = $Conteudo;
      $Conteudo = $comentarios;
      $this->cmp_formatado['comentarios'] = $Conteudo;

      //----- $idcomentarios
      $this->Date_part = false;
      if (isset($idcomentarios) || $idcomentarios_cond == "nu" || $idcomentarios_cond == "nn" || $idcomentarios_cond == "ep" || $idcomentarios_cond == "ne")
      {
         $this->monta_condicao("idComentarios", $idcomentarios_cond, $idcomentarios, $idcomentarios_input_2, "idcomentarios");
      }
      ...
      //----- $articulo
      $this->Date_part = false;
      if (isset($articulo) || $articulo_cond == "nu" || $articulo_cond == "nn" || $articulo_cond == "ep" || $articulo_cond == "ne")
      {
         $this->monta_condicao("articulo", $articulo_cond, $articulo, $articulo_input_2, "articulo");
      }

      //----- $comentarios
      $this->Date_part = false;
      if (isset($comentarios) || $comentarios_cond == "nu" || $comentarios_cond == "nn" || $comentarios_cond == "ep" || $comentarios_cond == "ne")
      {
         $this->monta_condicao("comentarios", $comentarios_cond, $comentarios, "", "comentarios");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comentarios']['where_pesq_ant'] = $this->comando . $this->comando_fim;
