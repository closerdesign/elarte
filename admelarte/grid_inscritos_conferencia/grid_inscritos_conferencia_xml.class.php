...
class grid_inscritos_conferencia_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_inscritos_conferencia_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_inscritos_conferencia.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_inscritos_conferencia";
   ...
   function NM_export_usuario_id()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_usuario_id))
         {
             $this->look_usuario_id = mb_convert_encoding($this->look_usuario_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " usuario_id =\"" . $this->trata_dados($this->look_usuario_id) . "\"";
   }
   //----- estado_inscripcion
   function NM_export_estado_inscripcion()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_estado_inscripcion))
         {
             $this->look_estado_inscripcion = mb_convert_encoding($this->look_estado_inscripcion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " estado_inscripcion =\"" . $this->trata_dados($this->look_estado_inscripcion) . "\"";
   }
   //----- metodo_pago
   function NM_export_metodo_pago()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_metodo_pago))
         {
             $this->look_metodo_pago = mb_convert_encoding($this->look_metodo_pago, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " metodo_pago =\"" . $this->trata_dados($this->look_metodo_pago) . "\"";
   }
   //----- transaction_id
   function NM_export_transaction_id()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->transaction_id))
         {
             $this->transaction_id = mb_convert_encoding($this->transaction_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " transaction_id =\"" . $this->trata_dados($this->transaction_id) . "\"";
   }
   //----- valor_inscripcion
   function NM_export_valor_inscripcion()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->valor_inscripcion))
         {
             $this->valor_inscripcion = mb_convert_encoding($this->valor_inscripcion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " valor_inscripcion =\"" . $this->trata_dados($this->valor_inscripcion) . "\"";
   }
   //----- creado
   ...
   function NM_export_id_inscripcion()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_inscripcion))
         {
             $this->id_inscripcion = mb_convert_encoding($this->id_inscripcion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " id_inscripcion =\"" . $this->trata_dados($this->id_inscripcion) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - inscritos_conferencia :: XML</TITLE>
