<?php
   ...
   session_start();
    $Ord_Cmp = new grid_inscritos_conferencia_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_inscritos_conferencia_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['usuario_id'] = "usuario_id";
   $tab_converte["usuario_id"]   = "usuario_id";
   $tab_labels["usuario_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["usuario_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["usuario_id"] : "Usuario Id";
   $tab_ger_campos['estado_inscripcion'] = "on";
   $tab_def_campos['estado_inscripcion'] = "estado_inscripcion";
   $tab_converte["estado_inscripcion"]   = "estado_inscripcion";
   $tab_labels["estado_inscripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["estado_inscripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["estado_inscripcion"] : "Estado Inscripcion";
   $tab_ger_campos['metodo_pago'] = "on";
   $tab_def_campos['metodo_pago'] = "metodo_pago";
   $tab_converte["metodo_pago"]   = "metodo_pago";
   $tab_labels["metodo_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["metodo_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["metodo_pago"] : "Metodo Pago";
   $tab_ger_campos['transaction_id'] = "on";
   $tab_def_campos['transaction_id'] = "transaction_id";
   $tab_converte["transaction_id"]   = "transaction_id";
   $tab_labels["transaction_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["transaction_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["transaction_id"] : "Transaction Id";
   $tab_ger_campos['valor_inscripcion'] = "on";
   $tab_def_campos['valor_inscripcion'] = "valor_inscripcion";
   $tab_converte["valor_inscripcion"]   = "valor_inscripcion";
   $tab_labels["valor_inscripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["valor_inscripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["valor_inscripcion"] : "Valor Inscripcion";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_converte["creado"]   = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['labels']["creado"] : "Creado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - inscritos_conferencia</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_inscritos_conferencia_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_inscritos_conferencia']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
