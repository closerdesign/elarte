...
class grid_inscritos_conferencia_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_inscritos_conferencia_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_inscritos_conferencia_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_inscritos_conferencia_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_inscritos_conferencia_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "inscritos_conferencia.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - inscritos_conferencia</TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_inscritos_conferencia_ajax_search.js"></script>
 <script type="text/javascript" src="grid_inscritos_conferencia_ajax.js"></script>
 <script type="text/javascript">
...
if (is_file($this->Ini->root . $this->Ini->path_link . "_lib/js/tab_erro_" . $this->Ini->str_lang . ".js"))
{
 ...
 if (NM_is_utf8($Lines) && $_SESSION['scriptcase']['charset'] != "UTF-8")
 {
    $Msg_Inval = mb_convert_encoding("Inv�lido", $_SESSION['scriptcase']['charset'], "UTF-8");
 }
?>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_estado_inscripcion_cond#NMF#' + search_get_sel_txt('SC_estado_inscripcion_cond') + '@NMF@';
  str_out += 'SC_estado_inscripcion#NMF#' + search_get_select('SC_estado_inscripcion') + '@NMF@';
  str_out += 'SC_metodo_pago_cond#NMF#' + search_get_sel_txt('SC_metodo_pago_cond') + '@NMF@';
  str_out += 'SC_metodo_pago#NMF#' + search_get_select('SC_metodo_pago') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - inscritos_conferencia</span></td>
...
<?php
   ...
   {
      global 
             $estado_inscripcion_cond, $estado_inscripcion,
             $metodo_pago_cond, $metodo_pago,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $estado_inscripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['estado_inscripcion']; 
          $estado_inscripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['estado_inscripcion_cond']; 
          $metodo_pago = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['metodo_pago']; 
          $metodo_pago_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['metodo_pago_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_estado_inscripcion = (in_array($estado_inscripcion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_metodo_pago = (in_array($metodo_pago_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($estado_inscripcion) || $estado_inscripcion == "")
      {
          $estado_inscripcion = "";
      }
      if (isset($estado_inscripcion) && !empty($estado_inscripcion))
      {
         $tmp_pos = strpos($estado_inscripcion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $estado_inscripcion = substr($estado_inscripcion, 0, $tmp_pos);
         }
      }
      if (!isset($metodo_pago) || $metodo_pago == "")
      {
          $metodo_pago = "";
      }
      if (isset($metodo_pago) && !empty($metodo_pago))
      {
         $tmp_pos = strpos($metodo_pago, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $metodo_pago = substr($metodo_pago, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_inscritos_conferencia_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['estado_inscripcion'])) ? $this->New_label['estado_inscripcion'] : "Estado Inscripcion"; ?></TD>
      
      <INPUT type="hidden" id="SC_estado_inscripcion_cond" name="estado_inscripcion_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_estado_inscripcion" <?php echo $str_hide_estado_inscripcion?> valign="top">
 ...
 $nmgp_tab_label .= "estado_inscripcion?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['estado_inscripcion'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['estado_inscripcion'][] = "0";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['estado_inscripcion'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['estado_inscripcion'][] = "2";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_estado_inscripcion"  name="estado_inscripcion"  size="1">
 <OPTION value="">Seleccione...</option>
 <OPTION value="0##@@Rechazado / Cancelado"<?php if ($estado_inscripcion == "0") { echo " selected" ;} ?>>Rechazado / Cancelado</option>
 <OPTION value="1##@@Pago Exitoso"<?php if ($estado_inscripcion == "1") { echo " selected" ;} ?>>Pago Exitoso</option>
 <OPTION value="2##@@Pendiente"<?php if ($estado_inscripcion == "2") { echo " selected" ;} ?>>Pendiente</option>
 </SELECT>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['metodo_pago'])) ? $this->New_label['metodo_pago'] : "Metodo Pago"; ?></TD>
      
      <INPUT type="hidden" id="SC_metodo_pago_cond" name="metodo_pago_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_metodo_pago" <?php echo $str_hide_metodo_pago?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['metodo_pago'])) ? $this->New_label['metodo_pago'] : "Metodo Pago";
 $nmgp_tab_label .= "metodo_pago?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'][] = "2";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'][] = "3";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'][] = "4";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'][] = "5";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'][] = "6";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_metodo_pago"  name="metodo_pago"  size="1">
 <OPTION value="">Seleccione...</option>
 <OPTION value="1##@@Tarjeta de Crédito"<?php if ($metodo_pago == "1") { echo " selected" ;} ?>>Tarjeta de Crédito</option>
 <OPTION value="2##@@Paypal"<?php if ($metodo_pago == "2") { echo " selected" ;} ?>>Paypal</option>
 <OPTION value="3##@@Transferencia PSE"<?php if ($metodo_pago == "3") { echo " selected" ;} ?>>Transferencia PSE</option>
 <OPTION value="4##@@Baloto"<?php if ($metodo_pago == "4") { echo " selected" ;} ?>>Baloto</option>
 <OPTION value="5##@@Oxxo"<?php if ($metodo_pago == "5") { echo " selected" ;} ?>>Oxxo</option>
 <OPTION value="6##@@BCP"<?php if ($metodo_pago == "6") { echo " selected" ;} ?>>BCP</option>
 </SELECT>
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['opc_psq'] && !$this->aba_iframe))
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_estado_inscripcion'), document.F1.estado_inscripcion_cond, 'estado_inscripcion');
   document.F1.estado_inscripcion.value = "";
   nm_campos_between(document.getElementById('id_vis_metodo_pago'), document.F1.metodo_pago_cond, 'metodo_pago');
   document.F1.metodo_pago.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Phronesis/grid_inscritos_conferencia";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_inscritos_conferencia/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_estado_inscripcion_cond'] = 'cond';
      $tp_fields['SC_estado_inscripcion'] = 'select';
      $tp_fields['SC_metodo_pago_cond'] = 'cond';
      $tp_fields['SC_metodo_pago'] = 'select';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $estado_inscripcion_cond, $estado_inscripcion,
             $metodo_pago_cond, $metodo_pago, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $estado_inscripcion_cond_salva = $estado_inscripcion_cond; 
      if (!isset($estado_inscripcion_input_2) || $estado_inscripcion_input_2 == "")
      {
          $estado_inscripcion_input_2 = $estado_inscripcion;
      }
      $metodo_pago_cond_salva = $metodo_pago_cond; 
      if (!isset($metodo_pago_input_2) || $metodo_pago_input_2 == "")
      {
          $metodo_pago_input_2 = $metodo_pago;
      }
      $tmp_pos = strpos($estado_inscripcion, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $estado_inscripcion;
      }
      else {
          $L_lookup = substr($estado_inscripcion, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['estado_inscripcion'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Estado Inscripcion : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($metodo_pago, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $metodo_pago;
      }
      else {
          $L_lookup = substr($metodo_pago, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['psq_check_ret']['metodo_pago'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Metodo Pago : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['estado_inscripcion'] = $estado_inscripcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['estado_inscripcion_cond'] = $estado_inscripcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['metodo_pago'] = $metodo_pago; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['metodo_pago_cond'] = $metodo_pago_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $estado_inscripcion;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['estado_inscripcion'] = $Conteudo;
      $Conteudo = $metodo_pago;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['metodo_pago'] = $Conteudo;

      //----- $estado_inscripcion
      $this->Date_part = false;
      if (isset($estado_inscripcion))
      {
         $this->monta_condicao("estado_inscripcion", $estado_inscripcion_cond, $estado_inscripcion, "", "estado_inscripcion");
      }
      ...
      {
         $this->monta_condicao("metodo_pago", $metodo_pago_cond, $metodo_pago, "", "metodo_pago");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inscritos_conferencia']['where_pesq_ant'] = $this->comando . $this->comando_fim;
