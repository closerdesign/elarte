...
$oExportPdf = new grid_inscritos_conferencia_export_pdf;
$oExportPdf->exportPdf();

class grid_inscritos_conferencia_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - inscritos_conferencia :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_inscritos_conferencia_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_inscritos_conferencia']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_inscritos_conferencia']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_inscritos_conferencia.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_inscritos_conferencia']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_inscritos_conferencia']['pdf_name'] : "grid_inscritos_conferencia.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
