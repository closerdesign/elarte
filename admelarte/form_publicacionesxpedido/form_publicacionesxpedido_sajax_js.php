  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_publicacionesxpedido" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_publicacionesxpedido_validate_publicacion()
  {
    var nomeCampo_publicacion = "publicacion";
    var var_publicacion = scAjaxGetFieldSelect(nomeCampo_publicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacionesxpedido_validate_publicacion(var_publicacion, var_script_case_init, do_ajax_form_publicacionesxpedido_validate_publicacion_cb);
  } // do_ajax_form_publicacionesxpedido_validate_publicacion

  function do_ajax_form_publicacionesxpedido_validate_publicacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacionesxpedido_validate_publicacion_cb
  // ---------- Form
  function do_ajax_form_publicacionesxpedido_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_publicacionesxpedido_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_publicacionesxpedido_submit_form(var_publicacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_publicacionesxpedido_submit_form_cb);
  } // do_ajax_form_publicacionesxpedido_submit_form

  function do_ajax_form_publicacionesxpedido_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_publicacionesxpedido_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_publicacionesxpedido_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_publicacionesxpedido_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_publicacionesxpedido_navigate_form_cb);
  } // do_ajax_form_publicacionesxpedido_navigate_form

  function do_ajax_form_publicacionesxpedido_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_publicacionesxpedido_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_publicacionesxpedido_navigate_form_cb
