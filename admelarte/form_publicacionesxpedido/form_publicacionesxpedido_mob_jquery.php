...
function scEventControl_init(iSeqRow) {
  scEventControl_data["publicacion" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
}

function scEventControl_active(iSeqRow) {
  if (scEventControl_data["publicacion" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["publicacion" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_publicacion' + iSeqRow).bind('blur', function() { sc_form_publicacionesxpedido_publicacion_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_publicacionesxpedido_publicacion_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_publicacionesxpedido_publicacion_onblur(oThis, iSeqRow) {
  do_ajax_form_publicacionesxpedido_mob_validate_publicacion();
  scCssBlur(oThis);
}

function sc_form_publicacionesxpedido_publicacion_onfocus(oThis, iSeqRow) {
