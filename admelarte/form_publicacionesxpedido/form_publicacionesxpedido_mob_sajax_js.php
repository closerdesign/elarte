  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_publicacionesxpedido_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_publicacionesxpedido_mob_validate_publicacion()
  {
    var nomeCampo_publicacion = "publicacion";
    var var_publicacion = scAjaxGetFieldSelect(nomeCampo_publicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacionesxpedido_mob_validate_publicacion(var_publicacion, var_script_case_init, do_ajax_form_publicacionesxpedido_mob_validate_publicacion_cb);
  } // do_ajax_form_publicacionesxpedido_mob_validate_publicacion

  function do_ajax_form_publicacionesxpedido_mob_validate_publicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "publicacion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacionesxpedido_mob_validate_publicacion_cb
  // ---------- Form
  function do_ajax_form_publicacionesxpedido_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_publicacionesxpedido_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_publicacion = scAjaxGetFieldSelect("publicacion");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_publicacionesxpedido_mob_submit_form(var_publicacion, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_publicacionesxpedido_mob_submit_form_cb);
  } // do_ajax_form_publicacionesxpedido_mob_submit_form

  function do_ajax_form_publicacionesxpedido_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("publicacion");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_publicacionesxpedido_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_publicacionesxpedido_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_publicacionesxpedido_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_publicacionesxpedido_mob_navigate_form_cb);
  } // do_ajax_form_publicacionesxpedido_mob_navigate_form

  function do_ajax_form_publicacionesxpedido_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_publicacionesxpedido_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_publicacionesxpedido_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "publicacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "publicacion": {"label": "Publicacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["publicacion"][1] = "publicacion";

  var ajax_field_id = {
    "publicacion": new Array("hidden_field_label_publicacion", "hidden_field_data_publicacion")
  };
