...
function navpage_atualiza(str_navpage)
{
 ...
 function nm_field_disabled(Fields, Opt, Seq) {
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['app_name_']) && $this->nmgp_cmp_hidden['app_name_'] == 'off') { $sStyleHidden_app_name_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_app_name_" style=";<?php echo $sStyleHidden_app_name_; ?>" >       
<?php
      $link_img = "";
...
<a href="javascript:nm_move('ordem', 'app_name')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a> <span class="scFormRequiredOddMult">*</span> </TD>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_access_']) && $this->nmgp_cmp_hidden['priv_access_'] == 'off') { $sStyleHidden_priv_access_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_priv_access_" style=";<?php echo $sStyleHidden_priv_access_; ?>" >       
<?php
      $link_img = "";
...
<a href="javascript:nm_move('ordem', 'priv_access')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_access_-control" /> </TD>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_insert_']) && $this->nmgp_cmp_hidden['priv_insert_'] == 'off') { $sStyleHidden_priv_insert_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_priv_insert_" style=";<?php echo $sStyleHidden_priv_insert_; ?>" >       
<?php
      $link_img = "";
...
<a href="javascript:nm_move('ordem', 'priv_insert')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_insert_-control" /> </TD>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_delete_']) && $this->nmgp_cmp_hidden['priv_delete_'] == 'off') { $sStyleHidden_priv_delete_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_priv_delete_" style=";<?php echo $sStyleHidden_priv_delete_; ?>" >       
<?php
      $link_img = "";
...
<a href="javascript:nm_move('ordem', 'priv_delete')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_delete_-control" /> </TD>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_update_']) && $this->nmgp_cmp_hidden['priv_update_'] == 'off') { $sStyleHidden_priv_update_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_priv_update_" style=";<?php echo $sStyleHidden_priv_update_; ?>" >       
<?php
      $link_img = "";
...
<a href="javascript:nm_move('ordem', 'priv_update')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_update_-control" /> </TD>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_export_']) && $this->nmgp_cmp_hidden['priv_export_'] == 'off') { $sStyleHidden_priv_export_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_priv_export_" style=";<?php echo $sStyleHidden_priv_export_; ?>" >       
<?php
      $link_img = "";
...
<a href="javascript:nm_move('ordem', 'priv_export')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_export_-control" /> </TD>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['priv_print_']) && $this->nmgp_cmp_hidden['priv_print_'] == 'off') { $sStyleHidden_priv_print_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_priv_print_" style=";<?php echo $sStyleHidden_priv_print_; ?>" >       
<?php
      $link_img = "";
...
<input type="hidden" name="app_name_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($app_name_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult" id="hidden_field_data_app_name_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_app_name_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px"><span id="id_ajax_label_app_name_<?php echo $sc_seq_vert; ?>"><?php echo $app_name_?></span>
<input type="hidden" name="app_name_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($app_name_); ?>">
...
<input type=hidden name="priv_access_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($this->priv_access_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
...
?> 
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_priv_access_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_priv_access_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
?>
<input type="hidden" name="priv_access_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($priv_access_) . "\">" . $priv_access__look . ""; ?>
<?php } else { ?>
...
$priv_access__look = "";
 if ($this->priv_access_ == "Y") { $priv_access__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "" ;} 
?>
<span id="id_read_on_priv_access_<?php echo $sc_seq_vert ; ?>" style=";<?php echo $sStyleReadLab_priv_access_; ?>"><?php echo NM_encode_input($priv_access__look); ?></span><span id="id_read_off_priv_access_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_access_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_access_" . $sc_seq_vert . "\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult" style=";"> <input type=checkbox class="sc-ui-checkbox-priv_access_ sc-ui-checkbox-priv_access_<?php echo $sc_seq_vert ?>" name="priv_access_<?php echo $sc_seq_vert ?>[]" value="Y"
...
<input type=hidden name="priv_insert_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($this->priv_insert_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
...
?> 
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_priv_insert_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_priv_insert_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
?>
<input type="hidden" name="priv_insert_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($priv_insert_) . "\">" . $priv_insert__look . ""; ?>
<?php } else { ?>
...
$priv_insert__look = "";
 if (in_array("Y", $this->priv_insert__1))  { $priv_insert__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "<br />";} 
?>
<span id="id_read_on_priv_insert_<?php echo $sc_seq_vert ; ?>" style=";<?php echo $sStyleReadLab_priv_insert_; ?>"><?php echo NM_encode_input($priv_insert__look); ?></span><span id="id_read_off_priv_insert_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_insert_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_insert_" . $sc_seq_vert . "\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult" style=";"> <input type=checkbox class="sc-ui-checkbox-priv_insert_ sc-ui-checkbox-priv_insert_<?php echo $sc_seq_vert ?>" name="priv_insert_<?php echo $sc_seq_vert ?>[]" value="Y"
...
<input type=hidden name="priv_delete_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($this->priv_delete_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
...
?> 
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_priv_delete_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_priv_delete_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
?>
<input type="hidden" name="priv_delete_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($priv_delete_) . "\">" . $priv_delete__look . ""; ?>
<?php } else { ?>
...
$priv_delete__look = "";
 if ($this->priv_delete_ == "Y") { $priv_delete__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "" ;} 
?>
<span id="id_read_on_priv_delete_<?php echo $sc_seq_vert ; ?>" style=";<?php echo $sStyleReadLab_priv_delete_; ?>"><?php echo NM_encode_input($priv_delete__look); ?></span><span id="id_read_off_priv_delete_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_delete_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_delete_" . $sc_seq_vert . "\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult" style=";"> <input type=checkbox class="sc-ui-checkbox-priv_delete_ sc-ui-checkbox-priv_delete_<?php echo $sc_seq_vert ?>" name="priv_delete_<?php echo $sc_seq_vert ?>[]" value="Y"
...
<input type=hidden name="priv_update_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($this->priv_update_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
...
?> 
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_priv_update_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_priv_update_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
?>
<input type="hidden" name="priv_update_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($priv_update_) . "\">" . $priv_update__look . ""; ?>
<?php } else { ?>
...
$priv_update__look = "";
 if ($this->priv_update_ == "Y") { $priv_update__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "" ;} 
?>
<span id="id_read_on_priv_update_<?php echo $sc_seq_vert ; ?>" style=";<?php echo $sStyleReadLab_priv_update_; ?>"><?php echo NM_encode_input($priv_update__look); ?></span><span id="id_read_off_priv_update_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_update_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_update_" . $sc_seq_vert . "\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult" style=";"> <input type=checkbox class="sc-ui-checkbox-priv_update_ sc-ui-checkbox-priv_update_<?php echo $sc_seq_vert ?>" name="priv_update_<?php echo $sc_seq_vert ?>[]" value="Y"
...
<input type=hidden name="priv_export_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($this->priv_export_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
...
?> 
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_priv_export_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_priv_export_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
?>
<input type="hidden" name="priv_export_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($priv_export_) . "\">" . $priv_export__look . ""; ?>
<?php } else { ?>
...
$priv_export__look = "";
 if (in_array("Y", $this->priv_export__1))  { $priv_export__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "<br />";} 
?>
<span id="id_read_on_priv_export_<?php echo $sc_seq_vert ; ?>" style=";<?php echo $sStyleReadLab_priv_export_; ?>"><?php echo NM_encode_input($priv_export__look); ?></span><span id="id_read_off_priv_export_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_export_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_export_" . $sc_seq_vert . "\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult" style=";"> <input type=checkbox class="sc-ui-checkbox-priv_export_ sc-ui-checkbox-priv_export_<?php echo $sc_seq_vert ?>" name="priv_export_<?php echo $sc_seq_vert ?>[]" value="Y"
...
<input type=hidden name="priv_print_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($this->priv_print_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
...
?> 
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_priv_print_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_priv_print_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
?>
<input type="hidden" name="priv_print_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($priv_print_) . "\">" . $priv_print__look . ""; ?>
<?php } else { ?>
...
$priv_print__look = "";
 if ($this->priv_print_ == "Y") { $priv_print__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "" ;} 
?>
<span id="id_read_on_priv_print_<?php echo $sc_seq_vert ; ?>" style=";<?php echo $sStyleReadLab_priv_print_; ?>"><?php echo NM_encode_input($priv_print__look); ?></span><span id="id_read_off_priv_print_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_print_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_print_" . $sc_seq_vert . "\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult" style=";"> <input type=checkbox class="sc-ui-checkbox-priv_print_ sc-ui-checkbox-priv_print_<?php echo $sc_seq_vert ?>" name="priv_print_<?php echo $sc_seq_vert ?>[]" value="Y"
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
