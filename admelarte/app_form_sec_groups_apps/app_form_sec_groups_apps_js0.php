<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="group_id_" value="<?php echo NM_encode_input($this->nmgp_dados_form['group_id_']); ?>">
<input type="hidden" name="app_name_" value="<?php echo NM_encode_input($this->nmgp_dados_form['app_name_']); ?>">
