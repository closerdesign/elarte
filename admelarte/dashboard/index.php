...
class dashboard_ini {
    ...
    function init()
    {
        ...
        {
            include_once("dashboard_nmutf8.php");
        }
...
?>
  ...
  <li class="scContainerWidget widget" id="widget1">
   <div class="widget-head scContainerTitle" >
    ...
    <h3 id="id-title-widget1">Registro de usuarios</h3>
   </div>
   <div class="widget-content" style="height: 480px; padding: 0px">
    <iframe id="id-iframe-widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_usuarios_1'); ?>/?script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>
...
var widgets_indiv = { widget1: { movable: true, removable: true, collapsible: true, editable: false } };
</script>
