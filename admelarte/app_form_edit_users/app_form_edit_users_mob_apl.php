...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(app_form_edit_users_mob_pack_protect_string($rs->fields[0]) => app_form_edit_users_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
...
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->priv_admin = $this->priv_admin_before_qstr;
              ...
              $this->nmgp_refresh_fields = array('login', 'pswd', 'confirm_pswd', 'name', 'email', 'active', 'groups');
              $this->ajax_return_values();
