...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>;"><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_name" style="<?php echo $sStyleHidden_name; ?>;"><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span></TD>
...
<input type="hidden" name="active" value="<?php echo NM_encode_input($active) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_active" style="<?php echo $sStyleHidden_active; ?>;"><span id="id_label_active"><?php echo $this->nm_new_label['active']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_active" style="<?php echo $sStyleHidden_active; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
?>
<input type="hidden" name="active" value="<?php echo NM_encode_input($active) . "\">" . $active_look . ""; ?>
<?php } else { ?>
...
<?php
 ...
 if ("N" == $this->active) { $active_look = "" . $this->Ini->Nm_lang['lang_opt_no'] . "";} 
?>
<span id="id_read_on_active" style=";<?php echo $sStyleReadLab_active; ?>"><?php echo NM_encode_input($active_look); ?></span><span id="id_read_off_active" style="<?php echo $sStyleReadInp_active; ?>"><div id="idAjaxRadio_active">
<TABLE><TR>
  <TD class="scFormDataFontOdd" style=";">    <input  type=radio name="active" value="Y"
...
<?php  if ("Y" == $this->active)  { echo " checked" ;} ?><?php  if (empty($this->active)) { echo " checked" ;} ?>  onClick="" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
  <TD class="scFormDataFontOdd" style=";">    <input  type=radio name="active" value="N"
...
<input type="hidden" name="groups" value="<?php echo NM_encode_input($groups) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_groups" style="<?php echo $sStyleHidden_groups; ?>;"><span id="id_label_groups"><?php echo $this->nm_new_label['groups']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_groups" style="<?php echo $sStyleHidden_groups; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"> 
<?php  
$nmgp_def_dados = "" ; 
...
else
{
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_groups\" style=\";" .  $sStyleReadLab_groups . "\">" . NM_encode_input($groups_look) . "</span><span id=\"id_read_off_groups\" style=\"" . $sStyleReadInp_groups . "\">";
   echo "<div id=\"idAjaxRadio_groups\">\r\n";
   $y = 0 ; 
   echo "<table border=0>\r\n";
   echo " <tr>\r\n";
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
