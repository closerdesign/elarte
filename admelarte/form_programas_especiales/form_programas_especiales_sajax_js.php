  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_programas_especiales" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate titulo
  function do_ajax_form_programas_especiales_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programas_especiales_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_programas_especiales_validate_titulo_cb);
  } // do_ajax_form_programas_especiales_validate_titulo

  function do_ajax_form_programas_especiales_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programas_especiales_validate_titulo_cb

  // ---------- Validate alias
  function do_ajax_form_programas_especiales_validate_alias()
  {
    var nomeCampo_alias = "alias";
    var var_alias = scAjaxGetFieldText(nomeCampo_alias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programas_especiales_validate_alias(var_alias, var_script_case_init, do_ajax_form_programas_especiales_validate_alias_cb);
  } // do_ajax_form_programas_especiales_validate_alias

  function do_ajax_form_programas_especiales_validate_alias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "alias";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programas_especiales_validate_alias_cb

  // ---------- Validate descripcion
  function do_ajax_form_programas_especiales_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldEditorHtml(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programas_especiales_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_programas_especiales_validate_descripcion_cb);
  } // do_ajax_form_programas_especiales_validate_descripcion

  function do_ajax_form_programas_especiales_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programas_especiales_validate_descripcion_cb

  // ---------- Validate estado
  function do_ajax_form_programas_especiales_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programas_especiales_validate_estado(var_estado, var_script_case_init, do_ajax_form_programas_especiales_validate_estado_cb);
  } // do_ajax_form_programas_especiales_validate_estado

  function do_ajax_form_programas_especiales_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programas_especiales_validate_estado_cb
  // ---------- Form
  function do_ajax_form_programas_especiales_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_programas_especiales_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_programas_especiales_submit_form(var_titulo, var_alias, var_descripcion, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_programas_especiales_submit_form_cb);
  } // do_ajax_form_programas_especiales_submit_form

  function do_ajax_form_programas_especiales_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_programas_especiales_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_programas_especiales_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_programas_especiales_navigate_form(var_id_programa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_programas_especiales_navigate_form_cb);
  } // do_ajax_form_programas_especiales_navigate_form

  function do_ajax_form_programas_especiales_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_programas_especiales_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_programas_especiales_navigate_form_cb
