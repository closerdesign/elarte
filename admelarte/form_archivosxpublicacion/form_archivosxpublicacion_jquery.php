...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idaxp_' + iSeqRow).bind('blur', function() { sc_form_archivosxpublicacion_idaxp__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_archivosxpublicacion_idaxp__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_archivosxpublicacion_idaxp__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_archivosxpublicacion_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_archivosxpublicacion_nombre__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_archivo_' + iSeqRow).bind('blur', function() { sc_form_archivosxpublicacion_archivo__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_archivosxpublicacion_archivo__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_orden_' + iSeqRow).bind('blur', function() { sc_form_archivosxpublicacion_orden__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_archivosxpublicacion_orden__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_archivosxpublicacion_orden__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_archivosxpublicacion_idaxp__onblur(oThis, iSeqRow) {
  do_ajax_form_archivosxpublicacion_validate_idaxp_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_archivosxpublicacion_idaxp__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_archivosxpublicacion_idaxp__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_archivosxpublicacion_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_archivosxpublicacion_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_archivosxpublicacion_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_archivosxpublicacion_archivo__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_archivosxpublicacion_orden__onblur(oThis, iSeqRow) {
  do_ajax_form_archivosxpublicacion_validate_orden_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_archivosxpublicacion_orden__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
