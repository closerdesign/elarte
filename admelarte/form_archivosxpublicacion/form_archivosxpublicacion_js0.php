...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_archivosxpublicacion_submit_form(y, z); 
} 
<?php
}
?>
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("form_archivosxpublicacion_doc.php?script_case_init=<?php echo NM_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id() ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "ScriptCase", "resizable, scrollbars");
}
