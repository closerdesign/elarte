  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_archivosxpublicacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre_
  function do_ajax_form_archivosxpublicacion_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_archivosxpublicacion_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_archivosxpublicacion_validate_nombre__cb);
  } // do_ajax_form_archivosxpublicacion_validate_nombre_

  function do_ajax_form_archivosxpublicacion_validate_nombre__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_archivosxpublicacion_validate_nombre__cb

  // ---------- Validate orden_
  function do_ajax_form_archivosxpublicacion_validate_orden_(iNumLinha)
  {
    var nomeCampo_orden_ = "orden_" + iNumLinha;
    var var_orden_ = scAjaxGetFieldText(nomeCampo_orden_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_archivosxpublicacion_validate_orden_(var_orden_, iNumLinha, var_script_case_init, do_ajax_form_archivosxpublicacion_validate_orden__cb);
  } // do_ajax_form_archivosxpublicacion_validate_orden_

  function do_ajax_form_archivosxpublicacion_validate_orden__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_archivosxpublicacion_validate_orden__cb

  // ---------- Validate archivo_
  function do_ajax_form_archivosxpublicacion_validate_archivo_(iNumLinha)
  {
    var nomeCampo_archivo_ = "archivo_" + iNumLinha;
    var var_archivo_ = scAjaxGetFieldText(nomeCampo_archivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_archivosxpublicacion_validate_archivo_(var_archivo_, iNumLinha, var_script_case_init, do_ajax_form_archivosxpublicacion_validate_archivo__cb);
  } // do_ajax_form_archivosxpublicacion_validate_archivo_

  function do_ajax_form_archivosxpublicacion_validate_archivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_archivosxpublicacion_validate_archivo__cb

  // ---------- Validate idaxp_
  function do_ajax_form_archivosxpublicacion_validate_idaxp_(iNumLinha)
  {
    var nomeCampo_idaxp_ = "idaxp_" + iNumLinha;
    var var_idaxp_ = scAjaxGetFieldHidden(nomeCampo_idaxp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_archivosxpublicacion_validate_idaxp_(var_idaxp_, iNumLinha, var_script_case_init, do_ajax_form_archivosxpublicacion_validate_idaxp__cb);
  } // do_ajax_form_archivosxpublicacion_validate_idaxp_

  function do_ajax_form_archivosxpublicacion_validate_idaxp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idaxp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idaxp_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idaxp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idaxp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_archivosxpublicacion_validate_idaxp__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_archivosxpublicacion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_archivosxpublicacion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_archivosxpublicacion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_archivosxpublicacion_add_new_line_cb);
  } // do_ajax_form_archivosxpublicacion_add_new_line

  function do_ajax_form_archivosxpublicacion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_archivosxpublicacion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_archivosxpublicacion_backup_line(iNumLinha)
  {
    var var_idaxp_ = scAjaxGetFieldHidden("idaxp_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_archivosxpublicacion_backup_line(var_idaxp_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_archivosxpublicacion_backup_line_cb);
  } // do_ajax_form_archivosxpublicacion_backup_line

  function do_ajax_form_archivosxpublicacion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_archivosxpublicacion_backup_line_cb

  function do_ajax_form_archivosxpublicacion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_archivosxpublicacion_cancel_insert

  function do_ajax_form_archivosxpublicacion_cancel_update(iSeqVert)
  {
    do_ajax_form_archivosxpublicacion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_archivosxpublicacion_cancel_update

  function do_ajax_form_archivosxpublicacion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_archivosxpublicacion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_archivosxpublicacion_table_refresh()
  {
    var var_idaxp_ = document.F2.idaxp_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_archivosxpublicacion_table_refresh(var_idaxp_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_archivosxpublicacion_table_refresh_cb);
  } //  do_ajax_form_archivosxpublicacion_table_refresh

  function do_ajax_form_archivosxpublicacion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.idaxp_.value = scAjaxGetKeyValue("idaxp_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_archivosxpublicacion_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_archivosxpublicacion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_archivosxpublicacion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_idaxp_ = scAjaxGetFieldHidden("idaxp_" + iNumLinha);
    var var_archivo__ul_name = scAjaxSpecCharProtect(eval('document.F1.archivo__ul_name' + iNumLinha + '.value'));
    var var_archivo__ul_type = eval('document.F1.archivo__ul_type' + iNumLinha + '.value');
    var var_archivo__salva = document.F1.elements["archivo_" + iNumLinha + "_salva"] ? eval('document.F1.archivo_' + iNumLinha + '_salva.value') : "";
    var var_archivo__limpa = eval('document.F1.archivo__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_archivosxpublicacion_submit_form(var_nombre_, var_orden_, var_archivo_, var_idaxp_, var_archivo__ul_name, var_archivo__ul_type, var_archivo__salva, var_archivo__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_archivosxpublicacion_submit_form_cb);
  } // do_ajax_form_archivosxpublicacion_submit_form

  function do_ajax_form_archivosxpublicacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idaxp_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
<?php
        ...
        {
?>
          if (document.F1.elements["archivo__limpa" + sc_num_ult_line] && document.F1.elements["archivo__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldDocument("archivo_" + sc_num_ult_line, oImgTemp, "", "");
            document.F1.elements["archivo__limpa" + sc_num_ult_line].checked = false;
          }
          else if (document.getElementById("id_ajax_doc_archivo_" + sc_num_ult_line) && "" != document.getElementById("id_ajax_doc_archivo_" + sc_num_ult_line).innerHTML)
          {
            document.getElementById("id_ajax_doc_archivo_" + sc_num_ult_line).style.display = "";
          }
<?php
        }
?>
  ...
  } // do_ajax_form_archivosxpublicacion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_archivosxpublicacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_archivosxpublicacion_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idaxp_" + iNavForm);
    }
    var var_idaxp_ = document.F2.idaxp_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_archivosxpublicacion_navigate_form(var_idaxp_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_archivosxpublicacion_navigate_form_cb);
  } // do_ajax_form_archivosxpublicacion_navigate_form

  function do_ajax_form_archivosxpublicacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idaxp_.value = scAjaxGetKeyValue("idaxp_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_archivosxpublicacion_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idaxp_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["orden_" + iNumLinha] = {"label": "Orden<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["idaxp_" + iNumLinha] = {"label": "Id Axp<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idaxp_"][iNumLinha] = "idaxp_" + iNumLinha;
    ...
    ajax_error_count["idaxp_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["idaxp_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idaxp_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idaxp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idaxp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idaxp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idaxp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idaxp_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idaxp_'])) ? $this->nmgp_cmp_readonly['idaxp_'] : 'on';
?>
    scAjaxFieldRead("idaxp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("idaxp_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["orden_" + iRow] || "on" == ajax_error_count["archivo_" + iRow] || "on" == ajax_error_count["idaxp_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_orden_" + iRow))
        document.getElementById("hidden_field_data_orden_" + iRow).className = "scFormErrorLine";
      ...
      if (document.getElementById("hidden_field_data_idaxp_" + iRow))
        document.getElementById("hidden_field_data_idaxp_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["orden_" + iRow] && "off" == ajax_error_count["archivo_" + iRow] && "off" == ajax_error_count["idaxp_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["idaxp_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_orden_" + iRow))
        document.getElementById("hidden_field_data_orden_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_archivo_" + iRow))
        document.getElementById("hidden_field_data_archivo_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_idaxp_" + iRow))
        document.getElementById("hidden_field_data_idaxp_" + iRow).className = sCssLine;
    }
  }
