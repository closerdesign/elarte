...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['old_pswd'] = "old_pswd";
    }
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_old_pswd" style="<?php echo $sStyleHidden_old_pswd; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_old_pswd"><?php echo $this->nm_new_label['old_pswd']; ?></span></span><br>
