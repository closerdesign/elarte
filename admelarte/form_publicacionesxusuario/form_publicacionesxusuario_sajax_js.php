  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_publicacionesxusuario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate publicacion_
  function do_ajax_form_publicacionesxusuario_validate_publicacion_(iNumLinha)
  {
    var nomeCampo_publicacion_ = "publicacion_" + iNumLinha;
    var var_publicacion_ = scAjaxGetFieldSelect(nomeCampo_publicacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacionesxusuario_validate_publicacion_(var_publicacion_, iNumLinha, var_script_case_init, do_ajax_form_publicacionesxusuario_validate_publicacion__cb);
  } // do_ajax_form_publicacionesxusuario_validate_publicacion_

  function do_ajax_form_publicacionesxusuario_validate_publicacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "publicacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "publicacion_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "publicacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "publicacion_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacionesxusuario_validate_publicacion__cb

  // ---------- Validate idppu_
  function do_ajax_form_publicacionesxusuario_validate_idppu_(iNumLinha)
  {
    var nomeCampo_idppu_ = "idppu_" + iNumLinha;
    var var_idppu_ = scAjaxGetFieldHidden(nomeCampo_idppu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacionesxusuario_validate_idppu_(var_idppu_, iNumLinha, var_script_case_init, do_ajax_form_publicacionesxusuario_validate_idppu__cb);
  } // do_ajax_form_publicacionesxusuario_validate_idppu_

  function do_ajax_form_publicacionesxusuario_validate_idppu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idppu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idppu_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idppu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idppu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacionesxusuario_validate_idppu__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_publicacionesxusuario_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_publicacionesxusuario_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_publicacionesxusuario_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_publicacionesxusuario_add_new_line_cb);
  } // do_ajax_form_publicacionesxusuario_add_new_line

  function do_ajax_form_publicacionesxusuario_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_publicacionesxusuario_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_publicacionesxusuario_backup_line(iNumLinha)
  {
    var var_idppu_ = scAjaxGetFieldHidden("idppu_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacionesxusuario_backup_line(var_idppu_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_publicacionesxusuario_backup_line_cb);
  } // do_ajax_form_publicacionesxusuario_backup_line

  function do_ajax_form_publicacionesxusuario_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_publicacionesxusuario_backup_line_cb

  function do_ajax_form_publicacionesxusuario_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_publicacionesxusuario_cancel_insert

  function do_ajax_form_publicacionesxusuario_cancel_update(iSeqVert)
  {
    do_ajax_form_publicacionesxusuario_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_publicacionesxusuario_cancel_update

  function do_ajax_form_publicacionesxusuario_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_publicacionesxusuario_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_publicacionesxusuario_table_refresh()
  {
    var var_idppu_ = document.F2.idppu_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_publicacionesxusuario_table_refresh(var_idppu_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_publicacionesxusuario_table_refresh_cb);
  } //  do_ajax_form_publicacionesxusuario_table_refresh

  function do_ajax_form_publicacionesxusuario_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.idppu_.value = scAjaxGetKeyValue("idppu_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_publicacionesxusuario_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_publicacionesxusuario_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_publicacionesxusuario_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_publicacion_ = scAjaxGetFieldSelect("publicacion_" + iNumLinha);
    var var_idppu_ = scAjaxGetFieldHidden("idppu_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_publicacionesxusuario_submit_form(var_publicacion_, var_idppu_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_publicacionesxusuario_submit_form_cb);
  } // do_ajax_form_publicacionesxusuario_submit_form

  function do_ajax_form_publicacionesxusuario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("publicacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idppu_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_publicacionesxusuario_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_publicacionesxusuario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_publicacionesxusuario_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("publicacion_" + iNavForm);
      scAjaxHideErrorDisplay("idppu_" + iNavForm);
    }
    var var_idppu_ = document.F2.idppu_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_publicacionesxusuario_navigate_form(var_idppu_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_publicacionesxusuario_navigate_form_cb);
  } // do_ajax_form_publicacionesxusuario_navigate_form

  function do_ajax_form_publicacionesxusuario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idppu_.value = scAjaxGetKeyValue("idppu_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_publicacionesxusuario_navigate_form_cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "publicacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idppu_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["publicacion_" + iNumLinha] = {"label": "Publicacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idppu_" + iNumLinha] = {"label": "Id Ppu<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["publicacion_"][iNumLinha] = "publicacion_" + iNumLinha;
    ajax_field_mult["idppu_"][iNumLinha] = "idppu_" + iNumLinha;
    ajax_field_id["publicacion_" + iNumLinha] = new Array("hidden_field_label_publicacion_", "hidden_field_data_publicacion_" + iNumLinha);
    ajax_error_count["publicacion_" + iNumLinha] = "off";
    ajax_error_count["idppu_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["publicacion_" + iNumLinha] = "off";
    ajax_read_only["idppu_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["publicacion_" + iNumLinha] = "on";
    ajax_read_only["idppu_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["publicacion_" + iNumLinha] = null;
    ajax_error_list["idppu_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["publicacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["publicacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["publicacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["publicacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["publicacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idppu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idppu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idppu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idppu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idppu_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['publicacion_'])) ? $this->nmgp_cmp_readonly['publicacion_'] : 'off';
?>
    scAjaxFieldRead("publicacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idppu_'])) ? $this->nmgp_cmp_readonly['idppu_'] : 'on';
?>
    scAjaxFieldRead("idppu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("publicacion_" + iSeq, "on");
    scAjaxFieldRead("idppu_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["publicacion_" + iRow] || "on" == ajax_error_count["idppu_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_publicacion_" + iRow))
        document.getElementById("hidden_field_data_publicacion_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_idppu_" + iRow))
        document.getElementById("hidden_field_data_idppu_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["publicacion_" + iRow] && "off" == ajax_error_count["idppu_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["publicacion_" + iRow] = "off";
        ajax_error_count["idppu_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_publicacion_" + iRow))
        document.getElementById("hidden_field_data_publicacion_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_idppu_" + iRow))
        document.getElementById("hidden_field_data_idppu_" + iRow).className = sCssLine;
    }
  }
