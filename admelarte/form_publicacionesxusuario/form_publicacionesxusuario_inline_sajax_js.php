  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_publicacionesxusuario_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_publicacionesxusuario_inline_validate_publicacion_()
  {
    var nomeCampo_publicacion_ = "publicacion_";
    var var_publicacion_ = scAjaxGetFieldSelect(nomeCampo_publicacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacionesxusuario_inline_validate_publicacion_(var_publicacion_, var_script_case_init, do_ajax_form_publicacionesxusuario_inline_validate_publicacion__cb);
  } // do_ajax_form_publicacionesxusuario_inline_validate_publicacion_

  function do_ajax_form_publicacionesxusuario_inline_validate_publicacion__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacionesxusuario_inline_validate_publicacion__cb

  // ---------- Validate idppu_
  function do_ajax_form_publicacionesxusuario_inline_validate_idppu_()
  {
    var nomeCampo_idppu_ = "idppu_";
    var var_idppu_ = scAjaxGetFieldText(nomeCampo_idppu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacionesxusuario_inline_validate_idppu_(var_idppu_, var_script_case_init, do_ajax_form_publicacionesxusuario_inline_validate_idppu__cb);
  } // do_ajax_form_publicacionesxusuario_inline_validate_idppu_

  function do_ajax_form_publicacionesxusuario_inline_validate_idppu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idppu_";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacionesxusuario_inline_validate_idppu__cb
  // ---------- Form
  function do_ajax_form_publicacionesxusuario_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_publicacionesxusuario_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_publicacion_ = scAjaxGetFieldSelect("publicacion_");
    var var_idppu_ = scAjaxGetFieldText("idppu_");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_publicacionesxusuario_inline_submit_form(var_publicacion_, var_idppu_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_publicacionesxusuario_inline_submit_form_cb);
  } // do_ajax_form_publicacionesxusuario_inline_submit_form

  function do_ajax_form_publicacionesxusuario_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("publicacion_");
      scAjaxHideErrorDisplay("idppu_");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_publicacionesxusuario_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_publicacionesxusuario_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_publicacionesxusuario_inline_navigate_form(var_idppu_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_publicacionesxusuario_inline_navigate_form_cb);
  } // do_ajax_form_publicacionesxusuario_inline_navigate_form

  function do_ajax_form_publicacionesxusuario_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_publicacionesxusuario_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_publicacionesxusuario_inline_navigate_form_cb
  ...
  ajax_field_list[0] = "publicacion_";
  ajax_field_list[1] = "idppu_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "publicacion_": {"label": "Publicacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idppu_": {"label": "Id Ppu", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["publicacion_"][1] = "publicacion_";
  ajax_field_mult["idppu_"][1] = "idppu_";

  var ajax_field_id = {
    "publicacion_": new Array("hidden_field_label_publicacion_", "hidden_field_data_publicacion_")
  };
