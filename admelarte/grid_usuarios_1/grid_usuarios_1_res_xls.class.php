...
class grid_usuarios_1_res_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "grid_usuarios_1.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xls_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xls_file'] = $this->xls_f;
      }
?>
