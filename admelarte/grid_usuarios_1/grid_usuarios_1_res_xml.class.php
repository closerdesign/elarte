...
class grid_usuarios_1_res_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo      .= ".xml";
      $this->tit_doc       = "grid_usuarios_1.xml";
      $this->Grava_view   = false;
      if (strtolower($_SESSION['scriptcase']['charset']) != strtolower($_SESSION['scriptcase']['charset_html']))
      {
          $this->Grava_view = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xml_name']);
      }
      if (!$this->Grava_view)
      {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($this->campo_titulo as $col => $titulo)
      {
          ...
          {
              $this->campo_titulo[$col] = mb_convert_encoding($this->campo_titulo[$col], "UTF-8", $_SESSION['scriptcase']['charset']);
          }
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios_1']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
