...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off';
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->priv_admin = $this->priv_admin_before_qstr;
              ...
              $this->nmgp_refresh_fields = array('login', 'pswd', 'confirm_pswd', 'name', 'email');
              $this->ajax_return_values();
