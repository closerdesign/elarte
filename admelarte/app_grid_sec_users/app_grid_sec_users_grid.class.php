...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   { 
       ...
       $nmgrp_apl_opcao= $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'];
...
<?php
       ...
       { 
           ...
           $nm_saida->saida("   var scQtReg  = " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['qt_reg_grid'] . ";\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("    <TR id=\"tit_app_grid_sec_users#?#" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . "\">\r\n");
 ...
 function grid($linhas = 0)
 {
   ...
   if (!empty($this->nm_grid_sem_reg))
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
       {
           ...
           {
               $nm_saida->saida("<table id=\"apl_app_grid_sec_users#?#$nm_seq_execucoes\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
...
// 
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] != "N"){ 
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "", "", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_app_form_edit_users . "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_outra_jan=true&nmgp_url_saida=modal&nmgp_opcao=igual&nmgp_parms=login*scin" . urlencode(str_replace('"', "@aspasd@", $this->login)) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout&KeepThis=true&TB_iframe=true&height=500&width=500&modal=true", "", "only_text", "text_right", "", "", "", "");
 ...
 function NM_grid_active()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['active']) || $this->NM_cmp_hidden['active'] != "off") { 
          $conteudo = trim($this->look_active); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"   align=\"left\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_active_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function quebra_geral_top() 
 {
   ...
   function nmgp_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print") 
      {
        ...
        {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "", "", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_app_form_edit_users . "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_outra_jan=true&nmgp_url_saida=modal&nmgp_opcao=edit_novo&nmgp_parms=NM_cancel_insert_new*scin1*scoutnmgp_opcao*scinnovo*scoutNM_btn_insert*scinS*scoutNM_btn_new*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scout&KeepThis=true&TB_iframe=true&height=500&width=500&modal=true", "", "only_text", "text_right", "", "", "", "");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "app_grid_sec_users/app_grid_sec_users_config_print.php?nm_opc=AM&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf")
   { 
   ...
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['nav']))
       { 
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['campo_psq_ret']) && empty($this->nm_grid_sem_reg))
   {
   ...
   $nm_saida->saida("   }\r\n");
   if ($this->grid_emb_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['reg_start']))
   {
