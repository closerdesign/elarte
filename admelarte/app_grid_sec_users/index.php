...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'Phronesis'); 
      } 
      else 
      { 
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_grid_sec_users']))
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_form'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] == "busca")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] = "inicio";
      }
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_pesq_filtro'];
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_url_de_saida = $this->Ini->java_protocol . $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_app_grid_sec_users_html_" . session_id() . ".html";
...
<input type="hidden" name="nm_tit_doc" value="app_grid_sec_users.doc"> 
...
//======= =========================
   ...
   {
       include_once("app_grid_sec_users_nmutf8.php");
   }
...
// 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['app_grid_sec_users']['embutida_form'])
       {
