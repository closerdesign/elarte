...
<?php
include_once("form_categorias_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_categorias_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['recarga'];
}
?>
...
<?php
 include_once("form_categorias_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_categorias'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_categorias'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_imagen" style="<?php echo $sStyleHidden_imagen; ?>;"><span id="id_label_imagen"><?php echo $this->nm_new_label['imagen']; ?></span></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['Lookup_status'][] = '1'; ?>
 <option value="0" <?php  if ($this->status == "0") { echo " selected" ;} ?>>Inactiva</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['Lookup_status'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_categorias']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_categorias");
 parent.scAjaxDetailHeight("form_categorias", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
