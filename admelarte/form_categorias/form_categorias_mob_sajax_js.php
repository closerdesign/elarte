  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_categorias_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre
  function do_ajax_form_categorias_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_categorias_mob_validate_nombre_cb);
  } // do_ajax_form_categorias_mob_validate_nombre

  function do_ajax_form_categorias_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_mob_validate_nombre_cb

  // ---------- Validate imagen
  function do_ajax_form_categorias_mob_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_mob_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_categorias_mob_validate_imagen_cb);
  } // do_ajax_form_categorias_mob_validate_imagen

  function do_ajax_form_categorias_mob_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "imagen";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_mob_validate_imagen_cb

  // ---------- Validate descripcion
  function do_ajax_form_categorias_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldEditorHtml(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_categorias_mob_validate_descripcion_cb);
  } // do_ajax_form_categorias_mob_validate_descripcion

  function do_ajax_form_categorias_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_mob_validate_descripcion_cb

  // ---------- Validate status
  function do_ajax_form_categorias_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_mob_validate_status(var_status, var_script_case_init, do_ajax_form_categorias_mob_validate_status_cb);
  } // do_ajax_form_categorias_mob_validate_status

  function do_ajax_form_categorias_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "status";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_mob_validate_status_cb
  // ---------- Form
  function do_ajax_form_categorias_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_categorias_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_categorias_mob_submit_form(var_nombre, var_imagen, var_descripcion, var_status, var_id, var_imagen_ul_name, var_imagen_ul_type, var_imagen_salva, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_categorias_mob_submit_form_cb);
  } // do_ajax_form_categorias_mob_submit_form

  function do_ajax_form_categorias_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_categorias_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_categorias_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categorias_mob_navigate_form_cb);
  } // do_ajax_form_categorias_mob_navigate_form

  function do_ajax_form_categorias_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_categorias_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_categorias_mob_navigate_form_cb
