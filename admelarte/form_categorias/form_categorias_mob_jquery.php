...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_nombre' + iSeqRow).bind('blur', function() { sc_form_categorias_nombre_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_categorias_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_imagen' + iSeqRow).bind('blur', function() { sc_form_categorias_imagen_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_categorias_imagen_onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion' + iSeqRow).bind('blur', function() { sc_form_categorias_descripcion_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_categorias_descripcion_onfocus(this, iSeqRow) });
  $('#id_sc_field_status' + iSeqRow).bind('blur', function() { sc_form_categorias_status_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_categorias_status_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_categorias_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_mob_validate_nombre();
  scCssBlur(oThis);
}

function sc_form_categorias_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_categorias_imagen_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_categorias_imagen_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_categorias_descripcion_onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_mob_validate_descripcion();
  scCssBlur(oThis);
}

function sc_form_categorias_descripcion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_categorias_status_onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_mob_validate_status();
  scCssBlur(oThis);
}

function sc_form_categorias_status_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
