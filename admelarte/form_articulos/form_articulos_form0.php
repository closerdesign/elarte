...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['insert_validation']; ?>">
<?php
}
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_titulo" style="<?php echo $sStyleHidden_titulo; ?>;"><span id="id_label_titulo"><?php echo $this->nm_new_label['titulo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['titulo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['titulo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_imagen" style="<?php echo $sStyleHidden_imagen; ?>;"><span id="id_label_imagen"><?php echo $this->nm_new_label['imagen']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['imagen']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['imagen'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_imagen" style="<?php echo $sStyleHidden_imagen; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_contenido" style="<?php echo $sStyleHidden_contenido; ?>;"><span id="id_label_contenido"><?php echo $this->nm_new_label['contenido']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['contenido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['contenido'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_contenido" style="<?php echo $sStyleHidden_contenido; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span id="id_read_on_contenido" style="<?php echo $sStyleReadLab_contenido; ?>"><?php echo $this->contenido; ?></span><span id="id_read_off_contenido" style="<?php echo $sStyleReadInp_contenido; ?>"><textarea id="contenido" name="contenido" cols="50" rows="10" class="mceEditor_contenido" style="width: 100%; height:200px;"><?php echo $this->contenido; ?></textarea>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_categoria" style="<?php echo $sStyleHidden_categoria; ?>;"><span id="id_label_categoria"><?php echo $this->nm_new_label['categoria']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['categoria']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['categoria'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_categoria" style="<?php echo $sStyleHidden_categoria; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_status" style="<?php echo $sStyleHidden_status; ?>;"><span id="id_label_status"><?php echo $this->nm_new_label['status']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['status']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['status'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['Lookup_status'][] = '1'; ?>
 <option value="0" <?php  if ($this->status == "0") { echo " selected" ;} ?>>Inactivo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['Lookup_status'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_fecha_publicacion" style="<?php echo $sStyleHidden_fecha_publicacion; ?>;"><span id="id_label_fecha_publicacion"><?php echo $this->nm_new_label['fecha_publicacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['fecha_publicacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['php_cmp_required']['fecha_publicacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_fecha_publicacion" style="<?php echo $sStyleHidden_fecha_publicacion; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_programas_especiales" style="<?php echo $sStyleHidden_programas_especiales; ?>;"><span id="id_label_programas_especiales"><?php echo $this->nm_new_label['programas_especiales']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_programas_especiales" style="<?php echo $sStyleHidden_programas_especiales; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
