...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate titulo
  function do_ajax_form_articulos_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_articulos_validate_titulo_cb);
  } // do_ajax_form_articulos_validate_titulo

  function do_ajax_form_articulos_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_validate_titulo_cb

  // ---------- Validate imagen
  function do_ajax_form_articulos_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_articulos_validate_imagen_cb);
  } // do_ajax_form_articulos_validate_imagen

  function do_ajax_form_articulos_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "imagen";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_validate_imagen_cb

  // ---------- Validate contenido
  function do_ajax_form_articulos_validate_contenido()
  {
    var nomeCampo_contenido = "contenido";
    var var_contenido = scAjaxGetFieldEditorHtml(nomeCampo_contenido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_validate_contenido(var_contenido, var_script_case_init, do_ajax_form_articulos_validate_contenido_cb);
  } // do_ajax_form_articulos_validate_contenido

  function do_ajax_form_articulos_validate_contenido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_validate_contenido_cb

  // ---------- Validate categoria
  function do_ajax_form_articulos_validate_categoria()
  {
    var nomeCampo_categoria = "categoria";
    var var_categoria = scAjaxGetFieldSelect(nomeCampo_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_validate_categoria(var_categoria, var_script_case_init, do_ajax_form_articulos_validate_categoria_cb);
  } // do_ajax_form_articulos_validate_categoria

  function do_ajax_form_articulos_validate_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_validate_categoria_cb

  // ---------- Validate status
  function do_ajax_form_articulos_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_validate_status(var_status, var_script_case_init, do_ajax_form_articulos_validate_status_cb);
  } // do_ajax_form_articulos_validate_status

  function do_ajax_form_articulos_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "status";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_validate_status_cb

  // ---------- Validate fecha_publicacion
  function do_ajax_form_articulos_validate_fecha_publicacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_validate_fecha_publicacion(var_fecha_publicacion, var_script_case_init, do_ajax_form_articulos_validate_fecha_publicacion_cb);
  } // do_ajax_form_articulos_validate_fecha_publicacion

  function do_ajax_form_articulos_validate_fecha_publicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_validate_fecha_publicacion_cb

  // ---------- Validate programas_especiales
  function do_ajax_form_articulos_validate_programas_especiales()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_articulos_validate_programas_especiales(var_programas_especiales, var_script_case_init, do_ajax_form_articulos_validate_programas_especiales_cb);
  } // do_ajax_form_articulos_validate_programas_especiales

  function do_ajax_form_articulos_validate_programas_especiales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_articulos_validate_programas_especiales_cb
  // ---------- Form
  function do_ajax_form_articulos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_articulos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_articulos_submit_form(var_titulo, var_imagen, var_contenido, var_categoria, var_status, var_fecha_publicacion, var_programas_especiales, var_imagen_ul_name, var_imagen_ul_type, var_imagen_salva, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_articulos_submit_form_cb);
  ...
  function do_ajax_form_articulos_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_articulos_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_articulos_navigate_form_cb);
