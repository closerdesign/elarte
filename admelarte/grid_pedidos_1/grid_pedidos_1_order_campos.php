<?php
   ...
   session_start();
    $Ord_Cmp = new grid_pedidos_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_pedidos_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["id"] : "Id";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_converte["usuario"]   = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_converte["valor"]   = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["valor"] : "Valor";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_converte["status"]   = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["status"] : "Status";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formaPago";
   $tab_converte["formaPago"]   = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["formapago"] : "Forma Pago";
   $tab_ger_campos['orderid'] = "on";
   $tab_def_campos['orderid'] = "orderId";
   $tab_converte["orderId"]   = "orderid";
   $tab_labels["orderid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["orderid"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['labels']["orderid"] : "Order Id";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - pedidos</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_pedidos_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_pedidos_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
