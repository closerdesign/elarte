<?php
   ...
   session_start();
    $Ord_Cmp = new grid_publicacionesxpedido_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_publicacionesxpedido_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["pedido"]   = "pedido";
   $tab_labels["pedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['labels']["pedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['labels']["pedido"] : "Pedido";
   $tab_ger_campos['publicacion'] = "on";
   $tab_def_campos['publicacion'] = "publicacion";
   $tab_converte["publicacion"]   = "publicacion";
   $tab_labels["publicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['labels']["publicacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['labels']["publicacion"] : "Publicacion";
   $tab_ger_campos['formato'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['formato'] = "formato";
       $tab_converte["formato"]   = "formato";
   }
   else
   {
       $tab_def_campos['formato'] = "SELECT nombre FROM `formatos` JOIN publicaciones ON publicaciones.formato = formatos.idFormato WHERE id = {publicacion}";
       $tab_converte["SELECT nombre FROM `formatos` JOIN publicaciones ON publicaciones.formato = formatos.idFormato WHERE id = {publicacion}"]   = "formato";
   }
   $tab_labels["formato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['labels']["formato"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['labels']["formato"] : "formato";
   $tab_ger_campos['formato'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - publicacionesxpedido</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_publicacionesxpedido_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_publicacionesxpedido']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
