...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_publicaciones_form0').style.width='1px';
    document.getElementById('form_publicaciones_form0').style.height='0px';
    document.getElementById('form_publicaciones_form0').style.display='none';
    document.getElementById('form_publicaciones_form0').style.overflow='scroll';
    document.getElementById('form_publicaciones_form1').style.width='1px';
    document.getElementById('form_publicaciones_form1').style.height='0px';
    document.getElementById('form_publicaciones_form1').style.display='none';
    document.getElementById('form_publicaciones_form1').style.overflow='scroll';
