<div id="form_publicaciones_mob_form1" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } 
?> 
<?php $sStyleHidden_banner_dumb = ('' == $sStyleHidden_banner) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_banner_dumb" style="<?php echo $sStyleHidden_banner_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_bannermovil" style="<?php echo $sStyleHidden_bannermovil; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_bannermovil"><?php echo $this->nm_new_label['bannermovil']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_bannermovil_dumb = ('' == $sStyleHidden_bannermovil) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_bannermovil_dumb" style="<?php echo $sStyleHidden_bannermovil_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_bannerdesktop" style="<?php echo $sStyleHidden_bannerdesktop; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_bannerdesktop"><?php echo $this->nm_new_label['bannerdesktop']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script> 
<?php
 $NM_pag_atual = "form_publicaciones_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_publicaciones_mob_form" . $this->nmgp_ancora;
 }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_publicaciones_mob");
 parent.scAjaxDetailHeight("form_publicaciones_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
