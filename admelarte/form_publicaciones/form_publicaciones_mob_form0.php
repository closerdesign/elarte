...
<?php
include_once("form_publicaciones_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_publicaciones_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['recarga'];
}
?>
...
<?php
 include_once("form_publicaciones_mob_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_publicaciones_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_publicaciones_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_publicaciones_mob_form0";
</script>
<ul class="scTabLine">
<?php
    if ($nmgp_num_form == "form_publicaciones_mob_form0")
    {
...
?>
   <li id="id_form_publicaciones_mob_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_publicaciones_mob_form0')">
     Básicos
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_publicaciones_mob_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_publicaciones_mob_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_publicaciones_mob_form1')">
     Publicidad
    </a>
   </li>
</ul>
...
<div id="form_publicaciones_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_codps" style="<?php echo $sStyleHidden_codps; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_codps"><?php echo $this->nm_new_label['codps']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_codps_dumb = ('' == $sStyleHidden_codps) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_codps_dumb" style="<?php echo $sStyleHidden_codps_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_portada" style="<?php echo $sStyleHidden_portada; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_portada"><?php echo $this->nm_new_label['portada']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_portada_dumb = ('' == $sStyleHidden_portada) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_portada_dumb" style="<?php echo $sStyleHidden_portada_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_descripcion" style="<?php echo $sStyleHidden_descripcion; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_descripcion"><?php echo $this->nm_new_label['descripcion']; ?></span></span><br><span id="id_read_on_descripcion" style="<?php echo $sStyleReadLab_descripcion; ?>"><?php echo $this->descripcion; ?></span><span id="id_read_off_descripcion" style="<?php echo $sStyleReadInp_descripcion; ?>"><textarea id="descripcion" name="descripcion" cols="50" rows="10" class="mceEditor_descripcion" style="width: 100%; height:200px;"><?php echo $this->descripcion; ?></textarea>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_precio" style="<?php echo $sStyleHidden_precio; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_precio"><?php echo $this->nm_new_label['precio']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_isbn" style="<?php echo $sStyleHidden_isbn; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_isbn"><?php echo $this->nm_new_label['isbn']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_isbn_dumb = ('' == $sStyleHidden_isbn) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_isbn_dumb" style="<?php echo $sStyleHidden_isbn_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_edicion" style="<?php echo $sStyleHidden_edicion; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_edicion"><?php echo $this->nm_new_label['edicion']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_edicion_dumb = ('' == $sStyleHidden_edicion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_edicion_dumb" style="<?php echo $sStyleHidden_edicion_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_paginas" style="<?php echo $sStyleHidden_paginas; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_paginas"><?php echo $this->nm_new_label['paginas']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_paginas_dumb = ('' == $sStyleHidden_paginas) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_paginas_dumb" style="<?php echo $sStyleHidden_paginas_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_video" style="<?php echo $sStyleHidden_video; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_video"><?php echo $this->nm_new_label['video']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_video_dumb = ('' == $sStyleHidden_video) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_video_dumb" style="<?php echo $sStyleHidden_video_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_demo_dumb = ('' == $sStyleHidden_demo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_demo_dumb" style="<?php echo $sStyleHidden_demo_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_formato" style="<?php echo $sStyleHidden_formato; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_formato"><?php echo $this->nm_new_label['formato']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_formato_dumb = ('' == $sStyleHidden_formato) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_formato_dumb" style="<?php echo $sStyleHidden_formato_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_idioma" style="<?php echo $sStyleHidden_idioma; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_idioma"><?php echo $this->nm_new_label['idioma']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_idioma_dumb = ('' == $sStyleHidden_idioma) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idioma_dumb" style="<?php echo $sStyleHidden_idioma_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_autor" style="<?php echo $sStyleHidden_autor; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_autor"><?php echo $this->nm_new_label['autor']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_autor_dumb = ('' == $sStyleHidden_autor) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_autor_dumb" style="<?php echo $sStyleHidden_autor_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_orden" style="<?php echo $sStyleHidden_orden; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_orden"><?php echo $this->nm_new_label['orden']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_orden_dumb = ('' == $sStyleHidden_orden) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_orden_dumb" style="<?php echo $sStyleHidden_orden_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_obsequio" style="<?php echo $sStyleHidden_obsequio; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_obsequio"><?php echo $this->nm_new_label['obsequio']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['Lookup_obsequio'][] = '1'; ?>
 <option value="0" <?php  if ($this->obsequio == "0") { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['Lookup_obsequio'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_obsequio_dumb = ('' == $sStyleHidden_obsequio) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_obsequio_dumb" style="<?php echo $sStyleHidden_obsequio_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_publicaciones_mob']['Lookup_status'][] = '1'; ?>
 </select></span>
</span><?php  }?>
