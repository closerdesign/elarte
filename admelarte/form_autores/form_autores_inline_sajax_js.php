  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_autores_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre_
  function do_ajax_form_autores_inline_validate_nombre_()
  {
    var nomeCampo_nombre_ = "nombre_";
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autores_inline_validate_nombre_(var_nombre_, var_script_case_init, do_ajax_form_autores_inline_validate_nombre__cb);
  } // do_ajax_form_autores_inline_validate_nombre_

  function do_ajax_form_autores_inline_validate_nombre__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autores_inline_validate_nombre__cb

  // ---------- Validate status_
  function do_ajax_form_autores_inline_validate_status_()
  {
    var nomeCampo_status_ = "status_";
    var var_status_ = scAjaxGetFieldSelect(nomeCampo_status_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autores_inline_validate_status_(var_status_, var_script_case_init, do_ajax_form_autores_inline_validate_status__cb);
  } // do_ajax_form_autores_inline_validate_status_

  function do_ajax_form_autores_inline_validate_status__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "status_";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autores_inline_validate_status__cb

  // ---------- Validate idautor_
  function do_ajax_form_autores_inline_validate_idautor_()
  {
    var nomeCampo_idautor_ = "idautor_";
    var var_idautor_ = scAjaxGetFieldText(nomeCampo_idautor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_autores_inline_validate_idautor_(var_idautor_, var_script_case_init, do_ajax_form_autores_inline_validate_idautor__cb);
  } // do_ajax_form_autores_inline_validate_idautor_

  function do_ajax_form_autores_inline_validate_idautor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_autores_inline_validate_idautor__cb
  // ---------- Form
  function do_ajax_form_autores_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_autores_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre_ = scAjaxGetFieldText("nombre_");
    var var_status_ = scAjaxGetFieldSelect("status_");
    var var_idautor_ = scAjaxGetFieldText("idautor_");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_autores_inline_submit_form(var_nombre_, var_status_, var_idautor_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_autores_inline_submit_form_cb);
  } // do_ajax_form_autores_inline_submit_form

  function do_ajax_form_autores_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idautor_");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_autores_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_autores_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_autores_inline_navigate_form(var_idautor_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_autores_inline_navigate_form_cb);
  } // do_ajax_form_autores_inline_navigate_form

  function do_ajax_form_autores_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_autores_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_autores_inline_navigate_form_cb
  ...
  var ajax_error_list = {
    ...
    "idautor_": {"label": "Id Autor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idautor_"][1] = "idautor_";
