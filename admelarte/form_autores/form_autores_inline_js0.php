<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="idautor_" value="<?php echo NM_encode_input($this->nmgp_dados_form['idautor_']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_autores_inline']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
{
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_autores']['where_detal']))
  {
?>  
  if (parent && parent.nmsc_iframe_liga_form_autores.scInlineFormReceive)
  {
    parent.nmsc_iframe_liga_form_autores.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_autores_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
...
?>  
  ...
  {
    parent.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_autores_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
