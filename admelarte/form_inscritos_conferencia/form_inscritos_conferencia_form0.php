...
<?php
include_once("form_inscritos_conferencia_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_inscritos_conferencia_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['recarga'];
}
?>
...
<?php
 include_once("form_inscritos_conferencia_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_inscritos_conferencia'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_inscritos_conferencia'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_usuario_id" style="<?php echo $sStyleHidden_usuario_id; ?>;"><span id="id_label_usuario_id"><?php echo $this->nm_new_label['usuario_id']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_usuario_id" style="<?php echo $sStyleHidden_usuario_id; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_estado_inscripcion'][] = '0'; ?>
 <option value="1" <?php  if ($this->estado_inscripcion == "1") { echo " selected" ;} ?>>Exitosa</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_estado_inscripcion'][] = '1'; ?>
 <option value="2" <?php  if ($this->estado_inscripcion == "2") { echo " selected" ;} ?>>Pendiente</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_estado_inscripcion'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_metodo_pago'][] = '1'; ?>
 <option value="2" <?php  if ($this->metodo_pago == "2") { echo " selected" ;} ?>>Paypal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_metodo_pago'][] = '2'; ?>
 <option value="3" <?php  if ($this->metodo_pago == "3") { echo " selected" ;} ?>>Transferencia PSE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_metodo_pago'][] = '3'; ?>
 <option value="4" <?php  if ($this->metodo_pago == "4") { echo " selected" ;} ?>>Puntos VIA Baloto</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_metodo_pago'][] = '4'; ?>
 <option value="5" <?php  if ($this->metodo_pago == "5") { echo " selected" ;} ?>>OXXO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_metodo_pago'][] = '5'; ?>
 <option value="6" <?php  if ($this->metodo_pago == "6") { echo " selected" ;} ?>>BCP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['Lookup_metodo_pago'][] = '6'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inscritos_conferencia']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_inscritos_conferencia");
 parent.scAjaxDetailHeight("form_inscritos_conferencia", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
